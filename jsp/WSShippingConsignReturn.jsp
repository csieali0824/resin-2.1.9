...
<%@ page import="bean.ComboBoxBean,bean.ArrayComboBoxBean,bean.ArrayListCheckBoxBean" %>
...
<font color="#000000" size="+2" face="Arial"><strong>寄售繳回</strong></font>

<form ACTION="WSShippingConsignUpdate.jsp" METHOD="post" NAME="MYFORM">
...
<input name="ADD" type="button" onClick='setSubmit("../jsp/WSShippingConsignReturn.jsp?RESET=1")' value="ADD">
	...
	if (aItems!=null) // if array bean selected for delete
	{
		...
		if (carIMEI!=null && !carIMEI.equals(""))
		{
			...
			if (sFlag.equals("Y"))
			{
				...
				String sqlIMEI = "select IMEI,ERP_ITEMNO,MES_CARTON_NO,INSERT_DTIME,ERP_CUSTNO||'-'||ERP_CUSTNAME as CUST from WSSHIP_IMEI_T WHERE " +
				" SHP_NOTES='S' ";
...
<BR>
<input name="del" type="button" onClick='setSubmit("../jsp/WSShippingConsignReturn.jsp?RESET=1")'  value="DELETE" >

<div align="center"><input name="confirm" type="submit" value="確認送出" ></div>
