...
String AgentNo=mySmartUpload.getRequest().getParameter("AGENTNO");
...
try
{
 if (AgentNo=="002-999" || AgentNo.equals("002-999"))
 {
...
//out.println("Step2<BR>");
    ...
    {      
            ...
            out.println("<table width='100%' border='0' cellspacing='1' cellpadding='1'><tr bgcolor='#000099'><td><font size='2' color='#FFFFFF'>廠別名稱</font></td><td><font size='2' color='#FFFFFF'>直客名稱</font></td><td><font size='2' color='#FFFFFF'>收件日期</font></td>"+
            ...
            {         
              ...
              //out.println("DSN="+DSN+" ");
              out.print("<tr bgcolor='#FFFFCC'><td><font size='2'>"+DSN+"</font></td>");
           ...
           */     
             ...
             if (FINDATE != null && !FINDATE.equals("") && FINDATE.length() != -1 && (FINDATE.substring(0,2)=="93" || FINDATE.substring(0,2).equals("93")) )       
             {
              ...
              if (IMEI !=null && !IMEI.equals(""))
			  {
                 ...
                 seqstmt.setString(1,IMEI); //out.println("Step1.2");
                 seqstmt.setString(2,DSN);  // out.println("Step1.3");             
                 seqstmt.setString(3,CMRNAME);
                 seqstmt.setString(4,REPNO); // 寫五聯單號
                 seqstmt.setString(5,"002"); // RECPERSONID
                 seqstmt.setString(6,seqno); //SVRDOCNO
                 seqstmt.setString(7,"001");  // BUYPLACE
                 seqstmt.setString(8,FINDATE);
                 seqstmt.setString(9,MODEL); // MODEL
                 seqstmt.setString(10,"N/A"); //COLOR
                 seqstmt.setString(11,FAULTDESC1); //out.println("Step1.2");
                 seqstmt.setString(12,FAULTDESC2);  // out.println("Step1.3");             
                 seqstmt.setString(13,FAULTDESC3);
                 seqstmt.setString(14,WARRTYPE); // out.println("Step1.4");
                 seqstmt.setString(15,RECDATE);// out.println("Step1.5");
                 seqstmt.setString(16,"ZIP"); //out.println("Step1.6");
                 seqstmt.setString(17,"001");  // RECITEMNO1
                 seqstmt.setString(18,RPMETHOD);  // RPMETHOD
                 seqstmt.setString(19,RPMETHODDESC); // // RPMETHODDESC
                 seqstmt.setString(20,""); // SWAPIMEI
                 seqstmt.setString(21,SENDSOFTWARE); //out.println("Step1.2");
                 seqstmt.setInt(22,0);  // WORKTIME            
                 seqstmt.setString(23,"N"); //ISTRANSMITTED
                 seqstmt.setString(24,dateBean.getYearMonthDay()); // ENTRYDATE
                 seqstmt.setString(25,"N");// out.println("Step1.5");
                 seqstmt.setString(26,WARRTYPE); // WARRTYPE2
                 seqstmt.setString(27,CONSUMEITEM);  // 寫Consume Item
                 seqstmt.setString(28,"010"); //RECCENTERNO
                 seqstmt.setString(29,AgentNo); //AGENTNO
                 seqstmt.setString(30,"Y"); // DBTEL_FAULT;
                 seqstmt.setString(31,DBFAULT1); //DBTEL_SYMPT1
                 seqstmt.setString(32,DBSYMPTOM1);  // DBTEL_SYMPT2;             
                 seqstmt.setString(33,DBSYMPTOM2); //DBTEL_SYMPT2; 
                 seqstmt.setString(34,DBSYMPTOM3); // DBTEL_SYMPT3; 
                 seqstmt.setString(35,DBSYMDESC);// DBTEL_SYMDESC;
