...
<html>
<head>
<title>Insert RETAILER PRICE UploadFile into Database</title>
  ...
  {  	    
	...
	{	 
	 ...
	 {               	  	  
	  ...
	  {	   
	   String sql="insert into PSALES_FORE_PRICE(FPCOMP,FPYEAR,FPMONTH,FPREG,FPCOUN,FPTYPE,FPPRJCD,FPPRI,FPMVER,FPLUSER,FPCURR) values(?,?,?,?,?,?,?,?,?,?,?)";
	...
	out.println("RETAILER PRICE FILE UPLOAD SUCCESSFULLY");
