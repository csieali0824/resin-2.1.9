...
if ( dateSetBegin==null || dateSetBegin.equals("") )
{
  ...
  {   // out.println("workingDateBean.getWeek()="+workingDateBean.getWeek());
     ...
     sSql = " select YWA.WO_NO, YWA.INV_ITEM, YWA.ITEM_DESC, YWO.OPERATION_CODE, WOP.DESCRIPTION, "+
   ...
   sWhereSDRQ = " ";
   havingGrp = "group by YWA.INV_ITEM, YWA.ITEM_DESC, YWA.WO_NO, YWO.OPERATION_CODE, WOP.DESCRIPTION ";               
   havingGrpSDRQ = "  ";
   sOrder = " order by YWO.OPERATION_CODE, WOP.DESCRIPTION, YWA.INV_ITEM, YWA.ITEM_DESC, YWA.WO_NO  "; //預設以站別
...
{ 
  ...
  sSql = " select YWA.WO_NO, YWA.INV_ITEM, YWA.ITEM_DESC, YWO.OPERATION_CODE, WOP.DESCRIPTION, sum(YWO.QUANTITY_BEGIN_BALANCE) as QUANTITY_BEGIN_BALANCE, "+
	        "        sum(YWO.QUANTITY_RECEIVED) as QUANTITY_RECEIVED, sum(YWO.QUANTITY_PROCESSED) as QUANTITY_PROCESSED, "+
			"        sum(YWO.QUANTITY_COMPLETED) as QUANTITY_COMPLETED, sum(YWO.QUANTITY_SCRAPPED) as QUANTITY_SCRAPPED, "+
			"        sum(YWO.QUANTITY_END_BALANCE) as QUANTITY_END_BALANCE, sum(YWO.QTY_MOVEIN_TRANSACT) as QTY_MOVEIN_TRANSACT, "+
			"        sum(YWO.QTY_LASTOP_COMPLETE) as QTY_LASTOP_COMPLETE, sum(YWO.QTY_ONLINE_RETURN) as QTY_ONLINE_RETURN, "+
   ...
   sWhere =  "  where YWO.ORGANIZATION_ID = OAP.ORGANIZATION_ID and YWO.ACCT_PERIOD_ID = OAP.ACCT_PERIOD_ID and YWO.ORGANIZATION_ID = "+marketType+" "+
	 ...
	 if (order.equals("ST")) sOrder = "  order by YWO.OPERATION_CODE, WOP.DESCRIPTION, YWA.INV_ITEM, YWA.ITEM_DESC, YWA.WO_NO ";
     else  sOrder = "  order by YWA.INV_ITEM, YWA.ITEM_DESC, YWA.WO_NO, YWO.OPERATION_CODE, WOP.DESCRIPTION ";
...
<table cellspacing="0" bordercolordark="#6699CC" cellpadding="1" width="100%" align="center" bordercolorlight="#ffffff" border="1">
  <tr bgColor="#bbd3e1">
    <td noWrap width="11%" height="22">
      <div align="center">
        <font color="#006666">工令</font>
      </div>
    </td>
    <td noWrap width="11%">
      <div align="center">
        <font color="#006666">站別</font>
      </div>
    </td>
    <td noWrap width="8%">
      <div align="center">
        <font color="#006666">料號</font>
      </div>
    </td>
    <td noWrap width="9%">
      <div align="center">
        <font color="#006666">品名</font>
      </div>
    </td>
    <td noWrap width="11%">
      <div align="center">
        <font color="#006666">期初數</font>
      </div>
    </td>
    <td noWrap width="9%">
      <div align="center">
        <font color="#006666">領料數</font>
      </div>
    </td>
    <td noWrap width="10%">
      <div align="center">
        <font color="#006666">轉入數</font>
      </div>
    </td>
    <td noWrap width="10%">
      <div align="center">
        <font color="#006666">入退庫</font>
      </div>
    </td>
    <td noWrap width="10%">
      <div align="center">
        <font color="#006666">轉出數</font>
      </div>
    </td>
    <td noWrap width="11%">
      <div align="center">
        <font color="#006666">期末數</font>
      </div>
    </td>
  </tr>
  <tr bgColor="#d8e6e7">
    <td noWrap>
      <div align="center">
        <font face="Arial" color="#000000">工令</font>
      </div>
    </td>
    <td noWrap>
      <div align="center">
        <font face="Arial" color="#000000">製程站別代號及說明</font>
      </div>
    </td>
    <td noWrap>
      <div align="center">
        <font face="Arial" color="#000000">工令製成品號</font>
      </div>
    </td>
    <td noWrap>
      <div align="center">
        <font face="Arial" color="#000000">製成品號規格</font>
      </div>
    </td>
    <td noWrap>
      <div align="center">
        <font face="Arial" color="#000000">上月結存數</font>
      </div>
    </td>
    <td noWrap>
      <div align="center">
        <font face="Arial" color="#000000">製程站實際領用數</font>
      </div>
    </td>
    <td noWrap>
      <div align="center">
        <font face="Arial" color="#000000">製程站別投入數</font>
      </div>
    </td>
    <td noWrap>
      <div align="center">
        <font face="Arial" color="#000000">製程末站完工數/製程線上退料數</font>
      </div>
    </td>
    <td noWrap>
      <div align="center">
        <font face="Arial" color="#000000">製程站別移出數</font>
      </div>
    </td>
    <td noWrap>
      <div align="center">
        <font face="Arial" color="#000000">期初+接收-產出-耗損</font>
      </div>
    </td>
  </tr>
</table>
