...
<title>Sales Forecast Distributor GM Index Entry Form</title>
</head>
<body>
...
<strong> Sales Forecast Labor Load Extra Rate and VAT Entry </strong></font>
...
<table width="100%" border="0">
	  ...
	  <BR>
        <% 		 		 		 
         ...
         {   
		  ...
		  out.println("<select NAME='REGION' onChange='setSubmit("+'"'+"../jsp/WSLaborRateVATEntry.jsp"+'"'+","+'"'+"../jsp/WSLaborRateVATEntry.jsp"+'"'+")'>");
   ...
   */ 
   %>
	<td width="8%" colspan="2"><input name="submit1" type="submit" value="Enter" onClick='return setSubmit("../jsp/WSLaborRateVATInput.jsp","../jsp/WSLaborRateVATInput.jsp")'>
</td> 
	</tr>	
	<tr>
