...
<strong> 產品編碼系統-產品延伸機種代碼查詢 </strong></font>
<FORM ACTION="../jsp/WSMRProdExtendInquiry.jsp" METHOD="post" NAME="MYFORM">
<%
   int rs1__numRows = 25;
   int rs1__index = 0;
   int rs_numRows = 0;
 ...
 %>
<A HREF="../WinsMainMenu.jsp">首頁</A> &nbsp;&nbsp;<A HREF="../jsp/WSModelEncodingSub.jsp">產品編碼管理作業</A> &nbsp;&nbsp;<A HREF="../jsp/WSMRProdAprnceInput.jsp?ENTRY=TRUE">產品延伸機種代碼資料新增</A>
<% 
     String MM_moveFirst="",MM_moveLast="",MM_moveNext="",MM_movePrev="";  
     String prodExtCode=request.getParameter("PRODEXTCODE");
...
<table width="50%" border="0">      
    <tr>
      <td bgcolor="#FFFFFF" colspan="2"><font color="#000000" face="Arial Black"><strong>產品外觀代碼
        <%
         ...
         {       
		  ...
		  sSql = "select PRODEXT_CODE, PRODEXT_CODE || '(' || PRODEXTEND ||')' "+
			     "from MRPROD_EXT ";	 
		  sSql = sSql+sWhere;
		  ...
		  comboBoxAllBean.setSelection(prodExtCode);
	      comboBoxAllBean.setFieldName("PRODEXTCODE");	   
          out.println(comboBoxAllBean.getRsString());
		  if (rs.next())
		  {		   
            prodExtCode= rs.getString("PRODEXT_CODE");
    ...
    <td width="35%" bgcolor="#FFFFFF"><INPUT TYPE="button"  value="Query" onClick='setSubmit("../jsp/WSMRProdExtendInquiry.jsp")' ></td>    
    </tr> 
...
<table width="50%" border="1" cellspacing="0" cellpadding="0">
        <tr bgcolor="#006666"> 
		  ...
		  <td width="19%"  height="19" bgcolor="#6699FF" nowrap><font color="#FFFFFF" size="2"><strong>延伸機種代碼</strong></font></td>
          <td width="33%"  height="19" bgcolor="#6699FF" nowrap><font color="#FFFFFF" size="2"><strong>產品延伸機種</strong></font></td>
          ...
          <%  
            ...
            {  
              ...
              String sqlTC =  "select PRODEXT_CODE, PRODEXTEND, PRODEXT_DESC "+
			                  "from MRPROD_EXT ";
			  String sWhereTC = "where PRODEXT_CODE IS NOT NULL ";
			
              if (prodExtCode == null || prodExtCode.equals("--")) { sWhereTC = sWhereTC + "and PRODEXT_CODE != '0'  "; }
			  else { sWhereTC = sWhereTC + "and PRODEXT_CODE ='"+prodExtCode+"'  "; }                      			             
             ...
             // if (MonthFr!="--" && MonthTo!="--") sWhereTC=sWhereTC+" and substr(LAUNCH_DATE,3,4)||substr(LAUNCH_DATE,1,2) between "+"'"+dateStringBegin+"'"+" and "+"'"+dateStringEnd+"' ";
			  ...
			  String sOrderTC = "order by PRODEXT_CODE ";
      ...
      if (request.getParameterNames().hasMoreElements()) {
        ...
        <tr bgcolor="<%=colorStr%>">
          ...
          <td height="20"><font size="2">
                 <% 
                      if (rsTC.getString("PRODEXT_CODE")!=null ) { out.println(rsTC.getString("PRODEXT_CODE")); } 
                      else { out.println("&nbsp;"); }
                  %></font></td>		           	           
		  <td><font size="2" >
                 <%
                   //if (codeClass==null || codeClass=="2" || codeClass.equals("2"))
                     ...
                     if (rsTC.getString("PRODEXTEND")!=null) { out.println(rsTC.getString("PRODEXTEND")); } 
                     else { out.println("&nbsp;"); }
          ...
          <td><font size="2" >
                 <%
                      if (rsTC.getString("PRODEXT_DESC") !=null) { out.println(rsTC.getString("PRODEXT_DESC")); } 
                      else { out.println("&nbsp;"); }
