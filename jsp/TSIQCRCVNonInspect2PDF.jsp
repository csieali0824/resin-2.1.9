...
<body>
<%
String docNo=request.getParameter("DOCNO");//���o�e�@������I����s��

String sSql="";
int itemCount=1;//�C�@��PO������
  ...
  {  	
     /*      
	  sSql="select c.VNDNAM,a.PVEND,b.TNAME,a.PSHIP,i.THADVN,a.PORD,a.PLINE,a.PODESC,a.PQORD,(a.PECST*a.PQORD) as PACST,i.THUPI,(a.PECST*a.PQORD)+i.THUPI as pait,i.TCOM,c.VCURR,t.VTMDSC from HPO a,ith i,EST b,AVM c,AVT t "+ 
			" where a.PSHIP=b.TSHIP and a.PVEND=c.VENDOR and a.PORD=i.tref  and a.PLINE=i.THLIN and c.VTERMS=t.VTERM and ( i.TTYPE='U' or  i.TTYPE='U1')";//�u���X�w���Ʀ��|���дڤ����
