...
<!--20250522 by JB,新增Plant (DP_CODE)-->
...
<script language="JavaScript" type="text/JavaScript">
	...
	function setSubmit1(URL)
	{
		...
		document.MYFORM.action=URL+"?CUSTOMER="+CUSTOMER+"&CUSTPO="+CUSTPO+"&PLANT="+PLANT+"&CYEARFR="+CYEARFR+"&CMONTHFR="+CMONTHFR+"&CDAYFR="+CDAYFR+"&CDAYFR="+CDAYFR+"&CMONTHTO="+CMONTHTO+"&CDAYTO="+CDAYTO+"&PDNFLAG="+PDNFLAG;
		document.MYFORM.submit();
	}
	...
	<table width="100%">
			...
			<td>
				<table cellSpacing="0" bordercolordark="#5C7671"  cellPadding="1" width="100%" align="center" borderColorLight="#CFDAD8" border='1' bgcolor="#DCE6E7" bordercolor="#CCCCCC">
					...
					<tr>
						...
						<td><font color="#666600">Plant:</font></td>
						<td>
							<input type="text" name="PLANT" value="<%=PLANT%>" style="font-family:Arial;font-size:12px" size="15">
						</td>
						<td colspan="8">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
		...
		<%
			try
			{
				if (PDNFLAG.equals("Y"))
				{
					sql = " SELECT c.DP_CODE, a.order_number \"M/O\",b.line_number||'.'||b.shipment_number \"Line No.\","+
							...
							" FROM ont.oe_order_headers_all a,ont.oe_order_lines_all b ,(select distinct c.DP_CODE, c.REQUEST_DATE, c.currency_code,c.erp_customer_id,c.customer_po,d.cust_po_line_no,d.REMARK from "+
					...
					while (rs.next())
					{
						...
						if ( i==1)
						{
							...
							out.println("<td width='9%' height='20' nowrap><div align='center'><font color='#ffffff'>M/O</font></div></td>");
							...
							out.println("<td width='12%' nowrap><div align='center'><font color='#ffffff'>Customer</font></div></td>");
							out.println("<td width='4%' nowrap><div align='center'><font color='#ffffff'>Plant</font></div></td>");
							...
							out.println("<td width='9%' nowrap><div align='center'><font color='#ffffff'>Remarks</font></div></td>");
							out.println("</tr>");
						}
						...
						out.println("<td align='center'>"+rs.getString("DP_CODE")+"</td>");
				...
				*/
						sql = " SELECT tt.* "+
								" FROM (SELECT b.dp_code,b.erp_customer_id customer_id,"+
								"              a.customer_name,"+
								"              b.customer_po,"+
								"              b.data_flag,"+
								"              b.currency_code,"+
								...
								//"             daphne_pi_temp d,"+
								"             (select case customer_id when 690290 then 1071293 when 702294 then 1071295 else customer_id end d_customer_id, d.* from daphne_pi_temp d) d,"+
								...
								"        AND b.erp_customer_id=d.d_customer_id(+)"+
						...
						sql += "       GROUP BY b.dp_code,b.erp_customer_id,"+
								"                a.customer_name,"+
								"                b.customer_po,"+
								"                b.data_flag,"+
								"                b.currency_code,"+
						...
						while (rs.next())
						{
							...
							if ( i==1)
							{
								...
								out.println("<td width='15%' nowrap><div align='center'><font color='#ffffff'>Customer</font></div></td>");
								out.println("<td width='7%' nowrap><div align='center'><font color='#ffffff'>Customer PO</font></div></td>");
								out.println("<td width='5%' nowrap><div align='center'><font color='#ffffff'>Plant</font></div></td>");
								...
								out.println("<td width='7%' nowrap><div align='center'><font color='#ffffff'>Last Update Date</font></div></td>");
							...
							out.println("<td align='left'" +linkurl+">"+rs.getString("dp_code")+"</td>");
					...
					else //quantity or price issue,add by Peggy 20141120
					{
						...
						sql = " select a.dp_code,a.erp_customer_id,b.customer_name,a.currency_code,a.customer_po,a.cust_po_line_no,a.cust_item_name,a.tsc_item_name,a.quantity,a.uom,a.unit_price,a.cust_request_date,d.creation_date,d.last_update_date,"+
								...
								" ,ac.customer_number"+
								" FROM (select a.dp_code,a.ERP_CUSTOMER_ID,a.CURRENCY_CODE,a.CUSTOMER_PO,b.CUST_PO_LINE_NO,b.CUST_ITEM_NAME,b.TSC_ITEM_NAME,sum(b.QUANTITY) QUANTITY,b.UOM,b.UNIT_PRICE,b.CUST_REQUEST_DATE from tsc_edi_orders_header a,tsc_edi_orders_detail b "+
								" where  a.customer_po = b.customer_po(+)"+
								" AND a.erp_customer_id = b.erp_customer_id(+)"+
								" group by a.dp_code,a.ERP_CUSTOMER_ID,a.CURRENCY_CODE,a.CUSTOMER_PO,b.CUST_PO_LINE_NO,b.CUST_ITEM_NAME,b.TSC_ITEM_NAME,b.UOM,b.UNIT_PRICE,b.CUST_REQUEST_DATE"+
								") a,"+
								" tsc_edi_customer b,"+
						...
						while (rs.next())
						{
							if ( i==0)
							{
								...
								out.println("<td width='9%' align='center'  nowrap>Customer</td>");
								out.println("<td width='3%' align='center'  nowrap>Currency</td>");
								out.println("<td width='7%' align='center'  nowrap>Customer PO</td>");
								out.println("<td width='4%' align='center'  nowrap>PLANT</td>");
								out.println("<td width='4%' align='center'  nowrap>PO Line</td>");
								out.println("<td width='8%' align='center'  nowrap>TSC PN</td>");
								...
								out.println("<td width='6%' align='center'  nowrap>MO</td>");
							...
							if (!ERP_CUSTOMER_ID.equals(rs.getString("erp_customer_id")) || !CUSTOMER_PO.equals(rs.getString("customer_po")) || !CUSTOMER_PO_LINE.equals(rs.getString("CUST_PO_LINE_NO")))
							{
								...
								out.println("<td align='left' rowspan='"+rs.getString("po_line_cnt")+"'>"+rs.getString("dp_code")+"</td>");
