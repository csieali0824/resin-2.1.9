...
*/
      ...
      org.jfree.chart.urls.TimeSeriesURLGenerator urlg = new org.jfree.chart.urls.TimeSeriesURLGenerator(sdf, "TSRFQTEWFacPlannerConfirmIMap.jsp?FAC="+factory, "TRENDMODE", "DATETIME");
     ...
     // plot.setRangeAxis(1, valueAxisRetn);
      ...
      org.jfree.chart.JFreeChart chart = new org.jfree.chart.JFreeChart("天津廠企劃每月訂單接收/回覆統計", org.jfree.chart.JFreeChart.DEFAULT_TITLE_FONT, plot, false);
