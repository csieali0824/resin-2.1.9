...
<table width="100%" border="0">
    <tr bgcolor="#D0FFFF">
      <td width="39%" bordercolor="#FFFFFF"><font color="#330099" face="Arial Black"><strong>業務員組織:</strong></font>			
	 <% 		
...
//          sSql = "select distinct trim(busi)||trim(dept) DEPT,gsvbu.svldes  from ac3,gsvbu,gsvdept";
//          sWhere = " where busi !='' and dept !='' and busi =gsvbu.svsgvl and dept =gsvdept.svsgvl "+
//                   " and BUSI in ('0','1') and DEPT in('09','13') ";
		  sSql = sSql+sWhere;		  
...
//		  comboBoxBean.setSelection(comp);
	...
	<td colspan="5">
	 ...
	 <% 
	    if (UserRoles.indexOf("admin")>=0 || UserRoles.indexOf("fs_editor")>=0 || UserRoles.indexOf("Sale")>=0)
	   {
