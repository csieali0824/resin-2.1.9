...
<FORM ACTION="../jsp/TSCWipJobCompleteNotIssueReport.jsp" METHOD="post" NAME="MYFORM">
...
<strong>WIP Discrete Job Completed Not Issue Report</strong></font>
<BR>
  <!--%/20040109/將Excel Veiw 夾在檔頭%-->
<%
...
if ((YearFr==null || YearFr.equals("")) && (YearTo==null || YearTo.equals("")) )
{
   ...
   sWhere =  "where J.WIP_ENTITY_ID = W.WIP_ENTITY_ID AND J.QUANTITY_COMPLETED>0 "+
	           "AND J.WIP_ENTITY_ID IN (SELECT TRANSACTION_SOURCE_ID FROM MTL_MATERIAL_TRANSACTIONS "+
	                                   "WHERE TO_CHAR(TRANSACTION_DATE,'YYYYMM') >='"+strPreMonth+"' AND TRANSACTION_TYPE_ID=44) "+
			   "AND J.STATUS_TYPE = 4 "+  // 限定工單狀態是已經 Complete 的( 4 = Complete, 7 = Cancelled, 12= Closed)
               "AND J.WIP_ENTITY_ID NOT IN (SELECT DISTINCT WIP_ENTITY_ID FROM WIP_REQUIREMENT_OPERATIONS WHERE QUANTITY_ISSUED!=0) "+
...
%>  
  <table width="100%" border="1" cellpadding="0" cellspacing="0" bordercolorlight="#999999" bordercolordark="#FFFFFF">
	...
	<td width="68%" bordercolor="#CCCCFF">
		    <INPUT TYPE="button" align="middle"  value='查詢' onClick='setSubmit("../jsp/TSCWipJobCompleteNotIssueReport.jsp")' >   
	</td>
   </tr>
  </table>  
    ...
    <tr bgcolor="<%=colorStr%>"> 
      ...
      <td width="31%" valign="top" nowrap>
	     <font size="-1">
			 ...
			 {
			    out.print("<tr><td>");%><a href="../jsp/TSCWipJobCompleteNotIssueReport.jsp?SPANNING=TRUE&WIPENTID=<%=rsTC.getString("WIP_ENTITY_ID")%>"><img src="../image/PLUS.gif" width="14" height="15" border="0"></a><% out.println("</td></tr>");
			  ...
			  {		
				...
				{	    
			     out.print("<tr><td>");%><a href="../jsp/TSCWipJobCompleteNotIssueReport.jsp?SPANNING=FALSE&WIPENTID=<%=rsTC.getString("WIP_ENTITY_ID")%>"><img src="../image/MINUS.gif" width="14" height="15" border="0"></a><% out.println("</td></tr>");
	  ...
	  <td width="8%" valign="top" nowrap><font size="-1" color="#CC0033"><strong><div align="right"><%=rsTC.getFloat("START_QUANTITY")%></div></strong></font></td>      
      <td width="8%" valign="top" nowrap><font size="-1" color="#CC0033"><strong><div align="right"><%=rsTC.getFloat("QUANTITY_COMPLETED")%></div></strong></font></td>    
    </tr>
    <%
  rs1__index++;
  rs_hasDataTC = rsTC.next();
...
%>
    <tr bgcolor="#003366"> 
      <td height="23" colspan="10" ><font color="#FFFFFF" size="-1">工單已完工未入庫筆數</font> 
        <% 
	      if (CaseCount==0) 
