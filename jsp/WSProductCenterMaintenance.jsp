...
<title>WINS System-Sales Forecast Product Data Inquiry and Maintenance</title>
...
<strong> Product Data Maintenance </strong></font>
...
to submenu</A>&nbsp;&nbsp;<A HREF="../jsp/WSProductCenterInput.jsp">Product Data Input</A>
<% 
...
<table width="100%" border="0">
    <tr>
      <td width="34%" bgcolor="#006699"><font color="#FF0066" face="Arial Black"><strong>BRAND  
        <%
         ...
         {   
		  ...
		  out.println("<select NAME='BRAND' onChange='setSubmit("+'"'+"../jsp/WSProductCenterMaintenance.jsp"+'"'+")'>");
      ...
      <td bgcolor="#006699"><font color="#FF0066" face="Arial Black"><strong>DESIGN HOUSE
        <%
         try
         {   
		  String sSql = "";
		  ...
		  out.println("<select NAME='DESIGNHOUSE' onChange='setSubmit("+'"'+"../jsp/WSProductCenterMaintenance.jsp"+'"'+")'>");
          out.println("<OPTION VALUE=-->--");     
          while (rs.next())
          {            
           String s1=(String)rs.getString(1); 
      ...
      <td width="31%" bgcolor="#006699"><font color="#FF0066" face="Arial Black"><strong>PLATFORM
         <%
         try
         {   
		  String sSql = "";
		  ...
		  sWhere = "where PLATFORM IS NOT NULL order by x";		 
		  sSql = sSql+sWhere;		  
		  		      
          Statement statement=con.createStatement();
          ResultSet rs=statement.executeQuery(sSql);
		  
		  out.println("<select NAME='PLATFORM' onChange='setSubmit("+'"'+"../jsp/WSProductCenterMaintenance.jsp"+'"'+")'>");
          out.println("<OPTION VALUE=-->--");     
          while (rs.next())
          {            
           String s1=(String)rs.getString(1); 
    ...
    <tr>
      <td bgcolor="#006699" colspan="2"><font color="#FF0066" face="Arial Black"><strong>INTERNAL MODEL
        <input name="INTERMODEL" type="text" value="<%=interModel%>" size="20" maxlength="15">
      </strong></font>
    </td>
    <td width="35%" bgcolor="#006699"><INPUT TYPE="button"  value="Query" onClick='setSubmit("../jsp/WSProductCenterMaintenance.jsp")' ></td>    
    </tr> 
    <tr>
      <td bgcolor="#006699" colspan="3">
        <font color="#FF0066" face="Arial Black"><strong>LUANCH DATE FR.</strong></font>
        <%
       ...
       %>         
         <font color="#FF0066" face="Arial Black"><strong> ~<font color="#FF0066" face="Arial Black"><strong>LUANCH DATE TO</strong></font></strong></font>  
         <%
...
<table width="100%" border="1" cellspacing="0" cellpadding="0">
        <tr bgcolor="#006666"> 
          ...
          <td width="8%"  height="19" bgcolor="#6699FF" nowrap><font color="#FFFFFF" size="2"><strong>INTERNAL MODEL</strong></font></td>          	  
		  <td width="23%" bgcolor="#6699FF" nowrap><font color="#FFFFFF" size="2"><strong>EXTERNAL MODEL</strong></font></td>
          <td width="25%" bgcolor="#6699FF" nowrap><font color="#FFFFFF" size="2"><strong>BRAND</strong></font></td>
		  <td width="25%" bgcolor="#6699FF" nowrap><font color="#FFFFFF" size="2"><strong>DESIGNHOUSE</strong></font></td>
          <td width="6%" bgcolor="#6699FF" nowrap><font color="#FFFFFF" size="2"><strong>PLATFORM</strong></font></td>	
          <td width="7%" bgcolor="#6699FF" nowrap><font color="#FFFFFF" size="2"><strong>LAUNCH DATE</strong></font></td>
		  <td width="7%" bgcolor="#6699FF" nowrap><font color="#FFFFFF" size="2"><strong>DESCRIPTION</strong></font></td>
          <td width="6%" bgcolor="#6699FF" nowrap><font color="#FFFFFF" size="2"><strong>CREATE DATETIME</strong></font></td>	  
		  <td width="15%" bgcolor="#6699FF" nowrap><font color="#FFFFFF" size="2"><strong>CREATE USER</strong></font></td>	
        </tr> 
          <%  
            try
            {  
              ...
              String sqlTC =  "select INTER_MODEL,EXT_MODEL,BRAND,DESIGNHOUSE,PLATFORM,LAUNCH_DATE,PROD_DESC,CREATE_DATE,CREATE_USER "+
			  ...
			  String sOrderTC = "order by INTER_MODEL,CREATE_DATE ";
   ...
   //out.println("MM_size Step0="+MM_size);
    ...
    <%
      ...
      if (request.getParameterNames().hasMoreElements()) {
        ...
        %>
        <tr bgcolor="<%=colorStr%>">
		  <td><a href="../jsp/WSProductCenterMaintEdit.jsp?INTERMODEL=<%=rsTC.getString("INTER_MODEL")%>&LAUNCHDATE=<%=rsTC.getString("LAUNCH_DATE")%>&PLATFORM=<%=rsTC.getString("PLATFORM")%>&BRAND=<%=rsTC.getString("BRAND")%>&DESIGNHOUSE=<%=rsTC.getString("DESIGNHOUSE")%>">
		      <div align="center"><img src="../image/docicon.gif" width="14" height="15" border="0"></div></a></td>
          <td height="20"><font size="2">
                 <% 
                      if (rsTC.getString("INTER_MODEL")!=null ) { out.println(rsTC.getString("INTER_MODEL")); } 
                      else { out.println("&nbsp;"); }
                  %></font></td>		           	           
		  <td><font size="2" >
                 <%
                   //if (codeClass==null || codeClass=="2" || codeClass.equals("2"))
                     ...
                     if (rsTC.getString("EXT_MODEL")!=null) { out.println(rsTC.getString("EXT_MODEL")); } 
                     else { out.println("&nbsp;"); }
          ...
          <td><font size="2" >
                 <%
                      if (rsTC.getString("BRAND") !=null) { out.println(rsTC.getString("BRAND")); } 
                      else { out.println("&nbsp;"); }
                     //=rsTC.getString("TXRPCENTERNO") 
                 %></font></td>		
          <td><font size="2" >
                 <%
                      if (rsTC.getString("DESIGNHOUSE") !=null && rsTC.getString("DESIGNHOUSE") != " " ) { out.println(rsTC.getString("DESIGNHOUSE")); } 
                      else { out.println("&nbsp;"); }
                     //=rsTC.getString("TXRPCENTERNO") 
                 %></font></td>	
          <td><font size="2" >
                 <%
                      if (rsTC.getString("PLATFORM") !=null) { out.println(rsTC.getString("PLATFORM")); } 
                      else { out.println("&nbsp;"); }
                     //=rsTC.getString("TXRPCENTERNO") 
                 %></font></td>	
          <td><font size="2" >
                 <%
                      ...
                      if (rsTC.getString("LAUNCH_DATE") !=null) { out.println(rsTC.getString("LAUNCH_DATE")); } 
                      else { out.println("&nbsp;"); }
                     //=rsTC.getString("TXRPCENTERNO") 
                 %></font></td> 
		  <td><font size="2" >
                 <%
                      if (rsTC.getString("PROD_DESC") !=null) { out.println(rsTC.getString("PROD_DESC")); } 
                      else { out.println("&nbsp;"); }
                     //=rsTC.getString("TXRPCENTERNO") 
                 %></font></td>			  
          <td><font size="2">
                 <%
                      if (rsTC.getString("CREATE_DATE") !=null) { out.println(rsTC.getString("CREATE_DATE")); } 
                      else { out.println("&nbsp;"); }
                     //=rsTC.getString("TXRPCENTERNO") 
                 %></font></td>	
		  <td><font size="2">
                 <%
                      if (rsTC.getString("CREATE_USER") !=null) { out.println(rsTC.getString("CREATE_USER")); } 
                      else { out.println("&nbsp;"); }
                     //=rsTC.getString("TXRPCENTERNO") 
                 %></font></td>	      
       </tr>
