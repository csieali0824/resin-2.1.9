...
<html>
<head>
<title>Query All Connectivity Specifics Data</title>
...
<body><FORM ACTION="../jsp/PIConnDel.jsp" METHOD="POST" onSubmit="return NeedConfirm()"> 
<input name="button" type=button onClick="this.value=check(this.form.CH)" value="全部選取">
<INPUT TYPE="submit" value="Delete">&nbsp;&nbsp;<A HREF="PIConnInput.jsp">New Connectivity Specifics</A>&nbsp;&nbsp;<A HREF="/wins/WinsMainMenu.jsp">Home</A> 
<jsp:useBean id="queryAllCheckBoxBean" scope="page" class="QueryAllCheckBoxBean"/>
<% 
 try
 {  
   Statement statement=con.createStatement();
   ResultSet rs=statement.executeQuery("select * from PICONN ORDER BY CONNNAME");
