...
<html>
<head>
    <link rel="stylesheet" href="../../jsp/tscDateCode/css/dateCodeModal.css">
</head>
...
<script>
    function setTableData(selectedData, url) {
        ...
        let columns = [
            ...
            },
            {
                ...
                formatter: function (value, row, index) {
                    value = value === undefined ? '' : value;
                    return setInputInfo(value, index, 'markingDesc');
                }
            },
            {
                field: 'remarks',
    ...
    function updateStatus(index, field) {
        const selectField = field === 'dateCode' ? '#modal-dateCode' : field === 'marking' ? '#modal-marking' : field === 'markingDesc' ? '#modal-markingDesc' : '#modal-remarks';
