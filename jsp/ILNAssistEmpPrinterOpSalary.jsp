...
<%@ page import="bean.QryAllChkBoxEditBean,bean.ArrayCheckBoxBean,bean.ComboBoxBean,bean.DateBean,bean.WorkingDateBean,bean.ArrayComboBoxBean"%>
...
<jsp:useBean id="arrayChechBoxBean" scope="session" class="bean.ArrayCheckBoxBean"/>
