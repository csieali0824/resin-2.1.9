...
<title>SG Safety Stock Detail</title>
<!--=============�H�U�Ϭq���w���{�Ҿ���==========-->
...
<FORM ACTION="TSCSGItemSafetyStockDetail.jsp" METHOD="post" NAME="MYFORM">
...
<div id="showimage" style="position:absolute; visibility:hidden; z-index:65535; top: 260px; left: 300px; width: 400px; height: 50px;"> 
  ...
  <table width="350" height="50" border="1" align="center" cellpadding="5" cellspacing="0" bordercolorlight="#CCFFCC" bordercolordark="#336600">
    <tr>
    <td height="70" bgcolor="#CCCC99"  align="center"><font color="#003399" face="�з���" size="+2">The data processing,please wait while.....</font> <BR>
...
<table cellSpacing="0" bordercolordark="#5C7671"  cellPadding="1" width="100%" align="center" borderColorLight="#CFDAD8" border='1' bgcolor="#DCE6E7">
	<tr>
		...
		<%
			if (UserRoles.equals("admin") || UserName.startsWith("CYTSOU") || UserName.startsWith("JUDY_") || UserName.startsWith("PERRY.JUAN"))
			{
		%>
			&nbsp;
...
try
{
	sql = " SELECT  a.safety_seq_id, a.c_month, a.organization_code,"+
          " a.inventory_item_id, a.item_name, a.item_desc,"+
	...
	sql += " order by A.ORGANIZATION_CODE,a.C_MONTH desc,a.ITEM_DESC";
	//out.println(sql);
...
%>
		<table cellSpacing="0" bordercolordark="#5C7671"  cellPadding="1" width="100%" align="center" borderColorLight="#CFDAD8" border='1'>
			<tr bgcolor="#C8E3E8" style="font-family: Tahoma,Georgia;font-size:11px" align="center">
				...
				<td width="10%">Approve Item Desc</td>
