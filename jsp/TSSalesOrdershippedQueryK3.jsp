...
{    
	...
	//	return false;
	//}	
	document.MYFORM.action=URL+"?ACTTYPE=MANUAL";
...
<FORM ACTION="../jsp/TSSalesOrdershippedQueryK3.jsp" METHOD="post" NAME="MYFORM">
<strong><font style="font-size:20px;color:#006666">TSCC出入庫明細(For 金碟)</font></strong>
<BR>
  ...
  <table cellSpacing='0' cellPadding='1' width='100%' align='center' borderColorLight="#CFDAD8"  bordercolordark="#5C7671" border='1'>
		    <td width="10%" bgcolor="#D3E6F3"  style="font-weight:bold;color:#006666">Shipped Date :</td>   
			...
			&nbsp;&nbsp;
			&nbsp;&nbsp;
		    <INPUT TYPE="button" align="middle"  value='EXCEL'  style="font-family:ARIAL" onClick='setExportXLS("../jsp/TSSalesOrdershippedExcelK3.jsp")' > 
		</td>
	</tr>
</table>
