...
<p>
  <%  
	...
	//upload_file.saveAs("C:\\resin-2.1.9\\webapps\\wins\\report\\"+upload_file.getFileName()); // save file o server
	upload_file.saveAs("D:\\resin-2.1.9\\webapps\\wins\\report\\"+sModelNo+"PDS.xls"); // save file o server
	//InputStream is = new FileInputStream("C:\\resin-2.1.9\\webapps\\wins\\report\\"+upload_file.getFileName());   // open uplad file
    InputStream is = new FileInputStream("D:\\resin-2.1.9\\webapps\\wins\\report\\"+sModelNo+"PDS.xls");   // open uplad file
