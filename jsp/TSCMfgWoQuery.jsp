...
/*	
  ...
  else if (document.MYFORM.WOTYPE.value=="3"  || document.MYFORM.WOTYPE.value=="5")
  { 
	  URL="../jsp/TSCMfgWoExceltype3.jsp?WOTYPE="+xWOTYPE+"&MARKETTYPE="+xMARKETTYPE+"&DATESETBEGIN="+document.MYFORM.YEARFR.value+document.MYFORM.MONTHFR.value+document.MYFORM.DAYFR.value+"&DATESETEND="+document.MYFORM.YEARTO.value+document.MYFORM.MONTHTO.value+document.MYFORM.DAYTO.value+"&WONO="+document.MYFORM.WONO.value+"&MFGDEPTNO="+document.MYFORM.MFGDEPTNO.value+"&INVITEM="+document.MYFORM.INVITEM.value+"&WAFERLOT="+document.MYFORM.WAFERLOT.value; 
  }  
  document.MYFORM.action=URL;
  document.MYFORM.submit();
}
...
try
{
     ...
     sSql = " select distinct YWA.WORKORDER_ID,YWA.WO_NO,YWA.MARKET_TYPE,YWA.WORKORDER_TYPE,YWA.INV_ITEM,YWA.ITEM_DESC,  "+
			...
			"      TO_CHAR(TO_DATE(YWA.SCHEDULE_END_DATE,'YYYYMMDDHH24MISS'),'YYYY/MM/DD ')  ENDDATE, "+
	   		" 	   YWA.TSC_PACKAGE,YWA.TSC_AMP,YWA.TSC_FAMILY,YWA.TSC_PACKING,USER_NAME,YWA.STATUS,  "+
			"      TO_CHAR(TO_DATE(YWA.CREATION_DATE,'YYYYMMDDHH24MISS'),'YYYY/MM/DD ') as CREATEDATE,YWA.ORGANIZATION_ID,  "+
			"      YWA.ALTERNATE_ROUTING, YWA.ORDER_LINE_ID "+
			//"      ,OHA.ORDER_NUMBER,OLA.LINE_NUMBER || CASE WHEN OLA.SHIPMENT_NUMBER IS NOT NULL THEN  '.'||OLA.SHIPMENT_NUMBER ELSE NULL END ERP_LINE_NO"+ //add by Peggy 20190729
			"      ,(SELECT ORDER_NUMBER FROM ONT.OE_ORDER_HEADERS_ALL OHA WHERE OHA.HEADER_ID=YWA.ORDER_HEADER_ID) ORDER_NUMBER"+
			"      ,(SELECT OLA.LINE_NUMBER||CASE WHEN OLA.SHIPMENT_NUMBER IS NOT NULL THEN  '.'||OLA.SHIPMENT_NUMBER ELSE NULL END ERP_LINE_NO FROM ONT.OE_ORDER_LINES_ALL OLA WHERE OLA.LINE_ID=NVL(YWA.ORDER_LINE_ID,0)) ERP_LINE_NO"+
   ...
   sSqlCNT = " select count(WO_NO)  CaseCount from YEW_WORKORDER_ALL ,YEW_RUNCARD_ALL RC ";
			//" ,ONT.OE_ORDER_HEADERS_ALL OHA,ONT.OE_ORDER_LINES_ALL OLA ";//add by Peggy 20190729
...
{   
  try
 {
   ...
   if (woNo==null || woNo.equals(""))  {sWhere=sWhere+" ";}
   	...
   	//sWhere=sWhere+" and ( YWA.WO_NO ='"+woNo+"' or RC.RUNCARD_NO= '"+woNo+"' or RC.CUST_LOT_NO= '"+woNo+"' or YWA.OE_ORDER_NO= '"+woNo+"' or YWA.WAFER_IQC_NO = '"+woNo+"' or YWA.CUSTOMER_PO like '%"+woNo+"%') "  ; 
	 sWhere+=" AND ('"+woNo+"' IN ( ywa.wo_no,rc.runcard_no,rc.cust_lot_no ,ywa.oe_order_no,ywa.wafer_iqc_no) OR ywa.customer_po LIKE '%"+woNo+"%') "; 
	}   
...
%> 
  <table cellspacing="0" bordercolordark="#6699CC" cellpadding="1" width="100%" align="center" bordercolorlight="#ffffff" border="1">
     <tr>
	   ...
	   <td width="30%" nowrap><font color="#006666"><strong> &nbsp; &nbsp;工令號、流程卡號、Customer PO或MO單號</strong></font></td>
	   <td width="20%"> &nbsp;
 ...
 <table cellspacing="0" bordercolordark="#6699CC" cellpadding="1" width="100%" align="center" bordercolorlight="#ffffff" border="1">
	 ...
	 <td width="25%" nowrap><font color="#006666" face="Arial"><strong>
    品名/規格：</strong></font>
	   <input type="text" name="ITEMDESC" tabindex="5" size="20" onKeyDown="setItemFindCheck(this.form.INVITEM.value,this.form.ITEMDESC.value,this.form.ORGANIZATIONID.value)"><INPUT TYPE="button" tabindex="14"  value="..." onClick='subWindowItemFind(this.form.INVITEM.value,this.form.ITEMDESC.value)'></td>	 
		
	    <td width="21%" nowrap><font color="#006666" face="Arial"><strong>
	      晶片批號：</strong></font>
	      <input type="text" name="WAFERLOT" tabindex="11" size="16" onKeyDown='setWaferLotFindCheck(this.form.INVITEM.value,this.form.ITEMDESC.value,this.form.WAFERLOT.value)'>
...
<table cellspacing="0" bordercolordark="#6699CC" cellpadding="1" width="100%" align="center" bordercolorlight="#ffffff" border="1">	
     <tr>	    
	   <td nowrap colspan="2"><font color="#006666"><strong><jsp:getProperty name="rPH" property="pgWorkOrder"/>
...
<%
	     ...
	     //try
         //{       
         // String a[]={"2008","2009","2010","2011","2012","2013","2014","2015","2007","2006"};
       ...
       %>    </td>  
	<td colspan="2">
		    <INPUT TYPE="button" align="middle"  value='<jsp:getProperty name="rPH" property="pgQuery"/>' onClick='setSubmit("../jsp/TSCMfgWoQuery.jsp")' > 
...
%>
  ...
  <table cellspacing="0" bordercolordark="#6699CC" cellpadding="1" width="100%" align="center" bordercolorlight="#ffffff" border="1">
    <tr bgcolor="#BBD3E1"> 
	  ...
	  <td width="8%" height="22" nowrap><div align="center"><font color="#006666" face="Arial"><jsp:getProperty name="rPH" property="pgWorkOrder"/></font></div></td>               
	  <td width="7%" nowrap><div align="center"><font color="#006666" face="Arial">ERP MO</font></div></td>
	  <td width="3%" nowrap><div align="center"><font color="#006666" face="Arial">ERP MO Line</font></div></td>
	  <td width="3%" nowrap><div align="center"><font color="#006666" face="Arial">Market</font></div></td>
      <td width="3%" nowrap><div align="center"><font color="#006666" face="Arial"><jsp:getProperty name="rPH" property="pgClass"/></font></div></td>           
      <td width="12%" nowrap><div align="center"><font color="#006666" face="Arial"><jsp:getProperty name="rPH" property="pgPart"/></font></div></td> 
	  <td width="10%" nowrap><div align="center"><font color="#006666" face="Arial"><jsp:getProperty name="rPH" property="pgItemDesc"/></font></div></td>
	  <td width="4%" nowrap><div align="center"><font color="#006666" face="Arial"><jsp:getProperty name="rPH" property="pgQty"/></font></div></td>
	  <td width="4%" nowrap><div align="center"><font color="#006666" face="Arial">耗損</font></div></td>
	  <td width="4%" nowrap><div align="center"><font color="#006666" face="Arial">己完工</font></div></td>	 
	  <td width="4%" nowrap><div align="center"><font color="#006666" face="Arial"><jsp:getProperty name="rPH" property="pgUOM"/></font></div></td>  	   
	  <td width="6%" nowrap><div align="center"><font color="#006666" face="Arial"><jsp:getProperty name="rPH" property="pgSchStartDate"/></font></div></td>
	  <td width="6%" nowrap><div align="center"><font color="#006666" face="Arial"><jsp:getProperty name="rPH" property="pgSchCompletDate"/></font></div></td>
	  <td width="4%" nowrap><div align="center"><font color="#006666" face="Arial">預計出貨日</font></div></td>
	  <td width="4%" nowrap><div align="center"><font color="#006666" face="Arial">設立人員</font></div></td>	
	  <td width="4%" nowrap><div align="center"><font color="#006666" face="Arial">設立日期</font></div></td>
	  <td width="3%" nowrap><div align="center"><font color="#006666" face="Arial">工令狀態</font></div></td>
...
//
		...
		woQty=rsTC.getString("WO_QTY");
		woUom=rsTC.getString("WO_UOM");
		...
		woStatus=rsTC.getString("STATUS");
		oeLineId=rsTC.getString("STATUS");
...
//  欄位辨識
		...
		//20121011 liling for YEW audit issue
		if (woType.equals("3") && rsTC.getString("ORDER_LINE_ID")!=null) //add by Peggy 20191028,ORDER LINE ID不等於NULL
		 {
			String sqlm4 = " select to_char(SCHEDULE_SHIP_DATE,'yyyy/mm/dd') SCHEDULE_SHIP_DATE from oe_order_lines_all where line_id = '"+rsTC.getString("ORDER_LINE_ID")+"' ";
		//out.print("sqlm4"+sqlm4);
			 Statement statem4=con.createStatement();
			 ResultSet rsm4=statem4.executeQuery(sqlm4);
			  if (rsm4.next())
				  {  schShipDate = rsm4.getString("SCHEDULE_SHIP_DATE");   }
			  else schShipDate =("&nbsp;");
		  ...
		  else { schShipDate =("&nbsp;"); } //20121011 liling for YEW audit issue
    ...
    %>
    <tr bgcolor="<%=colorStr%>"> 
      <td bgcolor="#BBD3E1" width="2%"><div align="center"><font color="#006666" face="Arial"><a name='#<%=rsTC.getString("WORKORDER_ID")%>'><% out.println(rs1__index+1);%></a></font></div></td>
	  <td ><div align="center"><font color="#006666" face="Arial"><a href="../jsp/TSCMfgWoDetail.jsp?WO_NO=<%=woNo%>" onMouseOver='this.T_ABOVE=false;this.T_WIDTH=180;this.T_OPACITY=80;return escape("<%=clkDesc%>")'><%=woNo%></a></font></div></td>
	  <td ><div align="center"><font color="#006666" face="Arial"><%=(rsTC.getString("ORDER_NUMBER")==null?"&nbsp;":rsTC.getString("ORDER_NUMBER"))%></font></div></td>
	  <td ><div align="center"><font color="#006666" face="Arial"><%=(rsTC.getString("ERP_LINE_NO")==null?"&nbsp;":rsTC.getString("ERP_LINE_NO"))%></font></div></td>
	  <td ><div align="center"><font color="#006666" face="Arial"><%=marketCode%></font></div></td>
	  <td ><div align="center"><font color="#006666" face="Arial"><%=woTypeCode%></font></div></td>
	  ...
	  <td ><div align="center"><font color="#006666" face="Arial"><%=completeQty%></font></div></td>
	  <td ><div align="center"><font color="#006666" face="Arial"><%=woUom%></font></div></td>	  
	  <td ><div align="center"><font color="#006666" face="Arial"><%=startDate%></font></div></td>
      <td ><div align="center"><font color="#006666" face="Arial"><%=endDate%></font></div></td> 
	  <td nowrap><div align="center"><font color="#006666" face="Arial"><%=schShipDate%></font></div></td> 
	  <td nowrap><div align="center"><font color="#006666" face="Arial"><%=userName%></font></div></td>
      <td ><div align="center"><font color="#006666" face="Arial"><%=createDate%></font></div></td>  
	  <td nowrap><div align="center"><font color="#006666" face="Arial"><%=olStatus%></font></div></td> 
    </tr>
    <%
  rs1__index++;
  rs_hasDataTC = rsTC.next();
...
%>
    <tr bgcolor="#BBD3E1"> 
      <td height="23" colspan="18" ><font color="#006666">工令筆數</font> 
        <% 
	      if (CaseCount==0) 
