...
<jsp:getProperty name="rPH" property="pgQuery"/>
<jsp:getProperty name="rPH" property="pgSPCProcessSummary"/><jsp:getProperty name="rPH" property="pgDetail"/><jsp:getProperty name="rPH" property="pgQuery"/>
 <% } else if (statusCode.equals("F")) { %>
 <jsp:getProperty name="rPH" property="pgFCTProcessSummary"/><jsp:getProperty name="rPH" property="pgDetail"/>
 <%
   }
 %>
 </strong></font>
...
{
   sSql =  sSql = "select DISTINCT a.DNDOCNO, b.LINE_NO, b.ITEM_DESCRIPTION, b.UOM, b.QUANTITY, TO_CHAR(TO_DATE(b.REQUEST_DATE,'YYYYMMDDHH24MISS'),'YYYY/MM/DD'),"+
          "b.PCCFMDATE, b.FTACPDATE, b.PCACPDATE, c.ORISTATUSID, c.ORISTATUS, c.PROCESS_WORKTIME, c.ACTIONNAME, c.UPDATEUSERID, c.SERIALROW "+          
		  "from ORADDMAN.TSDELIVERY_NOTICE a,ORADDMAN.TSDELIVERY_NOTICE_DETAIL b, ORADDMAN.TSDELIVERY_DETAIL_HISTORY c ";		 
   sSqlCNT = "SELECT count(a.DNDOCNO) as CaseCount FROM ORADDMAN.TSDELIVERY_NOTICE a,ORADDMAN.TSDELIVERY_NOTICE_DETAIL b, ORADDMAN.TSDELIVERY_DETAIL_HISTORY c ";
   sWhere =  "WHERE a.DNDOCNO = b.DNDOCNO and a.DNDOCNO = c.DNDOCNO "+
               "and b.LINE_NO = c.LINE_NO ";     // 預設進入頁面即將小於今日 			
			   
   sOrder = "order by a.DNDOCNO, b.LINE_NO, c.SERIALROW ";		
   ...
   if (dnDocNo!=null && !dnDocNo.equals("")) { sWhere=sWhere+" and a.DNDOCNO ='"+dnDocNo+"'"; }
...
{ 
   sSql = "select DISTINCT a.DNDOCNO, b.LINE_NO, b.ITEM_DESCRIPTION, b.UOM, b.QUANTITY, TO_CHAR(TO_DATE(b.REQUEST_DATE,'YYYYMMDDHH24MISS'),'YYYY/MM/DD'),"+
          "decode(b.PCCFMDATE,'N/A','N/A',to_char(to_date(b.PCCFMDATE,'YYYYMMDDHH24MISS'),'YYYY/MM/DD')) as PCCFMDATE, "+
		  "decode(b.FTACPDATE,'N/A','N/A',to_char(to_date(b.FTACPDATE,'YYYYMMDDHH24MISS'),'YYYY/MM/DD')) as FTACPDATE, "+
		  "decode(b.PCACPDATE,'N/A','N/A',to_char(to_date(b.PCACPDATE,'YYYYMMDDHH24MISS'),'YYYY/MM/DD')) as PCACPDATE, "+
		  "decode(b.SASCODATE,'N/A','N/A',to_char(to_date(b.SASCODATE,'YYYYMMDDHH24MISS'),'YYYY/MM/DD')) as SASCODATE, "+
		  "c.ORISTATUSID, c.ORISTATUS, "+
		  "decode(c.CDATETIME,'N/A','N/A',to_char(to_date(c.CDATETIME,'YYYYMMDDHH24MISS'),'YYYY/MM/DD')) as CDATETIME, "+
		  "c.PROCESS_WORKTIME, c.ACTIONNAME, c.UPDATEUSERID, c.SERIALROW "+          
		  "from ORADDMAN.TSDELIVERY_NOTICE a,ORADDMAN.TSDELIVERY_NOTICE_DETAIL b, ORADDMAN.TSDELIVERY_DETAIL_HISTORY c ";
   sSqlCNT = "SELECT count(a.DNDOCNO) as CaseCount FROM ORADDMAN.TSDELIVERY_NOTICE a,ORADDMAN.TSDELIVERY_NOTICE_DETAIL b, ORADDMAN.TSDELIVERY_DETAIL_HISTORY c ";
   sWhere =  "WHERE a.DNDOCNO = b.DNDOCNO and a.DNDOCNO = c.DNDOCNO "+
               "and b.LINE_NO = c.LINE_NO ";     // 預設進入頁面即將小於今日 	
   ...
   { 
    sWhere=sWhere+" and b.LSTATUSID ='010' and c.ORISTATUSID = '009' "; // 已結案單據來自於生成訂單頁面 
	if ((!(DayFr=="--")&&(DayFr=="00")) && DayTo=="--") sWhere=sWhere+" and substr(b.CREATION_DATE,0,8) >="+"'"+dateSetBegin+"'";
    if (DayFr!="--" && DayTo!="--") sWhere=sWhere+" and substr(b.CREATION_DATE,0,8) >= "+"'"+dateSetBegin+"'"+" AND substr(b.CREATION_DATE,0,8) <= "+"'"+dateSetEnd+"'";
   } // 只找業務結案的單據 (對應HISTORY 的 ORISTATUSID in ('009') )
   else if (statusCode.equals("SA")) 
   { 
    sWhere=sWhere+" and b.LSTATUSID = '012' and c.ORISTATUSID = '008' ";  // 放棄交期單據來自於客戶待確認作業狀態
	if ((!(DayFr=="--")&&(DayFr=="00")) && DayTo=="--") sWhere=sWhere+" and substr(b.CREATION_DATE,0,8) >="+"'"+dateSetBegin+"'";
    if (DayFr!="--" && DayTo!="--") sWhere=sWhere+" and substr(b.CREATION_DATE,0,8) >= "+"'"+dateSetBegin+"'"+" AND substr(b.CREATION_DATE,0,8) <= "+"'"+dateSetEnd+"'"; 
  ...
  //out.println(sSql);    
   ...
   String sqlOrgCnt = "select count(a.DNDOCNO) as CaseCountORG from ORADDMAN.TSDELIVERY_NOTICE a,ORADDMAN.TSDELIVERY_NOTICE_DETAIL b, ORADDMAN.TSDELIVERY_DETAIL_HISTORY c ";
  ...
  <table cellSpacing="0" bordercolordark="#99CC99" cellPadding="1" width="97%" align="center" bordercolorlight="#FFFFCC"  border="1">
   <tbody>
    <tr bgcolor="#CCFFCC"> 
	  ...
	  <td width="3%"  height="19" nowrap><div align="center"><font color="#006699" face="Arial" size="2"><strong><jsp:getProperty name="rPH" property="pgQDocNo"/></strong></font></div></td> 
	  <td width="3%"  height="19" nowrap><div align="center"><font color="#006699" face="Arial" size="2"><strong><jsp:getProperty name="rPH" property="pgAnItem"/></strong></font></div></td>   
      <td width="9%" height="22" nowrap><div align="center"><font color="#006699" face="Arial" size="-1"><jsp:getProperty name="rPH" property="pgTSCAlias"/><jsp:getProperty name="rPH" property="pgOrderedItem"/><jsp:getProperty name="rPH" property="pgDesc"/></font></div></td>          
      <td width="10%" nowrap><div align="center"><font color="#006699" face="Arial" size="-1"><jsp:getProperty name="rPH" property="pgUOM"/></font></div></td>
      <td width="14%" nowrap><div align="center"><font color="#006699" face="Arial" size="-1"><jsp:getProperty name="rPH" property="pgQty"/></font></div></td>      
      <td width="9%" nowrap><div align="center"><font color="#006699" face="Arial" size="-1"><jsp:getProperty name="rPH" property="pgRequestDate"/></font></div></td>
      <td width="14%" nowrap><div align="center"><font color="#006699" face="Arial" size="-1"><jsp:getProperty name="rPH" property="pgPCAssignDate"/></font></div></td>      
      <td width="21%" nowrap><div align="center"><font color="#006699" face="Arial" size="-1"><jsp:getProperty name="rPH" property="pgFTArrangeDate"/></font></div></td>
	  ...
	  <td width="13%" nowrap><div align="center"><font color="#006699" face="Arial" size="-1"><jsp:getProperty name="rPH" property="pgOrdCreateDate"/></font></div></td>	
	  <td width="13%" nowrap><div align="center"><font color="#006699" face="Arial" size="-1"><jsp:getProperty name="rPH" property="pgOriStat"/></font></div></td>  
	  <td width="13%" nowrap><div align="center"><font color="#006699" face="Arial" size="-1"><jsp:getProperty name="rPH" property="pgWKFDESC"/></font></div></td>
	  <td width="13%" nowrap><div align="center"><font color="#006699" face="Arial" size="-1"><jsp:getProperty name="rPH" property="pgAction"/></font></div></td>
	  <td width="13%" nowrap><div align="center"><font color="#006699" face="Arial" size="-1"><jsp:getProperty name="rPH" property="pgExecutor"/></font></div></td>
	  <td width="13%" nowrap><div align="center"><font color="#006699" face="Arial" size="-1"><jsp:getProperty name="rPH" property="pgTheItem"/><jsp:getProperty name="rPH" property="pgProcessTime"/></font></div></td>
	  <td width="13%" nowrap><div align="center"><font color="#006699" face="Arial" size="-1"><jsp:getProperty name="rPH" property="pgWorkHour"/></font></div></td>        
    </tr>
    ...
    <tr bgcolor="<%=colorStr%>"> 
	  ...
	  <td height="20"><div align="center"><font size="-1"><%=rsTC.getString("LINE_NO") %></font></div></td>      
	  <td nowrap><font size="-1"><%=rsTC.getString("ITEM_DESCRIPTION") %></font></td>      
      <td width="10%" nowrap><font size="-1"><%=rsTC.getString("UOM")%></font></td>
      <td width="14%" nowrap><font size="-1"><%=rsTC.getString("QUANTITY")%></font></td>
      <td width="9%" nowrap><font size="-1"><%=rsTC.getString(6)%></font></td>
      <td width="14%" nowrap><font size="-1"><%=rsTC.getString("PCCFMDATE")%></font></td>      
      <td width="21%" nowrap><font size="-1"><%=rsTC.getString("FTACPDATE")%></font></td>      
      <td width="13%" nowrap><font size="-1"><%=rsTC.getString("PCACPDATE")%></font></td>
	  <td width="13%" nowrap><font size="-1"><%=rsTC.getString("SASCODATE")%></font></td>
	  <td width="13%" nowrap><font size="-1"><%=rsTC.getString("ORISTATUSID")%></font></td> 
	  <td width="13%" nowrap><font size="-1"><%=rsTC.getString("ORISTATUS")%></font></td>
	  <td width="13%" nowrap><font size="-1"><%=rsTC.getString("ACTIONNAME")%></font></td> 
	  <td width="13%" nowrap><font size="-1"><%=rsTC.getString("UPDATEUSERID")%></font></td> 
	  <td width="13%" nowrap><font size="-1"><%=rsTC.getString("CDATETIME")%></font></td>  
	  <td width="13%" nowrap><font size="-1"><%=rsTC.getString("PROCESS_WORKTIME")%></font></td>     
    </tr>
    <%
      rs1__index++;
      rs_hasDataTC = rsTC.next();
...
%>
    <tr bgcolor="#CCFFCC"> 
      <td height="23" colspan="17" ><font color="#006699" size="-1">總資料筆數</font> 
        <% 
	      if (CaseCount==0) 
		  { //若 	  
		  } 
