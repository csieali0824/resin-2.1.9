...
<jsp:useBean id="FactoryCFMBean" scope="session" class="bean.Array2DimensionInputBean"/>
...
%>
<body> 
<FORM ACTION="../jsp/TSCSGPOBuyer.jsp" METHOD="post" NAME="MYFORM">
<div style="font-family:Tahoma,Georgia;font-weight:bold;font-size:20px">SG PO Accept Check </div>
...
<br>
  <DIV align="CENTER"><input type="button" name="btnQuery" value="Query"  style="font-family:Tahoma,Georgia;font-size:12px" onClick="setQuery('../jsp/TSCSGPOBuyer.jsp')">&nbsp;&nbsp;
  </DIV>
        <HR>
<%
try
...
<table align="center" width="100%" border="1" bordercolorlight="#333366" bordercolordark="#ffffff" cellPadding="1" cellspacing="0">
	<tr style="background-color:#D1E0D3;color:#000000">
		<td width="2%" align="center" style="background-color:#CCCCFF;color:#000000">&nbsp;</td>
		<td width="2%" align="center" style="background-color:#CCCCFF;color:#000000"><input type="checkbox" name="chkall"  onClick="checkall()"></td>
		<td width="16%" align="center" style="background-color:#CCCCFF;color:#000000"> CFM Result</td>
		<td width="6%" align="center" style="background-color:#CCCCFF;color:#000000">Remark</td>
		<td width="4%" style="background-color:#67DCCB;" align="center">廠商直出</td>
		<td width="4%" style="background-color:#67DCCB;" align="center">內外銷</td>
		<td width="7%" style="background-color:#67DCCB;" align="center">Receipt Num</td>
		<td width="7%" style="background-color:#67DCCB;" align="center">PO NO</td>
		<td width="11%" style="background-color:#67DCCB;" align="center">Vendor Name</td>
		<td width="7%" style="background-color:#67DCCB;" align="center">TSC Prod Group</td>
		<td width="8%" style="background-color:#67DCCB;" align="center">Item Desc</td>
		<td width="7%" style="background-color:#67DCCB;">Lot Number</td>
		<td width="6%" style="background-color:#67DCCB;" align="center">Date Code</td>
		<td width="6%" style="background-color:#67DCCB;" align="center">Qty(K)</td>
		<td width="6%" style="background-color:#67DCCB;" align="center">Receive Date</td>
	</tr>
		<%
		}
...
<table border="0" width="100%" bgcolor="#DAF0FC">
	<tr>
		<td align="center"><input type="button" name="submit1" value="Submit" style="font-size:11px;font-family: Tahoma,Georgia;" onClick='setSubmit("../jsp/TSCSGPOReceiveProcess.jsp?TRANSTYPE=BUYERCHECK")'></td>
	</tr>
</table>
<hr>
	<%
