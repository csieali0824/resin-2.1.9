...
<body>
<font color="#3366FF" size="+2" face="Arial"><font size="+3" face="Arial Black"><font color="#3366FF" size="+2" face="Arial"><font size="+3" face="Arial Black"><font face="Courier, MS Sans Serif"><font color="#54A7A7" size="+2" face="Arial Black">TSC</font></font></font></font><font face="Courier, MS Sans Serif"></font></font></font><font color="#000000" size="+2" face="Times New Roman"> 
<strong>Other Invoice Create(CN To HK)</strong></font>
<FORM ACTION="../jsp/TscOtherInvCreateCN2HKSubmit.jsp" METHOD="post" NAME="MYFORM">
<%
...
<% 
	 ...
	 if (shipMethod==null || shipMethod.equals("")) { shipMethod=""; };
	 if (shipFrom==null || shipFrom.equals("")) { shipFrom=""; };
	 if (shipMark==null || shipMark.equals("")) { shipMark=""; };
     
  %>
<table width="100%" border="0">
  <tr bgcolor="#339999">    
    <td bordercolor="#FFFFFF" nowrap><div align="center"><font color="#FFFF00"><strong>Please Input Invoice No.</strong></font>
        <input name="INVOICENO" type="text" value="<%=invoiceNo%>" size="20" maxlength="15"></div>
    </td>	
	<td width="38%" bordercolor="#FFFFFF" nowrap><font color="#FFFF00"><strong>Please choice Invoice Date</strong></font>
        <%
  ...
  <tr bgcolor="#339999">
    <td width="38%" bordercolor="#FFFFFF" nowrap><font color="#FFFF00"><strong>SHIPPING METHOD</strong></font>
	   <select name = "SHIPMETHOD" size="1">
    ...
    <td width="38%" bordercolor="#FFFFFF" nowrap><font color="#FFFF00"><strong>(起運地)      FROM</strong></font> 
	   <select name = "SHIPFROM" size="1">
         <option value = "TIANJIN AIRPORT CHINA">TIANJIN AIRPORT CHINA</OPTION>
         <option value="JINAN AIRPORT CHINA">JINAN AIRPORT CHINA</option>
         <option value = "QINGDAO AIRPORT CHINA">QINGDAO AIRPORT CHINA</OPTION>      
         <option value = "XINGANG PORT CHINA">XINGANG PORT CHINA</OPTION>
         <option value="QINGDAO PORT CHINA">QINGDAO PORT CHINA</option>
		 <option value="KEELUNG PORT TAIWAN">KEELUNG PORT TAIWAN</option>
         <option value="CKS AIR PORT TAIWAN">CKS AIR PORT TAIWAN</option>
       </select>   
	</td> 
  </tr>
  <tr bgcolor="#339999">    
  ...
  <input type="hidden" name="SHIPMARK">
  <tr>
    <td bordercolor="#FFFFFF" nowrap colspan="2"><div align="center">
    <font color="#FFFF00"><strong><input name="submit2" type="submit" value="Submit" onClick='return setSubmit2("../jsp/TscOtherInvCreateCN2HKSubmit.jsp")'></strong></font>
     &nbsp;	
