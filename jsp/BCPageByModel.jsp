...
<title>BCPageByModel.jsp</title>
</head>

<body >
  <FORM METHOD=post ACTION="BCPageByModelDb.jsp">
  <%
...
<jsp:useBean id="comboBoxAllBean" scope="page" class="ComboBoxAllBean"/>
  <strong><font size="+2">計算本月退貨/上月出貨比率</font></strong><BR>
...
<table width="39%" border="1" align="center" cellpadding="0" cellspacing="0">
    ...
    <tr bgcolor="#FFFFFF"> 
	  ...
	  <%
			  ...
			  ResultSet rs=statement.executeQuery("select distinct MODEL a,MODEL b from WSMODEL_ITEM_T order by a");
