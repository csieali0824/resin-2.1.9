...
<body>
<FORM ACTION="../jsp/TSCSGShippingAdviseOverviewReport.jsp" METHOD="post" name="MYFORM">
<%
...
{ 	
	...
	RPTName = "TSCSGShippingAdviseOverView";
	...
	sql = " select x.* "+
          ...
          "             ,a.so_header_id"+
          "             ,a.to_tw"+
          "             ,tssg_ship_pkg.GET_ORDER_CARTON_LIST('ORDER_LINE',a.advise_no,a.so_line_id,'0','0') CARTON_LIST"+
          ...
          "            ,y.vendor_id"+
          "            ,y.vendor_site_code"+
          "            ,TSC_GET_ITEM_PACKING_CODE(43,X.INVENTORY_ITEM_ID) TSC_PACKING_CODE"+
          "            ,tsc_label_pkg.TSC_GET_CUST_LABEL_GROUP(X.so_line_id) CUST_LABEL_GROUP"+
          "            ,(SELECT SUM(round(b.CARTON_QTY*b.TOTAL_QTY/(select sum(c.TOTAL_QTY) from tsc.tsc_shipping_advise_lines c where c.tew_advise_no=b.tew_advise_no and c.carton_num_fr =b.carton_num_fr and c.carton_num_to=b.carton_num_to),1))   "+
          "              FROM tsc.tsc_shipping_advise_lines b WHERE x.pc_advise_id=b.pc_advise_id) CARTON_NUM "+
          "            ,tssg_ship_pkg.GET_SO_DESTINATION(x.advise_no,x.so_header_id) destination"+
          "            FROM tsc_shipping_advise_pc_sg x"+
          "                 ,ap.ap_supplier_sites_all y"+
		  "            where  x.pc_schedule_ship_date between to_date('"+SDATE+"','yyyymmdd') and to_date('"+EDATE+"','yyyymmdd')+0.99999 "+
          "            and x.vendor_site_id=y.vendor_site_id "+
          "            and x.advise_no is not null ) a"+
          "         ,ONT.OE_ORDER_LINES_ALL c"+
          "      ,ar_customers d "+
          " ,(select * from tsc_item_packing_master where INT_TYPE ='SG' and STATUS='Y') e"+
