...
function searchRepNo(actionID,EDITION,TIME,searchString) 
{   
  location.href="../jsp/LCProcess.jsp?ACTIONID="+actionID+"&EDITION="+EDITION+"&TIME="+TIME+"&SEARCHSTRING="+searchString     
 }
 function searchRepNoD(actionIDD,EDITION,TIME,searchString) 
{   
  location.href="../jsp/LCProcessD.jsp?ACTIONIDD="+actionIDD+"&EDITION="+EDITION+"&TIME="+TIME+"&SEARCHSTRING="+searchString     
 }
</script>
...
%>
  ...
  <FORM ACTION="../jsp/LCConfirmShow.jsp" METHOD="post" NAME="MYFORM">  
<table width="100%">
     <tr bgcolor="#D0FFFF"> 	
      <td width="37%" valign="top" bordercolor="#CCCCCC" bgcolor="#CCEEFF">LC 
        NO</strong></font> 
        <input name="SEARCHSTRING" type="text" size="20"  maxlength="20"></td>
	   
      <td width="47%" align="center" bgcolor="#D0FFFF"><div align="left"> 
          <input name="submit1" type="submit" value="Enter" >
          <input name="search" type=button onClick="searchRepNo('<%=actionID%>','<%=EDITION%>','<%=TIME%>','<%=searchString%>')" value="CONFIRM"> 
		 <input name="searchD" type=button onClick="searchRepNoD('<%=actionIDD%>','<%=EDITION%>','<%=TIME%>','<%=searchString%>')" value="DELETE"> 
	     <input type="hidden" name="SEARCHSTRING" value="<%= searchString %>" >
        </div></td> 	      	     
	   
      <td width="16%" bgcolor="#D0FFFF">&nbsp; </td>
	</tr>
  </table>
  ...
  <tr bgcolor="#CCFFFF"> 
    <td width="11%"><font size="2"><strong>PO NO.</strong></font></td>
	<td width="12%"><font size="2"><strong>PO LINE</strong></font></td>
	<td width="14%"><font size="2"><strong>Item No.</strong></font></td>
	<td width="11%"><font size="2"><strong>Qty.</strong></font></td>
    <td width="11%"><font size="2"><strong>Unit Price</strong></font></td>
    <td width="16%" nowrap><font size="2"><strong>Currency</strong></font></td>
  </tr>
  <% //  *** Main Loop  Start   *** //
...
String sql = "select LPORD,LPLINE,LPPROD,LPQORD,LPECST,LPOCUR,PLCNO from POLC where PLCNO = '"+searchString+"'";
//String sWhere = "Where ";
			...
			/*if (plcno==null || plcno.equals("")) 
			{   sWhere = sWhere + " PLCNO !=  'ALL'  "; }
		    else { sWhere = sWhere + " PLCNO = '"+plcno+"'  "; }
            		  
		    String sOrder = "order by LPORD ";
