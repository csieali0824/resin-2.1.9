...
<body>
<FORM ACTION="file:///P|/resin-2.1.9/webapps/wins/jsp/WSShipStatisticAuto.jsp" METHOD="post" NAME="MYFORM" >
  ...
  <table width="100%" border="1" cellspacing="0" cellpadding="0">
    ...
    {      	
       ...
       ResultSet docrs=docstatement.executeQuery("select unique colordesc from prodmodel,picolor_master where MITEM='"+fmItem+"' and mcolor=colorcode");	 
