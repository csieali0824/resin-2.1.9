...
String prodExtend=request.getParameter("PRODEXTEND");
String extendDesc=request.getParameter("EXTENDDESC");
...
{  
	   ...
	   //{
		 ...
		 //String c_in_array=request.getParameter("MONTH"+ac+"-"+subac);//取前一頁之輸入欄位
          // sql="insert into PSALES_FORE_COST(FCCOMP,FCYEAR,FCMONTH,FCREG,FCCOUN,FCTYPE,FCPRJCD,FCCOST,FCMVER,FCLUSER,FCCURR) values(?,?,?,?,?,?,?,?,?,?,?)";
           sql="insert into MRPROD_EXT(PRODEXT_CODE,PRODEXTEND,PRODEXT_DESC) values(?,?,?)";
  ...
  out.println("輸入產品機種延伸代碼新增成功 !!!<BR>");
  out.println("<A HREF=/wins/WinsMainMenu.jsp>首頁</A>&nbsp;&nbsp;<A HREF=../jsp/WSMRProdExtendInput.jsp?ENTRY=TRUE>產品機種延伸代碼資料新增</A>&nbsp;&nbsp;<A HREF='../jsp/WSMRProdExtendInquiry.jsp'>產品機種延伸代碼資料查詢</A> ");
