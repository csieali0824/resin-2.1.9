	...
	<td nowrap colspan="2"><font color="#006666"><strong>工令類別</strong></font><font color="#CC3366" face="Arial Black">&nbsp;</font>
	   <%
                 ...
                 {  
				   ...
				   */
				   out.println("<select NAME='WOTYPE' onChange='setSubmit("+'"'+"../jsp/TSCMfgWIPSingleOPEntry.jsp"+'"'+")'>");
...
<table cellspacing="0" bordercolordark="#6699CC" cellpadding="1" width="100%" align="center" bordercolorlight="#ffffff" border="1">
  ...
  <tr bgColor="#d8e6e7">
    ...
    <td nowrap>
      <div align="center">
        <font face="Arial" color="#000000">工令號</font>
      </div>
    </td>
    <td nowrap>
      <div align="center">
        <font face="Arial" color="#000000">上月此工令結存</font>
      </div>
    </td>
    <td nowrap>
      <div align="center">
        <font face="Arial" color="#000000">工令累計接收</font>
      </div>
    </td>
    <td nowrap>
      <div align="center">
        <font face="Arial" color="#000000">工令累計處理</font>
      </div>
    </td>
    <td nowrap>
      <div align="center">
        <font face="Arial" color="#000000">工令累計產出</font>
      </div>
    </td>
    <td nowrap>
      <div align="center">
        <font face="Arial" color="#000000">工令累計耗損</font>
      </div>
    </td>
    <td nowrap>
      <div align="center">
    ...
    <td nowrap>
      <div align="center">
        <font face="Arial" color="#000000">累計回報工時</font>
      </div>
    </td>
    <td nowrap>
      <div align="center">
