...
<title>Query All Material Request Confirmation that need to receive </title>
<style type="text/css">
<!--
.style1 {color: #FF0000}
-->
...
{   
  location.href="../jsp/WSFore_MRC_ReceiveQueryAll.jsp?SEARCHSTRING="+document.MYFORM.SEARCHSTRING.value;
}
</script>
<%   
 ...
 {         
   ...
   {	
	 sql="select DOCNO,'REPLIED' as STATUS,TARGETYEAR||'/'||TARGETMONTH as TARGET_DATE from PSALES_FORE_MRC_HD where IS_COMPLETE='Y' and DOCNO like '"+searchString+"%' order by TARGET_DATE desc";	
   } else {    
	 sql="select DOCNO,'REPLIED' as STATUS,TARGETYEAR||'/'||TARGETMONTH as TARGET_DATE from PSALES_FORE_MRC_HD where IS_COMPLETE='Y' order by TARGET_DATE desc";	  
   }        
...
<strong>Material Request Confirmation List(</strong></font><font size="+1" face="Times New Roman"><strong><span class="style1">need
to receive</span></strong></font><font color="#000000" size="+1" face="Times New Roman"><strong>)</strong></font>
<BR>
...
<table width="100%" border="0">
 ...
 {       
   ...
   String a[]={"","DOC NO","STATUS","TARGET DATE"};	
   queryAllEditBean.setPageURL("../jsp/WSFore_MRC_Receive.jsp");      
   queryAllEditBean.setHeaderArray(a);   
   queryAllEditBean.setOptionURI("");   
