...
<body>
<strong><font color="#0080C0" size="5">PO查詢報表</font></strong> 
<%
   int rs1__numRows = 25;
   int rs1__index = 0;
   int rs_numRows = 0;
...
<%
  ...
  String dayto=request.getParameter("DAYTO");  
  //float lpord=0;
  String lpord=request.getParameter("LPORD");  
 ...
 //out.print(userRoles+"<br>");
 //out.print(userID+"<br>");
 //out.print(userRepCenterNo +"<br>");
 
  int numRow = 0;  
%>

  <FORM ACTION="../jsp/ByPOShow2.jsp" METHOD="post" NAME="MYFORM">
  <table width="100%">
     <tr bgcolor="#D0FFFF"> 	
      ...
      <td width="65%" bgcolor="#D0FFFF"> <font color="#CC3366" face="Arial Black"><strong>PO 
        NO</strong></font> 
        <input name="LPORD" type="text" size="20" maxlength="20">
	   </td>     	     
	   <td width="6%" bgcolor="#D0FFFF">
  ...
  <tr bgcolor="#CCFFFF"> 
  <td width="4%" ><font size="2"><strong>LINK</strong></font></td>
      <td width="12%"><font size="2"><strong>LC NO</strong></font></td>
      <td width="6%"><font size="2"><strong>LINE</strong></font></td>
      <td width="10%" nowrap><font size="2"><strong>CURRENCY</strong></font></td>
      <td width="9%"><font size="2"><strong>Q'TY</strong></font></td>
      <td width="8%" ><font size="2"><strong>PRICE</strong></font></td>
	  <td width="7%"><font size="2"><strong>USAGE</strong></font></td>
	  <td width="13%"><font size="2"><strong>SHORTAGE</strong></font></td>
	  <td width="9%"><font size="2"><strong>STATUS</strong></font></td>
  </tr>
  <% //  *** Main Loop  Start   *** //
       //ResultSet RpRepair = StatementRpRepair.executeQuery(); 	   
		   ...
		   { 
			...
			/////////////////////////////////////////////////////
             ...
             sql="select PLCNO,LPLINE,LPOCUR,LPQORD,LPECST,LCUSAMT,LPQORD*LPECST-LCUSAMT SHORTAGE,LPSTAT from POLC ";
             String sWhere = "where LPORD='"+lpord+"' ";
...
//////////////////////////////////////////////////////////////////////////////////////////////			
  ...
  <%
   ...
   %>
  <tr bgcolor="<%=colorStr%>"> 
  <td><a href="../jsp/ByPoEdit.jsp?PLCNO=<%=rs.getString("PLCNO")%>&LPLINE=<%=rs.getString("LPLINE")%>"><img src="../image/docicon.gif" width="14" height="19" border="0"></a></td>
    <td nowrap><font color="#993366" size="2"><strong><%=rs.getString("PLCNO")%></strong></font></td>
	...
	<td nowrap><font color="#993366" size="2"><strong><%=rs.getString("SHORTAGE")%></strong></font></td>
