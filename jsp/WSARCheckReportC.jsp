...
<body>
<FORM ACTION="WSARCheckReportC.jsp" METHOD="post" NAME="MYFORM">
  <div align="left">
    <table width="100%" border="0">
      ...
      <tr>
        <td><div align="center"><strong><font color="#0000FF" size="+2" face="Arial">監檢日報表(應收帳款餘額)</font></strong> 
            <%
   int rs1__numRows = 5000;
   int rs1__index = 0;
   int rs_numRows = 0;
 ...
 %>
  ...
  <table width="100%" border="0">
    <tr> 
      ...
      <td width="28%" bgcolor="#006699"><input name="button" type="button" onClick='setSubmit("../jsp/WSARCheckReportC.jsp")'  value="Query" > 
  ...
  <table width="100%" border="1" cellspacing="0" cellpadding="0">
    <tr bgcolor="#006666"> 
      ...
      <td width="10%" rowspan="2" bgcolor="#99CCFF"> <div align="center"><strong><font size="2">到款金額減出貨金額</font></strong></div></td>
      <td width="15%" rowspan="2" nowrap bgcolor="#99CCFF"> <div align="center"><strong><font size="2">備註</font></strong></div></td>
    </tr>
    <tr bgcolor="#006666"> 
      <td width="2%" bgcolor="#6699FF" nowrap><font color="#FFFFFF" size="2"><strong><font size="2">代號</font></strong></font></td>
      <td width="18%" bgcolor="#6699FF"> <div align="center"><font color="#FFFFFF" size="2"><strong><font size="2">名稱</font></strong></font></div></td>
      ...
      <td width="4%" nowrap bordercolor="#000000" bgcolor="#6699FF"> <div align="right"><font color="#FFFFFF"><strong><font size="2" face="新細明體">數量</font></strong></font></div></td>
      <td width="7%"bordercolor="#000000" bgcolor="#6699FF"> <div align="right"><font color="#FFFFFF"><strong><font size="2" face="新細明體">金額</font></strong></font></div></td>
      <td width="5%"bordercolor="#000000" bgcolor="#6699FF"> <div align="center"><font color="#FFFFFF"><strong><font size="2" face="新細明體">日期</font></strong></font></div></td>
      <td width="4%" nowrap bgcolor="#6699FF" nowrapbordercolor="#000000"> <div align="right"><font color="#FFFFFF"><strong><font size="2" face="新細明體">數量</font></strong></font></div></td>
      <td width="7%"bordercolor="#000000" bgcolor="#6699FF"> <div align="right"><font color="#FFFFFF"><strong><font size="2" face="新細明體">金額</font></strong></font></div></td>
      <td width="5%"bordercolor="#000000" bgcolor="#6699FF"> <div align="center"><font color="#FFFFFF"><strong><font size="2" face="新細明體">日期</font></strong></font></div></td>
      <td width="7%"bordercolor="#000000" bgcolor="#6699FF"> <div align="right"><font color="#FFFFFF"><strong><font size="2" face="新細明體">金額</font></strong></font></div></td>
      <td width="4%" nowrap bgcolor="#6699FF" nowrapbordercolor="#000000"> <div align="right"><font color="#FFFFFF"><strong><font size="2" face="新細明體">數量</font></strong></font></div></td>
    ...
    <tr bgcolor="#FFFFFF"> 
      ...
      <td><div align="center"><font size="2" color="#000099">&nbsp; </font> <font color="#000000" size="2" face="Arial, Helvetica, sans-serif"><%=rsTC.getString("arodyr") %> <%=rsTC.getString("arodpx") %> <%=rsTC.getString("rinvc") %> </font><font color="#0000FF" size="2" face="Arial, Helvetica, sans-serif"> 
          <% 
		   int CKSTS = 0; 
	...
	out.println("<tr bgcolor='#FFCCFF'><td colspan='4'>&nbsp;</td><td><font size='2' color='#000099' face='Arial'><div align='right'>"+subsumLQORD_str+"</div></font></td><td><font size='2' color='#000099' face='Arial'><div align='right'>"+subsumLAMT_str+"</div></font></td><td>&nbsp;</td><td><font size='2' color='#000099' face='Arial'><div align='right'>"+subsumILQTY_str+"</div></font></td><td><font size='2' color='#000099' face='Arial'><div align='right'>"+subsumIAMT_str+"</div></font></td><td>&nbsp;</td><td><font size='2' color='#000099' face='Arial'><div align='right'>"+subsumRAMT_str+"</div></font></td><td><font size='2' color='#000099' face='Arial'><div align='right'>"+subsumUNQTY_str+"</div></font></td><td><font size='2' color='#000099' face='Arial'><div align='right'>"+subsumUNAMT_str+"</div></font></td><td><font size='2' color='#000099' face='Arial'><div align='right'>"+subsumAMTMIN_str+"</div></font></td><td>&nbsp;</td></tr>"); 
	 sumLQORD_str=String.valueOf(sumLQORD);
			   ...
			   if (sumAMTMIN_str.length()>3)		
	            {sumAMTMIN_str=df.format(sumAMTMIN);}			 //out.println("<tr bgcolor='#6699FF'><td colspan='4'><font size='3' color='#FFFF00' face='Arial'><strong><div align='right'>TOTAL</div></strong></font></td><td><font size='2' color='#FFFF00' face='Arial'><div align='right'>"+sumLQORD+"</div></font></td><td><font size='2' color='#FFFF00' face='Arial'><div align='right'>"+sumLAMT+"</div></font></td><td>&nbsp;</td><td><font size='2' color='#FFFF00' face='Arial'><div align='right'>"+sumILQTY+"</div></font></td><td><font size='2' color='#FFFF00' face='Arial'><div align='right'>"+sumIAMT+"</div></font></td><td>&nbsp;</td><td><font size='2' color='#FFFF00' face='Arial'><div align='right'>"+sumRAMT+"</div></font></td><td><font size='2' color='#FFFF00' face='Arial'><div align='right'>"+sumUNQTY+"</div></font></td><td><font size='2' color='#FFFF00' face='Arial'><div align='right'>"+sumUNAMT+"</div></font></td><td><font size='2' color='#FFFF00' face='Arial'><div align='right'>"+sumAMTMIN+"</div></font></td><td>&nbsp;</td></tr>"); 
