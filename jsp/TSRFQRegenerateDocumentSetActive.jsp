...
<FORM ACTION="/jsp/TSRFQRegenerateDocumentSetActive.jsp" METHOD="post" NAME="MYFORM">
...
<strong><jsp:getProperty name="rPH" property="pgSalesPlanner"/><jsp:getProperty name="rPH" property="pgApproval"/><jsp:getProperty name="rPH" property="pgOrdCreate"/></strong></font>
<!--%/20040109/將Excel Veiw 夾在檔頭%-->
<%
...
if (intType==null || intType.equals(""))
{
   ...
   sSql = "select ORDERNO||LINE_NO as OKEY,d.LINE_NO,d.LSTATUS,d.ITEM_DESCRIPTION, d.QUANTITY,d.UOM, "+
 ...
 sWhere = "where (d.LSTATUSID = '012' ) "+
			  "and d.ASSIGN_MANUFACT = e.MANUFACTORY_NO(+) "+
			  "and substr(d.DNDOCNO,3,3)=b.SALES_AREA_NO and b.LOCALE='"+locale+"' and d.SDRQ_EXCEED = 'Y' ";							  
...
{ 
   sSql = "select d.DNDOCNO||d.LINE_NO as OKEY,d.LINE_NO,d.LSTATUS,d.ITEM_DESCRIPTION, d.QUANTITY,d.UOM, "+
          "       TO_CHAR(TO_DATE(d.REQUEST_DATE,'YYYYMMDDHH24MISS'),'YYYY/MM/DD'),"+
		  "       d.PCCFMDATE,d.FTACPDATE, d.PCACPDATE, d.SASCODATE, d.ORDERNO,"+
          "       e.MANUFACTORY_NAME,d.REMARK "+
		  "  from ORADDMAN.TSSALES_AREA b, "+
		  "       ORADDMAN.TSDELIVERY_NOTICE_DETAIL d, ORADDMAN.TSPROD_MANUFACTORY e ";	
   sSqlCNT = "SELECT count(*) as CaseCount FROM ORADDMAN.TSSALES_AREA b,ORADDMAN.TSDELIVERY_NOTICE_DETAIL d, ORADDMAN.TSPROD_MANUFACTORY e ";		  									     
/*   sWhere = "where (d.LSTATUSIS = '012' ) "+
			  
			  				*/
   sWhere = "where d.SDRQ_EXCEED = 'Y' "+
            "  and substr(d.DNDOCNO,3,3)=b.SALES_AREA_NO and b.LOCALE='"+locale+"' "+
            "  and d.ASSIGN_MANUFACT = e.MANUFACTORY_NO(+) "+
//			"  and d.LSTATUSID not in ('005','010','012') "+ // 限制CANCELED/CLOSED/ABANDONING 不代入
            "  and d.DNDOCNO = '"+dnDocNo+"'" ;
   sOrder = "order by d.LINE_NO ";				   
...
%> 
  <table cellSpacing="0" bordercolordark="#99CC99" cellPadding="1" width="100%" align="center" bordercolorlight="#FFFFCC"  border="1">    
  <tr>
	   <td colspan="1"><font color="#006666" size="3"><strong><jsp:getProperty name="rPH" property="pgSalesOrderNo"/></strong></font></td>
	   <td colspan="3"><%=dnDocNo%></td>
    </tr>
     <!--tr>	    
	...
	<td colspan="2">
		    <INPUT TYPE="button" align="middle"  value='<jsp:getProperty name="rPH" property="pgQuery"/>' onClick='setSubmit("../jsp/TSRFQRegenerateDocumentSetting.jsp")' >   
	</td-->
   </tr>
  </table> 
  <table cellspacing="0" bordercolordark="#99CC99" cellpadding="1" width="100%" align="center" bordercolorlight="#FFFFCC"  border="1">
    <tbody>
      <tr bgcolor="#CCFFCC">
        ...
        <td width="3%"  height="19" nowrap><div align="center"><font color="#006699" face="Arial" size="2"><strong>
            <jsp:getProperty name="rPH" property="pgEdit"/>  
        </strong></font></div></td>
        <td width="9%" height="22" nowrap><div align="center"><font color="#006699" face="Arial" size="-1">
            <jsp:getProperty name="rPH" property="pgAnItem"/>  
        </font></div></td>
        <td width="10%" nowrap><div align="center"><font color="#006699" face="Arial" size="-1">
        ...
        <td width="14%" nowrap><div align="center"><font color="#006699" face="Arial" size="-1">
            <jsp:getProperty name="rPH" property="pgUOM"/>  
        </font></div></td>
        <td width="9%" nowrap><div align="center"><font color="#006699" face="Arial" size="-1">
        ...
        <td width="13%" nowrap><div align="center"><font color="#006699" face="Arial" size="-1">
    ...
    %>
      <tr bgcolor="<%=colorStr%>">
        ...
        <!--<td height="20"><a href="/jsp/TSDRQItemPackageCategoryEdit.jsp?INTTYPE=<%//=rsTC.getString("ITEM_DESCRIPTION")%>&PACKCLASS=<%//=rsTC.getString("LINE_NO")%>&OUTLINE=<%//=rsTC.getString("LINE_NO")%>&PACKCODE=<%//=rsTC.getString("LINE_NO")%>">
          <div align="center"><img src="../image/docicon.gif" width="14" height="15" border="0"></div> -
        </a> </td> -->
        ...
        <td width="14%" nowrap><font size="-1"><%=rsTC.getString(7)%></font></td>
...
%>
      <tr bgcolor="#CCFFCC">
        <td height="23" colspan="12" ><font color="#006699" size="-1">總資料筆數</font>
            <% 
	      if (CaseCount==0) 
		  { //若 	  
		  } 
	 ...
	 %>
            ...
            <%out.println("<font color='#000099' face='Arial'><strong>"+CaseCount+"</strong></font>");%>
        </td>
      </tr>
    <tbody>
  </table>
...
<% if (rs_isEmptyTC ) {  %>
    ...
    <% } else {
			   ...
			   <BR>
               <div align="left">
                  <input name="button" type=button onClick="this.value=check(this.form.CHKFLAG)" value="Select All">&nbsp;&nbsp;&nbsp;
			      <input name="submit2" type="submit" value="Batch Setting Active / Inactive" onClick='return setSubmit2("../jsp/TSRFQRegenerateDocumentSetActiveSubmit.jsp?DNDOCNO=<%=dnDocNo%>")'>
			   </div> 
               <%                    
	          }	    
	/*若有資料則顯示可全選擇的按鈕 */ %>    
