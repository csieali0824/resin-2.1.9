...
<title>Sales Monthly Forecast Inquiry Region Report</title>
</head>
<body>
<%@ include file="/jsp/include/ProgressStatusBarStart.jsp"%>
<FORM ACTION="../jsp/WSForecastRegionRptNoAuth.jsp" METHOD="post" NAME="MYFORM">
<font color="#3366FF" size="+2" face="Arial"><font size="+3" face="Arial Black"><font face="Courier, MS Sans Serif"><font color="#000000" size="+2" face="Arial Black"><strong>DBTEL</strong></font></font></font></font><font color="#000000" size="+2" face="Times New Roman"> 
  Forecast <font color="#990066">Region</font> Report</font> 
  <%
   int rs1__numRows = 24;
   int rs1__index = 0;
   int rs_numRows = 0;
  ...
  <table width="100%" border="1" cellpadding="0" cellspacing="0">
    ...
    <% //  *** Main Loop  Start   *** //    	   	   
		   ...
		   {                                      			  
		    ...
		    String sOrder = "ORDER BY w.FMCOUN,w.FMPRJCD ";
