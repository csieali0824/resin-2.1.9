...
<font color="#000000" size="+2" face="Arial"><strong>樣品領用查詢</strong></font>
<BR>
<A HREF="/wins/WinsMainMenu.jsp">HOME</A>
<form ACTION="WSShippingSampleQuery.jsp?" METHOD="post" NAME="MYFORM" >
<%
...
<table>
	...
	<tr>
		...
		<td><input name="Search"  type="submit" value="Query" onClick='return Submit("../jsp/WSShippingSampleQuery.jsp?ON=1")'></td>
	</tr>
...
try
{
	...
	" WHERE IN_CENTERNO = CENTERNO AND SHP_NOTES = 'S01' "+sWhere;
