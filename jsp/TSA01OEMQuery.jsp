...
<%@ page import="bean.DateBean,bean.ComboBoxBean,,bean.Array2DimensionInputBean"%>
<jsp:useBean id="rPH" scope="application" class="bean.SalesDRQPageHeaderBean"/>
<jsp:useBean id="dateBean" scope="page" class="bean.DateBean"/>
<jsp:useBean id="dateBean1" scope="page" class="bean.DateBean"/>
<jsp:useBean id="comboBoxBean" scope="page" class="bean.ComboBoxBean"/>
<jsp:useBean id="PCBean" scope="session" class="bean.Array2DimensionInputBean"/>
