...
<%
	 ...
	 String cost=request.getParameter("FCCOST");
     ...
     {  
      // !±o!Psou-!N-i|]¢DDAE
       String sSqUpMAT="update psales_fore_cost  set FCCOST=?,FCLUSER=? where FCCOMP='"+comp+"' and FCTYPE='"+type+"' and FCREG='"+region+"' and FCCOUN='"+country+"' and FCCURR='"+curr+"' and FCPRJCD='"+model+"' and FCYEAR='"+year+"' and FCMONTH='"+month+"' and FCMVER='"+version+"' ";   
       out.println(sSqUpMAT);
         
       PreparedStatement stmtUpMAT=con.prepareStatement(sSqUpMAT);             
       stmtUpMAT.setString(1,cost); 
...
<%
  response.sendRedirect("../jsp/WSForecastCostMaintenance.jsp?FCCOMP="+comp+"&FCTYPE="+type+"&FCREG="+region+"&FCCOUN="+country+"&FCCURR="+curr+"&FCPRJCD="+model+"&FCYEAR="+year+"&FCMONTH="+month);	 
%>
</body>
