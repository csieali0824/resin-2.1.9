...
<br>
<font color="#3366FF" size="+2" face="Arial"><font size="+3" face="Arial Black"><font face="Courier, MS Sans Serif"><font color="#003399" size="+2" face="Arial Black">TSC</font></font></font></font><font color="#000000" size="+2" face="Times New Roman"> <strong> Order Information (<%=order_no%>):</strong></font></TD>
...
<table width="600" border="1"  bordercolor="#0066FF"    align="center" cellpadding="0" cellspacing="0" bordercolorlight='#999999'>
<tr BGCOLOR='0066FF'>
	<td><font face="Arial" size="2" color="#FFFFFF">Order_number</font></td>
	<td><font face="Arial" size="2" color="#FFFFFF">Item_Description</font></td>
	<td><font face="Arial" size="2" color="#FFFFFF">Cust_PO</font></td>
	<td><font face="Arial" size="2" color="#FFFFFF">Quantity</font></td>
	<td><font face="Arial" size="2" color="#FFFFFF">Price</font></td>
...
<%
	...
	mo_sql = " select a.order_number , b.* from oe_order_headers_v a, oe_order_lines_v b where a.order_number = '"&order_no&"'"&_
			 "  and a.header_id = b.header_id "
 	'response.write(mo_sql)
	'response.end
	Set rs_mo_sql = Ora_conn.execute(mo_sql)

If  rs_mo_sql.eof=false Then 
		while not rs_mo_sql.eof 
			response.write("<tr>")
			response.write("<td><font face='Arial' size='2'>"&rs_mo_sql("order_number")&"</font></td><td><font face='Arial' size='2'>"&rs_mo_sql("ordered_item")&"</font></td>")
			response.write("<td><font face='Arial' size='2'>"&rs_mo_sql("CUST_PO_NUMBER")&"</font></td><td><font face='Arial' size='2'>"&rs_mo_sql("ORDERED_QUANTITY")&"</font></td>")
			response.write("<td><font face='Arial' size='2'>"&rs_mo_sql("UNIT_SELLING_PRICE")&"</font></td><td><font face='Arial' size='2'>"&rs_mo_sql("CREATION_DATE")&"</font></td>")
			response.write("</tr>")
		rs_mo_sql.movenext
		wend
else
