...
{    
	if (document.MYFORM.RSDATE.value=="" && document.MYFORM.REDATE.value =="" )
	{
		alert("請先輸入查詢條件!");
		return false;
	}
	document.MYFORM.action=URL+"?ACTTYPE=RFQ";
...
<title>PMD/PRD WIP Detail Report</title>
<!--=============以下區段為安全認證機制==========-->
...
<FORM ACTION="../jsp/TSCPMDWIPAllDataQuery.jsp" METHOD="post" NAME="MYFORM">
<strong><font style="font-size:20px;color:#006666">WIP Detail Report</font></strong>
<BR>
  ...
  <table cellSpacing='0' cellPadding='1' width='100%' align='center' borderColorLight="#CFDAD8"  bordercolordark="#5C7671" border='1'>
		<td width="5%" bgcolor="#D3E6F3"  style="font-weight:bold;color:#006666">工單開立日:</td>   
		    <td width="15%">
			<input type="TEXT" name="RSDATE" value="<%=RSDATE%>"  style="font-family: Tahoma,Georgia;" size="8" onKeyPress="return (event.keyCode >= 48 && event.keyCode <=57)"><A href='javascript:void(0)' onclick='gfPop.fPopCalendar(document.MYFORM.RSDATE);return false;'><img name='popcal' border='0' src='../image/calbtn.gif'></A>		
			&nbsp;~&nbsp;
			<input type="TEXT" name="REDATE" value="<%=REDATE%>"  style="font-family: Tahoma,Georgia;" size="8" onKeyPress="return (event.keyCode >= 48 && event.keyCode <=57)"><A href='javascript:void(0)' onclick='gfPop.fPopCalendar(document.MYFORM.REDATE);return false;'><img name='popcal' border='0' src='../image/calbtn.gif'></A>		
		</td>  
		  <td width="5%" bgcolor="#D3E6F3"  style="font-weight:bold;color:#006666">預計完工日:</td>   
		    <td width="75%">
			...
			&nbsp;&nbsp;
			&nbsp;&nbsp;
		    <INPUT TYPE="button" align="middle"  value='EXCEL'  style="font-family:ARIAL" onClick='setExportXLS("../jsp/TSCPMDWIPAllDataNotice.jsp")' > 
		</td>
	</tr>
</table>
</FORM>
