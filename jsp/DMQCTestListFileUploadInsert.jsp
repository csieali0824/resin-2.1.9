...
<%  
	...
	upload_file.saveAs("D:\\resin-2.1.9\\webapps\\wins\\report\\"+sModelNo+"TESTLIST.xls");
    InputStream is = new FileInputStream("D:\\resin-2.1.9\\webapps\\wins\\report\\"+sModelNo+"TESTLIST.xls"); 
	//jxl.Workbook wb = Workbook.getWorkbook(is);  // open work book
	
	//wb.close();  

	//String sModelNo = upload_file.getFileName().substring(0,upload_file.getFileName().indexOf("_"));      
    //out.println(userID);
