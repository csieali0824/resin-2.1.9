...
<p> <strong><font color="#54A7A7" size="+2" face="Arial Black"> DBTEL</font><font face="Courier, MS Sans Serif"></font></font></font><font color="#000000" size="+2" face="Times New Roman"> 
  產品代碼<font color="#FF0000">註銷</font></font></strong></p>
...
<FORM ACTION="WSModelCodeDel.jsp" METHOD="post">
<%
try
{  
...
<table width="735" border="1">
  ...
  <tr> 
      ...
      <td bgcolor="#CCCCCC"><font color="#0000FF">專案生效日 : <%=pjtnDate %></font></td>
      <td bgcolor="#CCCCCC"><font color="#0000FF">專案終止日 :</font><font size=2> 
        <%
     ...
     try
      {	   
	   ...
	   arrayComboBoxBean.setFieldName("PJTFYEAR");	   
      ...
      {       
	   ...
	   arrayComboBoxBean.setFieldName("PJTFMONTH");	   
       out.println(arrayComboBoxBean.getArrayString());              
       } //end of try
       catch (Exception e)
       {
      ...
      {       
	   ...
	   arrayComboBoxBean.setFieldName("PJTFDAY");	   
       out.println(arrayComboBoxBean.getArrayString());              
       } //end of try
       catch (Exception e)
       {
  ...
  <p> 
    ...
    <input type="submit" name="Submit" value="註銷">
    <em>　
