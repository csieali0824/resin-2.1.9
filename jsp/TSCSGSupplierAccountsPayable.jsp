...
<title>SG Supplier Account Payable Report</title>
<!--=============以下區段為安全認證機制==========-->
...
<FORM ACTION="../jsp/TSCSGSupplierAccountsPayable.jsp" METHOD="post" NAME="MYFORM">
<strong><font style="font-size:20px;color:#006666">SG Payable Detail</font></strong>
<BR>
  ...
  <table cellSpacing='0' cellPadding='1' width='100%' align='center' borderColorLight="#CFDAD8"  bordercolordark="#5C7671" border='1'>
		  <td width="10%" bgcolor="#D3E6F3"  style="font-weight:bold;color:#006666">Receive Date :</td>   
			...
			&nbsp;&nbsp;
			&nbsp;&nbsp;
		    <INPUT TYPE="button" align="middle"  value='EXCEL'  style="font-family:ARIAL" onClick='setExportXLS("../jsp/TSCSGSupplierAccountsPayableExcel.jsp")' > 
		</td>
	</tr>
</table>
</FORM>
