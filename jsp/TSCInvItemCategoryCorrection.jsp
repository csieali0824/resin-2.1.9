...
<strong>Item Category Setting Error Correction</strong></font>
<BR>
...
%>  
  <table width="100%" border="1" cellpadding="0" cellspacing="0" bordercolorlight="#999999" bordercolordark="#FFFFFF">
	...
	<td width="68%">
		    <INPUT TYPE="button" align="middle"  value='查詢' onClick='setSubmit("../jsp/TSCInvItemCategoryCorrection.jsp")' >   
	</td>
   </tr>
  </table>  
  ...
  <table cellSpacing="0" borderColorDark="#333399"  cellPadding="1" width="100%" align="center" borderColorLight="#CCFFFF" border="1">
   <tbody>
    <tr bgcolor="#99CCFF"> 
	  ...
	  <td width="5%"  height="19" nowrap><div align="center"><font color="#330099" size="2"><strong>Fix</strong></font></div></td>   
      <td width="8%" height="22" nowrap><div align="center"><font color="#330099" size="-1">Org. Information</font></div></td>          
      <td width="11%" nowrap><div align="center"><font color="#330099" size="-1">Item</font></div></td>
      <td width="12%" nowrap><div align="center"><font color="#330099" size="-1">Error Category</font></div></td>      
      <td width="14%" nowrap><div align="center"><font color="#330099" size="-1">Correct Category</font></div></td>
      <td width="11%" nowrap><div align="center"><font color="#330099" size="-1">Last Upate User</font></div></td>      
      <td width="16%" nowrap><div align="center"><font color="#330099" size="-1">Inform User Mail</font></div></td>
	  <td width="19%" nowrap><div align="center"><font color="#330099" size="-1">Last Update Date </font></div></td>	         
    </tr>
...
%>
    <tr bgcolor="#99CCFF"> 
      <td height="23" colspan="10" ><font color="#330099" size="-1">料號分類設定異常筆數</font> 
        <% 
	      if (CaseCount==0) 
		  { //若 	  
		  } 
...
<BR>
<div align="left"><input name="submit2" type="submit" value="BATCH CORRECT CATEGORY" onClick='return setSubmit2("../jsp/TSCInvItemCategoryCorrectionCommit.jsp")'></div>
</FORM>
