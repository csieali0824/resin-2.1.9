	...
	<%
		try
		{
			if (ATYPE.equals("Q"))
			{
				...
				{
					sql= sql.replace("?01"," (OHA.ORG_ID =906 OR (OHA.ORG_ID=41 AND SUBSTR(OHA.ORDER_NUMBER,1,4) IN ('1142','1214') AND OLA.PACKING_INSTRUCTIONS='T') OR (OHA.ORG_ID=41 AND OLA.PACKING_INSTRUCTIONS='E'))\n"+
