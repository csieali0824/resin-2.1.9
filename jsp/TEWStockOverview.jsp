...
<title>TEW In and Out Report</title>
<!--=============以下區段為安全認證機制==========-->
...
<strong><font style="font-size:20px;color:#006666">TEW 進銷存明細查詢報表</font></strong>
<BR>
...
%>    
			...
			&nbsp;&nbsp;
			&nbsp;&nbsp;
		    <INPUT TYPE="button" align="middle"  value='EXCEL'  style="font-family:ARIAL" onClick='setExportXLS("../jsp/TEWStockOverviewReport.jsp")' > 
		</td>
	</tr>
</table>
</FORM>
