...
<!--%/20040109/將Excel Veiw 夾在檔頭%-->
 ...
 <font color="#000066" face="Times New Roman" size="+2"><strong>Database Data-Dictionary Inquiry</strong></font>  
<BR>
  <!--%/20040109/將Excel Veiw 夾在檔頭%-->
<%
...
{
   sSql = "select OWNER, SYNONYM_NAME, trim(COMMENTS) as COMMENTS, TABLE_OWNER, a.TABLE_NAME from DBA_SYNONYMS a, DICTIONARY b ";
   sSqlCNT = "select count(SYNONYM_NAME) as CaseCount from DBA_SYNONYMS a, DICTIONARY b ";
   sWhere =  "where TABLE_OWNER ='SYS' and SYNONYM_NAME NOT LIKE '%/%' and a.TABLE_NAME = b.TABLE_NAME(+)   ";                  
   sOrder = "order by SYNONYM_NAME ";
 ...
 <A HREF="/oradds/ORAddsMainMenu.jsp">回首頁</A>
  ...
  <table width="100%" border="1" cellpadding="0" cellspacing="0" bordercolorlight="#999999" bordercolordark="#FFFFFF">
    <tr bgcolor="#CCFF99" > 
      ...
      <td width="19%" nowrap><div align="center"><font color="#000000" size="-1">Synonms Name</font></div></td>  
	  <td width="40%" nowrap><div align="center"><font color="#000000" size="-1">Description</font></div></td>    
      <td width="7%" nowrap><div align="center"><font color="#000000" size="-1">Table Owner</font></div></td>
      <td width="21%" nowrap><div align="center"><font color="#000000" size="-1">Table Name</font></div></td>                    
    </tr>
    ...
    <tr bgcolor="<%=colorStr%>"> 
	  ...
	  <td><div align="center"><a href="../jsp/OraSysSynonmsResultPage.jsp?SYNONMSNAME=<%=rsTC.getString("SYNONYM_NAME")%>"><img src="../image/docicon.gif" width="14" height="15" border="0"></a></div></td>    
	  <td><font size="-1"><%=rsTC.getString("OWNER") %></font></td>
      <td width="19%" nowrap><font size="-1"><%=rsTC.getString("SYNONYM_NAME")%></font></td>
	  <td width="40%" nowrap><font size="-1"><%=rsTC.getString("COMMENTS")%></font></td>
      <td width="7%"><font size="-1"><%=rsTC.getString("TABLE_OWNER")%></font></td>
      <td width="21%" nowrap><font size="-1"><%=rsTC.getString("TABLE_NAME")%></font></td>            
    </tr>
    <%
  rs1__index++;
  rs_hasDataTC = rsTC.next();
