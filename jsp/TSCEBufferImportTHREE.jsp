...
<%
	...
	SimpleDateFormat sdf = new SimpleDateFormat("yyyyMMdd_HHmmss");
        ...
        if ( (todo != null) && (todo.equalsIgnoreCase("upload")) )  {
         ...
         //WritableSheet wsheet = rw.getSheet(0);
         //WritableImage wimg   = wsheet.getImage(0);
         //WritableImage.removeImage(wimg);
         //rw.write();
         //rw.close();
         ...
         Cell cellunitprice = null;
    	  ...
    	  arrayRFQBufferInputBean.setArrayString(oneDArray);
         ...
         // Loop To read the Cells value
          ...
          String iNo=null;
          String b[][]                 = new String[columns][rows];
             ...
             // Get TSC Part Number
               ...
               try
               {
                 ...
                 if (BufferPartNumber[1][i].trim() !=null && BufferPartNumber[1][i].trim() !=null && BufferPartDescNew[1][i].trim() !=null && BufferPartDescNew[1][i].trim() !=null)
                 {
                    ...
                    { arrayRFQBufferInputBean.setArray2DString(b);
                     arrayRFQBufferInputBean.setArray2DCheck(b);	
					} 	
					j++;
                } // End of if ()
...
<% //TSCEBufferImportTwo.jsp?UPLOADFLAG=Y
  ...
  String q[][]=arrayRFQBufferInputBean.getArray2DContent();//���o�ثe�}�C���e 		
  ...
  {//out.println("<BR>");		  
					...
					out.println(arrayRFQBufferInputBean.getArray2DBufferString());
  }
