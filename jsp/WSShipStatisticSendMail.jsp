...
String mailHost=application.getInitParameter("MAIL_HOST"); //由Server的web.xml中取出mail server的host nam
	...
	while(rsMail.next())
	{
	   try 
		  ...
		  // urAddress1 =  serverName+"/wins/jsp/WSProductionStatusAutoII.jsp?COMPNO=08&&LOCALE=886&&YEARFR="+dateStrYear+"&&MONTHFR="+monthFr+" ";
           urAddress1 =  serverName+"/wins/jsp/WSProductionStatusAutoII.jsp";     
