...
<title>SG In and Out Report</title>
<!--=============以下區段為安全認證機制==========-->
...
<FORM ACTION="../jsp/TSCSGStockOverview.jsp" METHOD="post" NAME="MYFORM">
<strong><font style="font-size:20px;color:#006666">SG 進銷存明細查詢報表</font></strong>
<BR>
  ...
  <table cellSpacing='0' cellPadding='1' width='100%' align='center' borderColorLight="#CFDAD8"  bordercolordark="#5C7671" border='1'>
		<td width="10%" bgcolor="#D3E6F3"  style="font-weight:bold;color:#006666">交易日期:</td>   
...
%>    
			...
			&nbsp;&nbsp;
			&nbsp;&nbsp;
		    <INPUT TYPE="button" align="middle"  value='EXCEL'  style="font-family:ARIAL" onClick='setExportXLS("../jsp/TSCSGStockOverviewReport.jsp")' > 
		</td>
	</tr>
</table>
</FORM>
