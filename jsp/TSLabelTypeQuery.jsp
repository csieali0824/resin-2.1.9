...
<title>TS Label Type Query</title>
...
<FORM ACTION="../jsp/TSLabelTypeQuery.jsp" METHOD="post" NAME="MYFORM">
<br>
  ...
  <table cellSpacing='0' cellPadding='1' width='100%' align='center' borderColorLight="#CFDAD8"  bordercolordark="#5C7671" border='1'>
     <tr>
		...
		<td width="31%" align="center">
		    <INPUT TYPE="button" align="middle"  value='<jsp:getProperty name="rPH" property="pgQuery"/>' onClick='setSubmit("../jsp/TSLabelTypeQuery.jsp")' > 
			&nbsp;&nbsp;&nbsp;
		    <INPUT TYPE="button" align="middle"  value='新增'  style="font-family:ARIAL" onClick='setAdd("../jsp/TSLabelTypeAdd.jsp?STATUS=NEW")' > 
			&nbsp;&nbsp;&nbsp;
		    <INPUT TYPE="button" align="middle"  value='匯出Excel'  style="font-family:ARIAL" onClick='setExportXLS("../jsp/TSLabelTypeExcel.jsp")' > 
		</td>
   </tr>
</table>  
<hr>
	...
	{ 	
		...
		<table width="100%" border="1" cellpadding="1" cellspacing="0" borderColorLight="#CFDAD8"  bordercolordark="#5C7671">
			<tr bgcolor="#D3E6F3"> 
				...
				<td width="10%" style="font-size:12px;color:#006666" align="center">標籤名稱</td>
				<td width="15%" style="font-size:12px;color:#006666" align="center">標籤說明</td>
				<td width="11%" style="font-size:12px;color:#006666" align="center">標籤尺吋</td>
				<td width="8%" style="font-size:12px;color:#006666" align="center">標籤容器</td>
    	...
    	%>
			...
			<td align="center">
			<img border="0" src="images/updateicon_enabled.gif" height="18" title="修改資料" onClick="setUpdate('../jsp/TSLabelTypeAdd.jsp?STATUS=UPD&LABEL_TYPE_CODE=<%=rs.getString("LABEL_TYPE_CODE")%>')"></td>
			...
			<td><%=(rs.getString("LABEL_TYPE_SIZE")==null?"&nbsp;":rs.getString("LABEL_TYPE_SIZE"))%></td>
