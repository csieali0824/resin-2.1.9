...
<strong> 產品編碼系統-產品編碼查詢 </strong></font> 
<FORM ACTION="../jsp/WSMRModelEncodingInquiry.jsp" METHOD="post" NAME="MYFORM">
<%
   int rs1__numRows = 25;
   int rs1__index = 0;
   int rs_numRows = 0;
 ...
 %>
  ...
  &nbsp;&nbsp;<A HREF="../jsp/WSModelEncodeApp.jsp">產品編碼資料新增</A> 
  <% 
...
<table width="50%" border="0">      
    <tr>
      <td bgcolor="#FFFFFF" colspan="2"><font color="#000000" face="Arial Black"><strong>產品編碼 
        <%
         ...
         {       
		  ...
		  sSql = "select MODELNO, MODELNO || '(' || RDESIGN_DPT ||')' "+
			     "from MRMODELAPP ";	 
		  sSql = sSql+sWhere;
		  ...
		  comboBoxAllBean.setSelection(modelNo);
    ...
    <td width="35%" bgcolor="#FFFFFF"><INPUT TYPE="button"  value="Query" onClick='setSubmit("../jsp/WSMRModelEncodingInquiry.jsp")' ></td>    
    </tr> 
    
</table>
  <table width="91%" border="1" cellspacing="0" cellpadding="0">
    <tr bgcolor="#006666"> 
      <td width="4%"  height="19" bgcolor="#6699FF" nowrap><font color="#FFFFFF" size="2"><strong></strong></font></td>
      <td width="13%"  height="19" bgcolor="#6699FF" nowrap><font color="#FFFFFF" size="2">&nbsp;<strong>申請單號</strong></font></td>
      <td width="16%"  height="19" bgcolor="#6699FF" nowrap><font color="#FFFFFF" size="2">&nbsp;<strong>產品代碼</strong></font></td>
      <td width="16%"  height="19" bgcolor="#6699FF" nowrap><font color="#FFFFFF" size="2">&nbsp;<strong>專案啟動日</strong></font></td>
      <td width="11%"  height="19" bgcolor="#6699FF" nowrap><font color="#FFFFFF" size="2">&nbsp;<strong>專案註銷日</strong></font></td>
      <td width="10%"  height="19" bgcolor="#6699FF" nowrap><font color="#FFFFFF" size="2"><strong>申請人</strong></font></td>
      <td width="10%"  height="19" bgcolor="#6699FF" nowrap><font color="#FFFFFF" size="2"><strong>申請日</strong></font></td>
      <td width="10%"  height="19" bgcolor="#6699FF" nowrap><font color="#FFFFFF" size="2"><strong>建檔人</strong></font></td>
      <td width="10%"  height="19" bgcolor="#6699FF" nowrap><font color="#FFFFFF" size="2"><strong>建檔日</strong></font></td>
      <td width="10%"  height="19" bgcolor="#6699FF" nowrap><font color="#FFFFFF" size="2">&nbsp;<strong>狀態</strong></font></td>
      <td width="10%" bgcolor="#6699FF" nowrap><font color="#FFFFFF" size="2"><strong>備註</strong></font></td>
    </tr>
    <%  
            try
            {  
              ...
              String sqlTC =  "select APPNO,MODELNO, PJTTNON_DATE, PJTTNOFF_DATE,APPLY_USER,APPLY_DATE,ENUSER,ENDTIME,PID,REMARK "+
			                  "from MRMODELAPP ";
			  String sWhereTC = "where MODELNO IS NOT NULL ";
			
              if (modelNo == null || modelNo.equals("--")) { sWhereTC = sWhereTC + "and MODELNO != '0'  "; }
             ...
             // if (MonthFr!="--" && MonthTo!="--") sWhereTC=sWhereTC+" and substr(LAUNCH_DATE,3,4)||substr(LAUNCH_DATE,1,2) between "+"'"+dateStringBegin+"'"+" and "+"'"+dateStringEnd+"' ";
			  ...
			  String sOrderTC = "order by modelNo ";
   ...
   //out.println("MM_size Step0="+MM_size);
    ...
    <tr bgcolor="<%=colorStr%>"> 
      <td bgcolor="#6699FF"> 
        <!--%<a href="../jsp/WSPriceSegmentMaintEdit.jsp?REGION=<!--%=rsTC.getString("APPEAR_CODE")%>">
      ...
      <td><font size="2" >&nbsp;
        <% 
           if (rsTC.getString("MODELNO")!=null )
		    {
			 String model = rsTC.getString("MODELNO");
      ...
      <td><font size="2" >&nbsp;
        <%
                   //if (codeClass==null || codeClass=="2" || codeClass.equals("2"))
                     ...
                     if (rsTC.getString("PJTTNON_DATE")!=null) { out.println(rsTC.getString("PJTTNON_DATE")); } 
                     else { out.println("&nbsp;"); }
      ...
      <td><font size="2" >&nbsp; 
        <%
                      if (rsTC.getString("PJTTNOFF_DATE") !=null) { out.println(rsTC.getString("PJTTNOFF_DATE")); } 
                      else { out.println("&nbsp;"); }
      ...
      <td><font size="2" >&nbsp; 
        <%
                      if (rsTC.getString("ENUSER") !=null) { out.println(rsTC.getString("ENUSER")); } 
                      else { out.println("&nbsp;"); }
                     //=rsTC.getString("TXRPCENTERNO") 
                 %>
        </font></td>
      <td><font size="2" >&nbsp;
        <%
                      if (rsTC.getString("ENDTIME") !=null) { out.println(rsTC.getString("ENDTIME")); } 
                      else { out.println("&nbsp;"); }
                     //=rsTC.getString("TXRPCENTERNO") 
                 %>
        </font></td>
      ...
      <td><font size="2" >
        <%
                      if (rsTC.getString("REMARK") !=null) { out.println(rsTC.getString("REMARK")); } 
                      else { out.println("&nbsp;"); }
                     //=rsTC.getString("TXRPCENTERNO") 
                 %>
        </font></td>
