...
<body>
<FORM ACTION="WSARCheckReportCollect.jsp" METHOD="post" NAME="MYFORM">
  <div align="left">
 ...
 %>
  ...
  <table width="100%" border="0">
    <tr> 
      ...
      <td width="30%" bgcolor="#006699"><input name="button" type="button" onClick='setSubmit("../jsp/WSARCheckReportCollect.jsp")'  value="Query" >
