...
<font color="#000000" size="+2" face="細明體"><strong>備機及備板借出查詢</strong></font>
<BR>
<A HREF="/wins/WinsMainMenu.jsp">HOME</A>
<form ACTION="WSShippingSpareQuery.jsp?ON=1" METHOD="post" NAME="MYFORM" >
<%
	String on = request.getParameter("ON"); //控制是否從本頁submit
	//out.println(on);
...
<table>
	<tr>
		...
		<td bgcolor="#CCFFCC" colspan="3"><font color="#333399" font size="2" face="Arial Black">領用人</font>
		<input type="text" name="CUSTNAME" size="50" maxlength="50" value="<%=CustName%>">
		</td>
	</tr>
	<tr>
		...
		<td><input name="Search"  type="submit" value="Query" onClick='return Submit("../jsp/WSShippingSpareQuery.jsp?ON=1")'></td>
	</tr>
...
try
{
	...
	if (CustName!=null && !CustName.equals("")) { sWhere = sWhere + " AND ERP_CUSTNAME='"+CustName+"'";}
	...
	+" WHERE IN_CENTERNO = CENTERNO AND SHP_NOTES = 'T' " //備機及備板借出
	+sWhere;
...
<%
	...
	else {out.println("<tr><td colspan='8'><font color='#333399' font size='2' face='Arial Black'>DATA NOT FOUND</font></td></tr>");}
	rs1.close();
	state1.close();
	} //end if
