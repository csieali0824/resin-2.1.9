...
{
   warray=new Array(document.MYFORM.PLATFORMCODE.value,document.MYFORM.SPLATFMNAME.value,document.MYFORM.PLATFORM.value,document.MYFORM.VNDNAME.value);   
   for (i=0;i<4;i++)
   {     
...
<title>WINS System-產品發展平台資料新增</title>
</head>
<body>
<FORM ACTION="WSMRProdAprnceInput.jsp" METHOD="post" NAME="MYFORM">
  ...
  <strong>  產品編碼系統-產品發展平台資料新增 </strong></font> &nbsp; &nbsp; &nbsp; 
  &nbsp;<BR>
  <A HREF="../WinsMainMenu.jsp">首頁</A> &nbsp;&nbsp;<A HREF="../jsp/WSModelEncodingSub.jsp">產品編碼管理作業</A> &nbsp;&nbsp;<A HREF="../jsp/WSMRProdPlatformInquiry.jsp">產品發展平台資料查詢</A> 
<%   
...
array2DimensionInputBean.setCommitmentMonth(commitmentMonth);     //設定承諾月數 out.println("Step1");
...
String platFormCode=request.getParameter("PLATFORMCODE"),splatFmName=request.getParameter("SPLATFMNAME"),platForm=request.getParameter("PLATFORM"),vndName=request.getParameter("VNDNAME");   
...
String [] allMonth={platFormCode,splatFmName,platForm,vndName};    
...
//out.println("Step15");
  ...
  {  //out.println("Step16");
    ...
    { 		 //out.println("Step17"); 
	 ...
	 {	 //out.println("Step18");  	  	    
       String t[][]=new String[a.length-addItems.length][a[0].length];  //out.println("Step19");    
	   int cc=0;
	   ...
	   array2DimensionInputBean.setArray2DString(t);        //out.println("Step23"); 
	 } else { 	   			 
	   array2DimensionInputBean.setArray2DString(null);     //out.println("Step24");            //將陣列內容清空
	 }  
	}//end of if a!=null
  } 
...
<table width="60%" border="1" cellspacing="0" cellpadding="0">
  <tr>      
      <td width="15%" bgcolor="#003366"><div align="center"><font face="Arial" color="#FFFFFF" size="3"><strong>產品平台代碼</strong></font></div></td>
	  <td width="15%" colspan="1" bgcolor="#003366"><div align="center"><font face="Arial" color="#FFFFFF" size="3"><strong>產品平台名稱</strong></font></div></td> 
      <td width="7%" colspan="1" bgcolor="#003366"><div align="center"><font face="Arial" color="#FFFFFF" size="3"><strong>平台簡稱</strong></font></div></td> 
      <td width="15%" colspan="1" bgcolor="#003366"><div align="center"><font face="Arial" color="#FFFFFF" size="3"><strong>廠商名稱</strong></font></div></td> 	  
      ...
      <td width="24%" rowspan="3"><div align="center"><strong> 
        <INPUT TYPE="button"  value="Add" onClick='setSubmit("../jsp/WSMRProdPlatformInput.jsp")' >
	  </font></div></td>   
    </tr>
  <tr>
    <td>    
    <input type="text" name="PLATFORMCODE"  size="15" maxlength="2" <%if (allMonth[0]!=null) out.println("value="); else out.println("value=");%>>
    </td>
    <td><input type="text" name="SPLATFMNAME"  size="15" maxlength="25"   <%if (allMonth[1]!=null) out.println("value="); else out.println("value=");%> >
    </td>
    <td><input type="text" name="PLATFORM"  size="15" maxlength="15"   <%if (allMonth[2]!=null) out.println("value="); else out.println("value=");%> >
    </td>
    <td><input type="text" name="VNDNAME"  size="25" maxlength="25"   <%if (allMonth[3]!=null) out.println("value="); else out.println("value=");%> >
    </td>        
    </tr>    
  <tr bgcolor="#003366">
    <td colspan="4"><div align="center"><strong>
     <%
	  try
      {
        ...
        String oneDArray[]= {"增項","產品平台代碼","產品平台名稱","產品平台簡稱","廠商名稱"}; 		 	     			  
    	array2DimensionInputBean.setArrayString(oneDArray);
         ...
         String dupSPFLAG="FALSE";
         String dupPLFLAG="FALSE";
	     if (platFormCode!=null && !platFormCode.equals("") && splatFmName!=null && !splatFmName.equals("") && platForm!=null && !platForm.equals("") && bringLast==null) //bringLast是用來識別是否帶出上一次輸入之最新版本資料
		 {  //out.println("step1");             		    
		   if (a!=null) 
		   { //out.println("step2");
			 ...
			 { //out.println("step3");
			  ...
			  { //out.println("step4");
			    b[i][j]=a[i][j];	
                if (a[k][0].equals(platFormCode) ) { dupFLAG = "TRUE"; }	
                else if ( a[k][1].equals(splatFmName) ) { dupSPFLAG = "TRUE"; }	
                else if (a[k][2].equals(platForm)  ) { dupPLFLAG = "TRUE"; }				
			  }
			  k++;
			 }
			 //b[k][0]=chooseItem;
             ...
             String sqlIMDUP = "select * from PRPROD_PLATFORM where (PLATFORM_CODE='"+platFormCode+"') ";
             //out.println(sqlIMDUP);     
             ResultSet rsIMDUP=stateIMDUP.executeQuery(sqlIMDUP);             
             if (rsIMDUP.next() )
             { out.println("<font color='#FF0000' face='Arial Black'>"+"Duplicate last Input :</font><font color='#FFFFFF' face='Arial Black'> "+platFormCode+"</font><font color='#FF0000' face='Arial Black'> on Database history"+"</font>"); }
             else if (dupFLAG=="TRUE" || dupFLAG.equals("TRUE") )  { out.println("<font color='#FF0000' face='Arial Black'>"+"Duplicate last Input :</font><font color='#FFFFFF' face='Arial Black'> "+platFormCode+"</font><font color='#FF0000' face='Arial Black'> on Your Platform code list"+"</font>"); }
             else if (dupSPFLAG=="TRUE" || dupSPFLAG.equals("TRUE") ) { out.println("<font color='#FF0000' face='Arial Black'>"+"Duplicate last Input :</font><font color='#FFFFFF' face='Arial Black'> "+splatFmName+"</font><font color='#FF0000' face='Arial Black'> on Your Platform Name list"+"</font>"); }
             else if (dupPLFLAG=="TRUE" || dupPLFLAG.equals("TRUE") ) { out.println("<font color='#FF0000' face='Arial Black'>"+"Duplicate last Input :</font><font color='#FFFFFF' face='Arial Black'> "+platForm+"</font><font color='#FF0000' face='Arial Black'> on Your Platform Short Name list"+"</font>"); }     
             else
             {
              b[k][0]=platFormCode;b[k][1]=splatFmName;b[k][2]=platForm;b[k][3]=vndName;
             ...
             {
              String c[][]={{platFormCode,splatFmName,platForm,vndName}};						             			 
...
<% 
     int div1=0,div2=0;      //做為運算共有多少個row和column輸入欄位的變數
      ...
      {	
       ...
       %>
<BR>
<INPUT name="button2" TYPE="button" onClick='setSubmit3("../jsp/WSMRProdPlatformInput.jsp")'  value="DELETE" >
------------------------------------------------------------------------------------------------------------
<INPUT TYPE="button"  value="SAVE" onClick='setSubmit2("../jsp/WSMRProdPlatformInsert.jsp",<%=div1%>,<%=div2%>)' >
---------------------
<!-- 表單參數 -->  
