...
<html>
<head>
<title>Sales Forecast Exworks Price Data Insert</title>
...
{  
     ...
     { 	 
	   for (int subac=1;subac<a[ac].length;subac++)
	   {
		 ...
		 String p_in_array=request.getParameter("MONTH"+ac+"-"+subac);//取前一頁之輸入欄位
           sql="insert into PSALES_FORE_EXWPRICE(FPCOMP,FPYEAR,FPMONTH,FPREG,FPCOUN,FPTYPE,FPPRJCD,FPEXWPRI,FPMVER,FPLUSER,FPCURR) values(?,?,?,?,?,?,?,?,?,?,?)";
  ...
  out.println("Input Exworks Price of Forecast Data Successfully!!<BR>");
