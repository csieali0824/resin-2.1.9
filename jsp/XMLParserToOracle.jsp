		...
		customerPO = custPoElt.getAttribute(name);}
					...
					**************************************************/
					...
					Element b_countryElt =  (Element)billElt.getElementsByTagName("Country").item(0);
						...
						if ( b_countyElt != null && b_countyElt.getFirstChild() != null){
							 county =b_countyElt.getFirstChild().getNodeValue(); }
						...
						out.println("<BR>Taipei, Taiwan 231");
					...
					**************************************************/
					...
					if ( countryElt != null && countryElt.getFirstChild() != null){
						...
						out.println("<td><div align ='right'><strong>Ship to:</strong>"+department+"<br>"+street+"<br>"+city+"<br>"+zip+"<br>"+country+"<br></div></td>");
  						out.println("</tr>");
						out.println("</table>");
						out.println("<br>");
						/****************************
					...
					********************************************/
						...
						// 20100520 Marvie Update : display currency
						...
						out.println("<td>Carton Number<br>AWB / Invoice Number</td><td>Product Description</td><td>Customer P/O</td><td>Customer P/N</td><td nowrap='nowrap' align='Right'>Quantity / Price ("+currency+")</td>");
						out.println("</tr>");
					for(j=0;j<itemNum;j++){
