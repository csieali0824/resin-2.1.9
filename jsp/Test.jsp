...
<strong>Item Category Setting Error Weekly Report</strong></font>
<BR>
  <!--%/20040109/將Excel Veiw 夾在檔頭%-->
<%
...
{
   sSql = "select C.ORGANIZATION_ID, I.SEGMENT1, I.CREATED_BY, I.CREATION_DATE, "+
                 "U.USER_NAME, P.ORGANIZATION_CODE,U.EMAIL_ADDRESS,C.LAST_UPDATE_DATE "+
				 "C.LAST_UPDATED_BY "+
   ...
   try
        {		
         Statement statement1=conTst2.createStatement();
...
{ 
  ...
  if ((!(DayFr=="--")&&(DayFr=="00")) && DayTo=="--") sWhere=sWhere+" and TO_CHAR(C.LAST_UPDATE_DATE,'YYYYMMDD') >="+"'"+dateStringBegin+"'";
  if (DayFr!="--" && DayTo!="--") sWhere=sWhere+" and TO_CHAR(C.LAST_UPDATE_DATE,'YYYYMMDD') between "+"'"+dateStringBegin+"'"+" and "+"'"+dateStringEnd+"'";
 ...
 //out.println("sSqlCNT="+sSqlCNT);
  //out.println(sSql);  
   ...
   Statement statement2=conTst2.createStatement();
   ...
   {       	 
         ...
         Statement statement3=conTst2.createStatement();
...
//Statement stateAct=conTst2.createStatement();
//out.println(sSql);

Statement statementTC=conTst2.createStatement(); 

//ResultSet rsTC=statementTC.executeQuery(sSql);
ResultSet rsTC=statementTC.executeQuery("select count(*) as CaseCount from MTL_ITEM_CATEGORIES C");
...
if (MM_rsCount == -1) {
  ...
  rsTC = statementTC.executeQuery("select count(*) as CaseCount from MTL_ITEM_CATEGORIES C");
...
%>  
 <A HREF="/oradds/ORAddsMainMenu.jsp">回首頁</A>
  ...
  <table width="100%" border="1" cellpadding="0" cellspacing="0" bordercolorlight="#999999" bordercolordark="#FFFFFF">
     <tr>
	    <td width="38%" bordercolor="#FFFFFF" nowrap><font color="#000066"><strong>Audit Date From</strong></font>
        <%
	...
	<td width="38%" bordercolor="#FFFFFF" nowrap><font color="#000066"><strong>Audit Date To</strong></font>
        <%
...
%>
    <tr bgcolor="#CC3366"> 
      <td height="23" colspan="10" ><font color="#FFFFFF">查詢筆數</font> 
        <% 
	      if (CaseCount==0) 
