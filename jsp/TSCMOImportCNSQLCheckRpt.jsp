...
{
   sSql = "SELECT a.ORDER_NUMBER, a.VER, "+
          "    substr(b.LINE_NUMBER,0,1) LINE_NUMBER, b.DESCRIPTION, b.QTY, "+
		  "    b.CREATE_DATE "+		  
   ...
   sSqlCNT = " select count(b.LINE_NUMBER) as CaseCount "+
             "  from TSC_IMPORT_OLDSYSTEM_LOG a,  TSC_IMPORT_OLDSYSTEM_LOG_LINE b, "+
		     "       TSC_IMPORT_OLDSYSTEM_LOG_MARK c ";  
...
{   
  ...
  out.println("sSql="+sSql);    
   ...
   String sqlOrgCnt = "select count(b.LINE_NUMBER) as CaseCountORG "+
                      "  from TSC_IMPORT_OLDSYSTEM_LOG a,  TSC_IMPORT_OLDSYSTEM_LOG_LINE b, "+
		              "       TSC_IMPORT_OLDSYSTEM_LOG_MARK c "; 
...
%> 
  <table cellSpacing='0' bordercolordark='#D8DEA9'  cellPadding='1' width='100%' align='center' borderColorLight='#ffffff' border='1'>     	 	 
	 <tr>
	    <td colspan="2" nowrap><font color="#006666"><strong>生產廠區</strong></font>         
        </td> 
	...
	<td colspan="2">
		    <INPUT TYPE="button" align="middle"  value='<jsp:getProperty name="rPH" property="pgQuery"/>' onClick='setSubmit("../jsp/TSCMOImportCNSQLCheckRpt.jsp")' > 			 
	</td>
   </tr>
  </table>  
<%
...
%>
  <table width="100%" border="1" cellpadding="0" cellspacing="0" bordercolorlight="#999999" bordercolordark="#FFFFFF">
    <tr>
	  <td height="22" nowrap colspan="7"><div align="center"><font color="#000000">台灣銷售訂單資訊</font></div></td>
	  <td height="22" nowrap colspan="6"><div align="center"><font color="#000000">大陸轉入訂單資訊</font></div></td>
	</tr>
    <tr bgcolor="#D8DEA9"> 
    ...
    <tr bgcolor="<%=colorStr%>"> 
	  ...
	  <% 
	                  ...
	                  String sSqlSQL = "select a.ORDERNO,a.VER, b.ITEMNO,b.ITEMDESCRIPTION, b.QTY, a.IMPORTDATE "+
					                   "from SALEMASTERTEMP a, SALEDETAILTEMP b "+
					                   "where a.ORDERNO = b.ORDERNO "+
					                   "and b.PCJUDGE = '"+rsTC.getString("PC_JUDGE")+"' and b.PCJUDGE = '"+prodManufactory+"' "+
					                   "and a.ORDERNO = '"+rsTC.getString("ORDER_NUMBER")+"' and b.ITEMNO = "+rsTC.getInt("LINE_NUMBER")+" ";
	                  out.println(sSqlSQL);
					  if (prodManufactory==null || prodManufactory.equals("") || prodManufactory.equals("T"))
					  {
					    /*  
	                    Statement stmentSQL=tewSQLcon.createStatement();
						...
						*/
					         ...
					         {
						          Statement stmentSQL=ilnAsistcon.createStatement();
                                  ResultSet rsSQL=stmentSQL.executeQuery(sSqlSQL);
					              if (rsSQL.next())
					              { 
					               orderNo = rsSQL.getString("ORDERNO");
	  ...
	  %>
	  <td width="10%" nowrap><div align="center"><font color="#006666"><%=orderNo%></font></div></td>	
	  <td width="3%" nowrap><div align="center"><font color="#006666"><%=ver%></font></div></td>
	  <td width="5%" nowrap><div align="center"><font color="#006666"><%=itemNo%></font></div></td>	
	  <td width="10%" nowrap><div align="center"><font color="#006666"><%=itemDesc%></font></div></td>	
	  <td width="6%" nowrap><div align="center"><font color="#006666"><%=qty%></font></div></td>
	  <td width="10%" nowrap><div align="center"><font color="#006666"><%=importDate%></font></div></td>    	  	                
    </tr>
    <%
  rs1__index++;
  rs_hasDataTC = rsTC.next();
