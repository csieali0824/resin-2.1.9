...
<body>
<FORM ACTION="WSARCheckReportA.jsp" METHOD="post" NAME="MYFORM">
 ...
 %>
  ...
  <table width="100%" border="0">
    <tr> 
      ...
      <td width="25%" bgcolor="#006699"><input name="button" type="button" onClick='setSubmit("../jsp/WSARCheckReportA.jsp")'  value="Query" > 
