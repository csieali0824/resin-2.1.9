...
<jsp:useBean id="qryAllChkBoxArrayEditBean" scope="session" class="bean.QryAllChkBoxEditBean"/>
 ...
 try
  {   
   ...
   {	 
    ...
    if (statusID.equals("004") || statusID.equals("005") || statusID.equals("011")) //�Y�����פ��ΧP�w�����A�hselect���󬰺��פu�{�v�ӤH
	{ 
	   if (searchString!=null && !searchString.equals("")) //�p�G���j�M�S�w�渹�h�t�USQL
	  {  
	     lotRs=lotStat.executeQuery("select count(distinct ASSIGN_MANUFACT) from ORADDMAN.TSDELIVERY_NOTICE a, ORADDMAN.TSDELIVERY_NOTICE_DETAIL b where a.DNDOCNO = b.DNDOCNO and a.DNDOCNO='"+searchString+"'");	
	   ...
	   if (statusID.equals("009")) //�Y�����ݥͦ��q�椤,�̦U�Ϸ~��,�u�ݱo��ۤv�}�ߪ����
       {	
	      if (searchString!=null && !searchString.equals("")) //�p�G���j�M�S�w�渹�h�t�USQL
	      {
		    lotRs=lotStat.executeQuery("select count(distinct ASSIGN_MANUFACT) from ORADDMAN.TSDELIVERY_NOTICE a, ORADDMAN.TSDELIVERY_NOTICE_DETAIL b where a.DNDOCNO = b.DNDOCNO and a.DNDOCNO='"+searchString+"'");	
 ...
 try
  {   
   ...
   {   //out.println("Step11");    	 	 
    ...
    if (statusID.equals("004") || statusID.equals("005") || statusID.equals("011") || statusID.equals("018") || statusID.equals("021")) //�Y�����פ��ΧP�w�����A�hselect���󬰺��פu�{�v�ӤH
	{ 
	   if (searchString!=null && !searchString.equals("")) //�p�G���j�M�S�w�渹�h�t�USQL
	  {
	     lotRs=lotStat.executeQuery("select count(distinct ASSIGN_MANUFACT) from ORADDMAN.TSDELIVERY_NOTICE a, ORADDMAN.TSDELIVERY_NOTICE_DETAIL b where a.DNDOCNO = b.DNDOCNO and a.DNDOCNO='"+searchString+"'");	
	  ...
	  if (statusID.equals("009")) //�Y���~�ȤH���ͦ��q��
	  {//out.println("Step16");
	      if (searchString!=null && !searchString.equals("")) //�p�G���j�M�S�w�渹�h�t�USQL
	     { //out.println("Step17");
		    lotRs=lotStat.executeQuery("select count(distinct ASSIGN_MANUFACT) from ORADDMAN.TSDELIVERY_NOTICE a, ORADDMAN.TSDELIVERY_NOTICE_DETAIL b where a.DNDOCNO = b.DNDOCNO and a.DNDOCNO='"+searchString+"'");	
	     ...
	     if (statusID.equals("020")) //�Y���A���ǳƫ�e��,�h�u���즬�󤤤ߤά��ݤ����פ��ߥi�ݨ�����e����
...
//			          { sql ="select REPNO,SVRDOCNO,IMEI,DSN,CMRNAME,BUYDATE,MODEL,COLOR,JAMDESC,JAMFREQ,OTHERJAMDESC,WARRTYPE,RECDATE,STATUS,SVRTYPENAME,ITEMNO,REPLVLNO,REPCENTERNO,REPPERSONID,a.REMARK from RPREPAIR where SVRTYPENO='"+svrTypeNo+"' and STATUSID='"+statusID+"' and b.LSTATUSID != '010' and (IMEI!='$' OR IMEI IS NULL) and (substr(RECCENTERNO,1,3)='"+userRepCenterNo+"') and REPNO in (select trim(REPNO) from RPREPLOT where LOTNO='"+searchString+"') and RECDATE between '"+queryDateFrom+"' and '"+queryDateTo+"' order by REPNO,RECDATE ASC"; }
   ...
   qryAllChkBoxArrayEditBean.setSubSearchStrIndx(4);	// �]�w���j�M�r��-4������
   ...
   qryAllChkBoxArrayEditBean.setSearchKeyArray(sKeyArray); // �HsetSearchKeyArray���N��, �]�����ݶǻ��T�Ӻ����Ѽ�
