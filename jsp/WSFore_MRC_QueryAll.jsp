...
<title>Query All Material Request Confirmation</title>
<style type="text/css">
<!--
.style1 {color: #FF0000}
-->
...
{   
  location.href="../jsp/WSFore_MRC_QueryAll.jsp?SEARCHSTRING="+document.MYFORM.SEARCHSTRING.value;
}
</script>
<%   
 ...
 {         
   ...
   {	
	 sql="select DOCNO,STATUS,USERNAME||'('||NEXTPRCSMAN||')' as NEXTPRCSMAN,TARGETYEAR||'/'||TARGETMONTH as TARGET_DATE from PSALES_FORE_MRC_HD,WSUSER where NEXTPRCSMAN=WEBID(+) and DOCNO like '"+searchString+"%'";	
   } else {    
	 sql="select DOCNO,STATUS,USERNAME||'('||NEXTPRCSMAN||')' as NEXTPRCSMAN,TARGETYEAR||'/'||TARGETMONTH as TARGET_DATE from PSALES_FORE_MRC_HD,WSUSER where NEXTPRCSMAN=WEBID(+)";	  
   }        
...
<strong>Material Request Confirmation List</strong></font>
<BR>
...
<table width="100%" border="0">
 ...
 {       
   ...
   queryAllEditBean.setPageURL("../jsp/WSFore_MRC_Display.jsp");      
