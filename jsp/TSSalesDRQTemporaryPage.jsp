<!-- 20150416 Peggy,java script function:subWindowOrderTypeFind�[customerid�Ѽ�-->
<!-- 20150417 Peggy,line qty�ק��ˬdspq��moq,CRD,REQUEST DATE�ˬd����榡-->
<!-- 20150507 Peggy,Sample Order�u���ˬdSPQ-->
<!-- 20150519 Peggy,add column "tsch orderl line id" for tsch case-->
<!-- 20150908 Peggy,sample��yew����u�n�j��t�Τ�Y�i-->
<!-- 20151008 Peggy,mtl_system_items_b�[�JCUSTOMER_ORDER_FLAG=Y AND CUSTOMER_ORDER_ENABLED_FLAG=Y�P�_-->
<!-- 20151026 Peggy,get_ssd  arrow ssd+�B��Ѽ�>=crd -->
<!-- 20160219 Peggy,�W�����P012 end customer�]������-->
<!-- 20160308 Peggy,for sample order add direct_ship_to_cust column-->
<!-- 20160318 Peggy,�Ȥ������w�q��,�۰ʱa�J-->
<!-- 20161228 Peggy,ITEM STATUS=NRND FOR SAMPLE ALERT-->
<!-- 20170216 Peggy,add sales region for bi-->
<!-- 20170425 Peggy,market group=AU & product package=SMA,������assign��YEW,�����P002,�_�h�̹w�]�u�t�O���(�PCELINE�Q��)-->
<!-- 20170511 Peggy,add end cust ship to id-->
<!-- 20171221 Peggy,TSCH-HK RFQ region code from 002 change to 018-->
<!-- 20180518 Peggy,TSCC���P012,022,�~�P002�Ȥ�8103 RFQ������JEND CUSTOMER-->
...
<jsp:useBean id="rfqArray2DTemporaryBean" scope="session" class="bean.Array2DimensionInputBean"/>
...
{     
	...
	//add by Peggy 20120112 check �t�O�O�_���T
	if (document.MYFORM.ACTIONID.value != "013")
	{
		...
		for (var i=0;i<num;i++)
		{   
			//add by Peggy 20150417,check qty�O�_��spq����
			if ((Math.round((eval(document.MYFORM.elements["MONTH"+i+"-3"].value)*1000)) % Math.round((eval(document.MYFORM.elements["MONTH"+i+"-11"].value)*1000)))>0)
			{
				...
				document.MYFORM.ACTIONID.value = "--"; //���F�T�Osubmit�e,array����W���ȳ����Qget��,�����j�G����ACTION
				document.MYFORM.elements["MONTH"+i+"-3"].focus();
				return (false);
			}
			//add by Peggy 20150507,SAMPLE�����ˬdMOQ
			...
			if (document.MYFORM.ACTIONID.value=="002" && document.MYFORM.SALESAREANO.value=="001")
			{
				if (document.MYFORM.elements["MONTH"+i+"-17"].value.toUpperCase().indexOf("FOB")>=0 || document.MYFORM.elements["MONTH"+i+"-17"].value.toUpperCase()=="EX WORKS" || document.MYFORM.elements["MONTH"+i+"-17"].value.toUpperCase()=="EX-WORK" || document.MYFORM.elements["MONTH"+i+"-17"].value.toUpperCase()=="FCA TAIWAN"  || document.MYFORM.elements["MONTH"+i+"-17"].value.toUpperCase()=="FCA TIANJIN" || document.MYFORM.elements["MONTH"+i+"-17"].value.toUpperCase()=="FCA YANGXIN XIAN"  || document.MYFORM.elements["MONTH"+i+"-17"].value.toUpperCase()=="FCA I-LAN" || document.MYFORM.elements["MONTH"+i+"-17"].value.toUpperCase()=="C&F H.K." || document.MYFORM.elements["MONTH"+i+"-17"].value.toUpperCase()=="EXW I-LAN" || document.MYFORM.elements["MONTH"+i+"-17"].value.toUpperCase()=="CIF H.K." )
				{
					...
					{
						if (document.MYFORM.elements["MONTH"+i+"-15"].value.toUpperCase()!="1214" || document.MYFORM.elements["MONTH"+i+"-17"].value.toUpperCase()!="EX WORKS")  //1214 EX WORKS�ƥ~ ADD BY PEGGY 20220105
						{
	...
	else if (document.MYFORM.ACTIONID.value!="002" && document.MYFORM.ACTIONID.value!="001"  && document.MYFORM.ACTIONID.value!="021" && document.MYFORM.ACTIONID.value!="013")  //��ܰʧ@�M�椣��CREATE,�i��O�ۦ��JLINE_ID,�]���ݥd������ʧ@
    { 
...
{ 
	...
	{  
  	...
  	document.MYFORM.ACTIONID.value="--"; // �קK�ϥΪ̥���ʧ@�A�]�w�U����	   	   
...
{  
	...
	if (warray[4]!=null) 
	{
		if (warray[4]!=0)
		{
			...
			{ 
				if (base >0 && spqQty>0) // �Y��̬Ҥj��s
				{ 
					var baseSPQ=spqQty;
					var baseMOQ=base;
	  				
					if (oQTY<baseMOQ) // �Y��J�ƶq�p�� MOQ �hĵ�i
					{ 
						if (xsampleOrder == "N")
						{ 
	...
	//add by Peggy 20111011,�ڬw��+SMA ITEM��AU���O�Ȥ�Ҥ������~�ʫ~
	...
	if ( document.MYFORM.SALESAREANO.value=="001")
	{
		if (document.MYFORM.LINEFOB.value.toUpperCase().indexOf("FOB") >=0 || document.MYFORM.LINEFOB.value.toUpperCase()=="EX WORKS" || document.MYFORM.LINEFOB.value.toUpperCase()=="EX-WORK" || document.MYFORM.LINEFOB.value.toUpperCase()=="FCA TAIWAN" || document.MYFORM.LINEFOB.value.toUpperCase()=="FCA TIANJIN" || document.MYFORM.LINEFOB.value.toUpperCase()=="FCA I-LAN" || document.MYFORM.LINEFOB.value.toUpperCase()=="FCA YANGXIN XIAN" || document.MYFORM.LINEFOB.value.toUpperCase()=="C&F H.K." || document.MYFORM.LINEFOB.value.toUpperCase()=="EXW I-LAN" || document.MYFORM.LINEFOB.value.toUpperCase()=="CIF H.K." )
		{
			...
			{
				if (document.MYFORM.LINEODRTYPE.value!="1214" || document.MYFORM.LINEFOB.value.toUpperCase()!="EX WORKS")  //1214 EX WORKS�ƥ~ ADD BY PEGGY 20220105
				{
	...
	//add by Peggy 20160219,012�~�ȰϤ��P�q�� end customer����
...
function setSPQCheck(xORDERQTY,xSPQP,xMOQP,xsampleOrder)
{
	...
	*/
	//modif by Peggy copy D1-001���ˬd��D1-009 20120516
	if (event.keyCode==13 || event.keyCode==9 ) // event.keycode = 9 --> Tab ��
	{ 
		if (xSPQP!=null) // �Y�t�Ψ��o�Ӧ��ƶ��̤p�]�˶q,�h�p��O�_��J�q�ʼƶq���̤p�]�˶q������
		{
			if (xSPQP==0 && xMOQP==0) //�Y�t�Ψ��o0, ��ܩ|���]�w�ӮƸ��̤p�]�˶q(MOQ��SPQ), ���o�߰�
			{
				alert("The Item SPQP not be default, Please contact with Item Administrator!!"); // �Y�n�d���J�̤p�]�˶q����,�h Enable��javascript
				document.MYFORM.REQUESTDATE.focus();  
				return(false); // �Y�n�d���J�̤p�]�˶q����,�h Enable��javascript
			} 
			else
			{ // �}�l�P�_�� MOQ /SPQ �W�h2006/06/05_�_
				if (xMOQP >0 && xSPQP>0) // �Y��̬Ҥj��s
				{ 
...
<%
	String dnDocNo=request.getParameter("DNDOCNO");
   	...
   	rfqArray2DTemporaryBean.setCommitmentMonth(commitmentMonth);//�]�w�ӿդ��
	...
	String v_conti_msg=""; //add by Peggy 202209	
  	...
  	{    
		rfqArray2DTemporaryBean.setArray2DString(null);//�N��bean�ȲM�ťH�����Pcase�i�H���s�B�@
  	}
	...
	try 
 	{   
   		String at[][]=rfqArray2DTemporaryBean.getArray2DContent();//���o�ثe�}�C���e     
  		...
  		{ 
    		...
    		String a[][]=rfqArray2DTemporaryBean.getArray2DContent();//���s���o�}�C���e
			if (a==null)
			{ 
				...
				{	  	  	    
					...
					for (int m=0;m<a.length;m++)
					{
						...
						if (inArray.equals("N")) 
						{
							...
							{                          // �ثe�@9��{ iNo,invItem,itemDescription,orderQty,uom,custrequestDate,shippingMethod,requestDate,lnRemark }      
								if (gg==0)
								{
...
if ((tsAreaNo==null && userActCenterNo.equals("020")) || tsAreaNo.equals("020"))  //add by Peggy 20150908,sample�ϥ���u�n�j��t�Τ�Y�i
{
	LIMITDAYS1 ="0";
}
...
<table cellSpacing="1" bordercolordark="#66CC99"cellPadding="1" width="100%" align="center" bordercolor="#66CC99" border="1">
	<tr bgcolor="#99CCFF">      
		...
		<%
		if (showSSD.equals("Y") || showSSD.equals("X")) //���CRD
		{
		%>
		...
		//modify by Peggy 20120209
		if (showSSD.equals("Y") || showSSD.equals("S") || showSSD.equals("X")) //���SHIPPINGMETHOD
		{
		%>
			<td width="9%" colspan="1">
			<div align="center"><font face="Arial" size="2" color="#3366FF">
...
%>    
	 ...
	 <%
	  ...
	  %>
		...
		else if (showSSD.equals("S") || showSSD.equals("X")) //���SHIPPINGMETHOD,modify by Peggy 20120209
		{
		%>
		<td width="5%" nowrap>    
		...
		try
       	{
			...
			{		
				...
				String a[][]=rfqArray2DTemporaryBean.getArray2DContent();//���o�ثe�}�C���e  	   			    
				int i=0,j=0,k=0;
			...
			<%
					...
					if (rsa.next())
					{
						...
						//if (invItem.substring(10,11).equals("1") || (tsc_prod_group.equals("PMD") && invItem.substring(3,4).equals("G"))) //PMD�Ƹ�22�X���ĥ|�X��G��GREEN COMPOUND,add by Peggy 20130319
						//{ 
				...
				{ //out.println("step6:����J��줺�e�@ Add ,����I���R����");
					if (a!=null) 
					{ 
							...
							for (int g=0 ; g < a.length ; g++)
							{
								if (a[g][15]!=null && !a[g][15].equals(""))
								{
									...
									if (rsa.next())
									{
										...
										remarks = rsa.getString("remarks");
										remarks = remarks.replace("?02",(greenFlag.equals("Y")?"green compound":""));  //modify by Peggy 20150519
										//if (a[g][1].substring(10,11).equals("1") ||  a[g][1].substring(3,4).equals("G")) //PMD�Ƹ�22�X���ĥ|�X��G��GREEN COMPOUND,add by Peggy 20130319
										//{ 
										//	remarks = remarks.replace("?02","green compound"); 
										//}
										//else
			...
			else 
			{
		 	...
		 	//###################�w��ثe�}�C���e�i���ˬd����#############################		  
		  	String T2[][]=rfqArray2DTemporaryBean.getArray2DContent();//���o�ثe�}�C���e�����Ȧs��;	  			  	
		  	if  (T2!=null) 
		  	{  		   
		    	//-------------------------���o��s�ΰ}�C-------------------- 		    
			 	...
			 	for (int ti=0;ti<T2.length;ti++) 
				{
			    	for (int tj=0;tj<T2[ti].length;tj++) 
					{
						...
						{
							//if ((showSSD.equals("Y") && (tj ==5 || tj==6)) || (tj!=5 && tj!=6)) //���CRD,SHIPPINGMETHOD
		    ...
		    //--------------------------------------------------------------------
		     	rfqArray2DTemporaryBean.setArray2DCheck(temp);  //�m�J�ˬd�}�C�H�������			   
		  	} 
			else 
			{    		      		     
      	...
      	{	
	    	String a[][]=rfqArray2DTemporaryBean.getArray2DContent();//���o�ثe�}�C���e 
		 	...
		 	{	
				...
				out.println(rfqArray2DTemporaryBean.getArray2DTempString());  // ��Item ��Item Description �@��Key ��Method				
		 	...
		 	else if (a==null)    // 2006/02/20 �P�_�Y�}�C�����ŭ�,�h�����Ʈw���� Temporary���e�m�J��C
		    {
			    ...
			    rfqArray2DTemporaryBean.setArray2DString(r);
  			    String q[][]=rfqArray2DTemporaryBean.getArray2DContent();//���o�ثe�}�C���e 	
                if (q!=null) 
		        {
...
<table align="left">
	...
	<% 
	//add by Peggy 20111103,�����ʧ@��abort,����Jcancel���]
