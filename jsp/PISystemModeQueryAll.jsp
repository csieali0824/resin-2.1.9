...
<html>
<head>
<title>Query All System Mode Data</title>
...
<body>
<FORM ACTION="../jsp/PISystemModeDel.jsp" METHOD="POST" onSubmit="return NeedConfirm()"> 
<input name="button" type=button onClick="this.value=check(this.form.CH)" value="全部選取">
<INPUT TYPE="submit" value="Delete">&nbsp;&nbsp;<A HREF="PISystemModeInput.jsp">New System Mode</A>&nbsp;&nbsp;<A HREF="/wins/WinsMainMenu.jsp">Home</A> 
<jsp:useBean id="queryAllCheckBoxBean" scope="page" class="QueryAllCheckBoxBean"/>
<% 
 try
 {  
   Statement statement=con.createStatement();
   ResultSet rs=statement.executeQuery("select SYSTEMMODE,MODEDESC from PISYSTEMMODE ORDER BY SYSTEMMODE");
