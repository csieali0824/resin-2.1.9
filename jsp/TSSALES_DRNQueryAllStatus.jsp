   ...
   {	 
	...
	{ 
	  ...
	  {  
	   ...
	   if (statusID.equals("009") || statusID.equals("010") || statusID.equals("015") || statusID.equals("022") || statusID.equals("016") || statusID.equals("017") || statusID.equals("019") || statusID.equals("029") || statusID.equals("031") || statusID.equals("034")) //�Y���T�ũΤu�t�h�i�ݨ����ݩ��U���Ҧ����פ��߮ץ�
       {	
	       if (searchString!=null && !searchString.equals("")) //�p�G���j�M�S�w�渹�h�t�USQL
	      {
		    /*
	      ...
	      rs=statement.executeQuery(sql);	   
	       ...
	       if (statusID.equals("020") || statusID.equals("028")) //�Y���A���ǳƫ�e��,�h�u���즬�󤤤ߤά��ݤ����פ��ߥi�ݨ�����e����
