...
<html>
<head>
<title>Updating Data of Product Factory Person</title>
<meta http-equiv="Content-Type" content="text/html; charset=Big5">
</head>
<body>
<%
String v_userID=request.getParameter("USERID");
String repCenterNo=request.getParameter("MANUFACTORY_NO");
...
try
{  
  String sql="update ORADDMAN.TSPROD_PERSON set PROD_FACNO=?,PROD_PERSONNO=?,USERNAME=? where USERID='"+v_userID+"'";
  ...
  out.println("Processing Data of Product Factory PC Person(ID:"+v_userID+") OK!<BR>");
