...
<%@ page import="bean.ComboBoxAllBean,bean.ComboBoxBean,bean.DateBean,bean.ArrayComboBoxBean,bean.ArrayListCheckBoxBean,java.text.DecimalFormat"%>
...
<body>
<FORM ACTION="WSARCheckReportSimple2.jsp" METHOD="post" NAME="MYFORM">
  <div align="left">
    <table width="100%" border="0">
      <tr>
        <td width="33%"><A HREF="../WinsMainMenu.jsp"><font size="2">HOME</font></A> 
          <% 
  ...
  %>
        ...
        <td width="67%"><strong><font color="#0000FF" size="+2" face="Arial">監檢日報表(簡表)</font></strong> 
          <%
      ...
      <td width="41%" bgcolor="#006699"><font color="#FFFF00"><strong>收款日結止日：</strong></font> 
		...
		<% if (DATE==null || DATE== "" || DATE.equals("")) 
		     ...
		     { out.println("value="+DATE); }
    	      ...
    	      String sDateBegin=DATE.substring(0,4)+DATE.substring(4,6)+"01";
			  																																							       		
		%>			
		> <font color="#FF0066" face="Arial Black">&nbsp;</font></td>
      <td width="27%" bgcolor="#006699"><input name="button" type="button" onClick='setSubmit("../jsp/WSARCheckReportSimple2.jsp")'  value="Query" >
