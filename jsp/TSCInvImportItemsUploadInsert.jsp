...
String organizationID=mySmartUpload.getRequest().getParameter("ORGANIZATION_ID");


//out.println("Step1");
com.jspsmart.upload.File upload_file=mySmartUpload.getFiles().getFile(0);
upload_file.saveAs("d://resin-2.1.9//webapps//oradds//clientupload/"+request.getRemoteAddr()+"-"+upload_file.getFileName()); 
String uploadFile_name=upload_file.getFileName();
String uploadFilePath="d://resin-2.1.9//webapps//oradds//clientupload/"+request.getRemoteAddr()+"-"+upload_file.getFileName();
//out.println("Step2");
String seqno=null;
String seqkey=null;
