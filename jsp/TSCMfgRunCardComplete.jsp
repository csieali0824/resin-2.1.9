...
<jsp:useBean id="arrMFGRCCompleteBean" scope="session" class="bean.Array2DimensionInputBean"/>
<jsp:useBean id="arrMFGCompResBean" scope="session" class="bean.Array2DimensionInputBean"/>
