<%@ page contentType="text/html; charset=utf-8" language="java" import="java.sql.*,bean.RsBean,bean.PoolBean,CheckBoxBean,bean.ArrayLstChkBoxInputBean,bean.ComboBoxBean" %>
