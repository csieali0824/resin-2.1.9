...
<strong> 產品編碼系統-產品研發單位查詢 </strong></font> 
<FORM ACTION="../jsp/WSMRDPTInquiry.jsp" METHOD="post" NAME="MYFORM">
<%
   int rs1__numRows = 25;
   int rs1__index = 0;
   int rs_numRows = 0;
 ...
 %>
  ...
  &nbsp;&nbsp;<A HREF="../jsp/WSMRDPTInput.jsp?ENTRY=TRUE">產品研發單位資料新增</A> 
  <% 
...
<table width="50%" border="0">      
    <tr>
      <td bgcolor="#FFFFFF" colspan="2"><font color="#000000" face="Arial Black"><strong>產品研發單位代碼 
        <%
         ...
         {       
		  ...
		  sSql = "select RD_CODE, RD_CODE || '(' || RDDPT ||')' "+
			     "from MRDPT ";	 
		  sSql = sSql+sWhere;
		  ...
		  comboBoxAllBean.setSelection(rd_Code);
	      comboBoxAllBean.setFieldName("RD_CODE");	   
          out.println(comboBoxAllBean.getRsString());
		  if (rs.next())
		  {		   
            rd_Code= rs.getString("RD_CODE");
    ...
    <td width="35%" bgcolor="#FFFFFF"><INPUT TYPE="button"  value="Query" onClick='setSubmit("../jsp/WSMRDPTInquiry.jsp")' ></td>    
    </tr> 
  ...
  <table width="50%" border="1" cellspacing="0" cellpadding="0">
    <tr bgcolor="#006666"> 
      ...
      <td width="19%"  height="19" bgcolor="#6699FF" nowrap><font color="#FFFFFF" size="2"><strong>公司別</strong></font></td>
      <td width="33%"  height="19" bgcolor="#6699FF" nowrap><font color="#FFFFFF" size="2"><strong>研發單位代碼</strong></font></td>
      <td width="45%"  height="19" bgcolor="#6699FF" nowrap><font color="#FFFFFF" size="2"><strong>研發單位簡稱</strong></font></td>
      <td width="45%"  height="19" bgcolor="#6699FF" nowrap><font color="#FFFFFF" size="2"><strong>研發單位說明</strong></font></td>
    </tr>
    <%  
            try
            {  
              ...
              String sqlTC =  "select RD_CODE,RDDPT_NO,RDDPT,RDDPR_DESC "+
			                  "from MRDPT ";
			  String sWhereTC = "where RD_CODE IS NOT NULL ";
			
              if (rd_Code == null || rd_Code.equals("--")) { sWhereTC = sWhereTC + "and RD_CODE != '0'  "; }
			  else { sWhereTC = sWhereTC + "and RD_CODE ='"+rd_Code+"'  "; }                      			             
             ...
             // if (MonthFr!="--" && MonthTo!="--") sWhereTC=sWhereTC+" and substr(LAUNCH_DATE,3,4)||substr(LAUNCH_DATE,1,2) between "+"'"+dateStringBegin+"'"+" and "+"'"+dateStringEnd+"' ";
			  ...
			  String sOrderTC = "order by RD_CODE ";
   ...
   //out.println("MM_size Step0="+MM_size);
    ...
    <tr bgcolor="<%=colorStr%>"> 
      ...
      <td height="20"><font size="2"> 
        <% 
                      if (rsTC.getString("RD_CODE")!=null ) { out.println(rsTC.getString("RD_CODE")); } 
                      else { out.println("&nbsp;"); }
                  %>
        </font></td>
      <td><font size="2" > 
        <%
                   //if (codeClass==null || codeClass=="2" || codeClass.equals("2"))
                     ...
                     if (rsTC.getString("RDDPT_NO")!=null) { out.println(rsTC.getString("RDDPT_NO")); } 
                     else { out.println("&nbsp;"); }
      ...
      <td><font size="2" > 
        <%
                      if (rsTC.getString("RDDPT") !=null) { out.println(rsTC.getString("RDDPT")); } 
                      else { out.println("&nbsp;"); }
      ...
      <td><font size="2" >
        <%
                      if (rsTC.getString("RDDPR_DESC") !=null) { out.println(rsTC.getString("RDDPR_DESC")); } 
                      else { out.println("&nbsp;"); }
                     //=rsTC.getString("TXRPCENTERNO") 
                 %>
        </font></td>
