...
<jsp:useBean id="arrMFGRCPOReceiptBean" scope="session" class="bean.Array2DimensionInputBean"/>
<jsp:useBean id="arrMFGPOResBean" scope="session" class="bean.Array2DimensionInputBean"/>
