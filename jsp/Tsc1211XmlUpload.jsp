...
<%
	String rootPath = application.getRealPath("/jsp/upload_xml");
...
<BR>
<p align="center">
<p align="center" class="style1"><font face="Verdana, Arial, Helvetica, sans-serif">TSC XML Upload Program and List </font></p>
</p>
...
<%@ include file="Tsc1211head.jsp"%>
  ...
  <TABLE width="70%" height="84" border="0" align="center" cellpadding="0" cellspacing="1" class="tborder">
    <tr bgcolor="#E6FFE6"> 
      <td height="30" colspan="6"> <div align="center"> 
          ...
          <input name="Submit" type="submit" class="btn" onclick ='setUpload("Tsc1211XmlUploadCheck.jsp")' value="Upload">
        </div></td>
    </tr>
	<tr> 
    ...
    <%
  	for(int i=0; i<fileList.size(); i++){
		...
		if( ((String)p.get("fn")).equals("Tsc1211XmlUpload") || ((String)p.get("fn")).equals("Tsc1211XmlUploadCheck.jsp")){
			continue;
		}
  ...
  %>
    <tr> 
      ...
      <td bgcolor="<%=color%>" >
	  <input type="submit" name="Submit" value="..." onclick ='setSubmit2("XMLParserToOracle.jsp?xmlname=<%=p.get("fn")%>")'>
	  </td>
      <td bgcolor="<%=color%>" > 
      ...
      <td bgcolor="<%=color%>" ><div align="center">
        <input type="submit" name="Submit2" value="insert" onclick ='setSubmit("XMLParserToOracle2.jsp?xmlname=<%=p.get("fn")%>")'>
      </div></td>
    </tr>
    <%
  	}
