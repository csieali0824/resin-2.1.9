...
<FORM NAME="MYFORM" ACTION="../jsp/DMProductScheduleFileUploadInsert.jsp?MODELNO=<%=sModelNo%>" METHOD="post" ENCTYPE="multipart/form-data">
  <p><A HREF='../WinsMainMenu.jsp'>HOME</A> <strong><font color="#004080" size="4">產品開發進度 File Upload</font></strong> </p>
