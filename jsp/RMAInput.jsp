...
<title>RMAInput.jsp</title>
</head>

<body onLoad="this.document.RMAform.IMEI.focus()">
...
<form action="../jsp/RMAUpdate.jsp" method="post" name="RMAform" onSubmit="return check();">
<div align="center">
<b>請輸入IMEI或Carton no:</b><br><br><input type="text" name="IMEI" size="20" maxlength="20">
<br><br>
<!--input name="button4" type="submit" onClick='Submit1("../jsp/UnShippingUpdate.jsp")'  value="修改" -->
<input type="submit" name="submit1" value="修改" onClick='check("../jsp/RMAInput.jsp")'>
