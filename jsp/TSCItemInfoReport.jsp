...
<!-- 20170510 Peggy,Product Group 8同 Forecast 及 BI 都使用 Function TSC_INV_Prod_Group_7-->
...
{ 	
	...
	strPath ="\\resin-2.1.9\\webapps\\oradds\\TSCItemList\\"+FileName;
	...
	{ 	
		...
		if (reccnt==0)
		{
			...
			////Franchise Lead time (Week) //MARK BY PEGGY 20240216
	...
	if (RTYPE.equals("AUTO") && reccnt>0)
	{
		...
		{
			remarks="";
			if (DATATYPE.equals("") && SYSDATE.equals(""))
			{			
				message.addRecipient(Message.RecipientType.TO, new javax.mail.internet.InternetAddress("amy.liu@ts.com.tw"));  //add by Peggy 20211209
			}
		}
