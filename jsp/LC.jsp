...
<form action="../jsp/LCShow.jsp" method="post" name="signform" onSubmit="return check();">
...
<table width="100%" border="1">
  <tr>
      ...
      <input name="submit1" type="submit" value="確定">
	  	  <%
         //out.println("Step0");
          String flgeLCCUR=request.getParameter("flgeLCCUR");
         //out.println("Step1");
         try
          { //out.println("Step3");
  
              if(flgeLCCUR ==null || flgeLCCUR=="" || flgeLCCUR.equals("")){
			  
              }else{
                     if(flgeLCCUR=="true" || flgeLCCUR.equals("true"))
                      {//out.println("Step5");
                        out.print("<font color=#FF0000 size=4><strong>錯誤:幣別需相同</strong></font>");
                      }
              }	
          }
         catch (Exception e)
