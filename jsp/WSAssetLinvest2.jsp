...
<%@ page import="bean.DateBean,java.text.DecimalFormat,bean.ComboBoxBean"%>
...
<body>
<FORM ACTION="WSAssetLinvest2.jsp" METHOD="post" NAME="MYFORM">
  <div align="left">
 ...
 %>
  ...
  <table width="100%" border="1" cellpadding="0" cellspacing="0">
    <tr bgcolor="#FFFFA8"> 
      <td width="134"  height="19" nowrap bordercolor="#CCCCCC"> 
        <div align="left"><font size="3"><strong><font color="#0000FF">公司別</font></strong> 
          </font></div></td>
      <td colspan="3" nowrap bordercolor="#FFFFA8" bgcolor="#FFFFA8"> <font color="#FF0066" face="Arial Black"><strong> 
        <%
         ...
         {   
		  ...
		  out.println("<select NAME='COMP' onChange='setSubmit("+'"'+"../jsp/WSAssetLinvest2.jsp"+'"'+")'>");
        ...
        %>
        </strong></font> <font color="#FF0066" face="Arial Black"><strong> </strong></font> 
       
        <INPUT name="button" TYPE="button" onClick='setSubmit("../jsp/WSAssetLinvest2.jsp")'  value="Query" > 
      </td>
      <td nowrap bordercolor="#FFFFA8" bordercolorlight="#FFFFA8">&nbsp;</td>
            ...
            { 
			  ...
			  if(comp.equals("01") || comp.equals("03") || comp.equals("04") || comp.equals("08") || comp.equals("23") || comp==null)
			   { sqlTC =  "SELECT J.JXSG01,j.jxsg02 as acct,g.svldes as acctname,j.jbamt as beginamt,j.jxdram as tdamt,j.jxcram as tcamt,j.jeamt as eamt   "+" "+
                 ...
                 %>
    <tr bgcolor="#FDC6FF"> 
      <td  height="19" nowrap bordercolor="#CCCCCC" bgcolor="#FFDFFF"> 
        <div align="left"><font color="#0000FF" size="3"><strong>會計科目 </strong></font></div></td>
    ...
    <tr bgcolor="#CCFFFF"> 
      <td  height="19" nowrap bordercolor="#CCFFFF" bgcolor="#CCFFFF"> 
