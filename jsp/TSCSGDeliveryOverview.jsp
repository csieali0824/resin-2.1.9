...
<title>SG Delivery Detail Report</title>
<!--=============以下區段為安全認證機制==========-->
...
String TSC_INVOICE_NO = request.getParameter("TSC_INVOICE_NO"); 
if (TSC_INVOICE_NO==null) TSC_INVOICE_NO=""; 

%>
<meta http-equiv="Content-Type" content="text/html; charset=big5"></head>
<body topmargin="0" bottommargin="0">  
<FORM ACTION="../jsp/TSCSGDeliveryOverview.jsp" METHOD="post" NAME="MYFORM">
<strong><font style="font-size:20px;color:#006666">SG出貨明細報表</font></strong>
<BR>
  ...
  <table cellSpacing='0' cellPadding='1' width='100%' align='center' borderColorLight="#CFDAD8"  bordercolordark="#5C7671" border='1'>
  	<tr>
        ...
        {   
			...
			String sql = " SELECT distinct a.PRODUCT_GROUP,a.PRODUCT_GROUP"+
...
%>    
			...
			&nbsp;&nbsp;
			&nbsp;&nbsp;
		    <INPUT TYPE="button" align="middle"  value='EXCEL'  style="font-family:ARIAL" onClick='setExportXLS("../jsp/TSCSGDeliveryOverviewExcel.jsp")' > 
		</td>
	</tr>
</table>
</FORM>
