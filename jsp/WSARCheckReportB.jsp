...
<body>
<FORM ACTION="WSARCheckReportB.jsp" METHOD="post" NAME="MYFORM">
 ...
 %>
  ...
  <table width="100%" border="0">
    <tr> 
      ...
      <td width="28%" bgcolor="#006699"><input name="button" type="button" onClick='setSubmit("../jsp/WSARCheckReportB.jsp")'  value="Query" > 
