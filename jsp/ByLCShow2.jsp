...
<body>
<strong><font color="#0080C0" size="5">LC查詢報表</font></strong> 
<%
   int rs1__numRows = 25;
   int rs1__index = 0;
   int rs_numRows = 0;
...
%>
  ...
  <FORM ACTION="../jsp/ByLCShow2.jsp" METHOD="post" NAME="MYFORM">
  <table width="100%">
     <tr bgcolor="#D0FFFF"> 	
      ...
      <td width="65%" bgcolor="#D0FFFF"> <font color="#CC3366" face="Arial Black"><strong>LC 
        NO</strong></font> 
        <input name="LCNO" type="text" size="20" maxlength="20">
	   </td>     	     
...
//////////////////////////////////////////////////////////////////////////////////////////////			
  ...
  <%
   ...
   %>
  <tr bgcolor="<%=colorStr%>"> 
    <td><a href="../jsp/ByLcEdit.jsp?LPORD=<%=rs.getString("LPORD")%>"><img src="../image/docicon.gif" width="14" height="19" border="0"></a></td>
