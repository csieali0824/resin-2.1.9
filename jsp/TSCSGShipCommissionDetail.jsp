...
<title>SG Ship Commission Report</title>
<!--=============以下區段為安全認證機制==========-->
...
<strong><font style="font-size:20px;color:#006666">TEW Commission Detail </font></strong>
<BR>
  ...
  <table cellSpacing='0' cellPadding='1' width='100%' align='center' borderColorLight="#CFDAD8"  bordercolordark="#5C7671" border='1'>
	      <td bgcolor="#D3E6F3"  style="font-weight:bold;color:#006666">SG-D/SG-E:</td> 
		    <td>	
		<%		
		try
    	{   
			Statement statement1=con.createStatement();
			sql = " select organization_id,case  organization_code when 'SG1' then 'SG-D' when 'SG2' then 'SG-E' else organization_code end as organization_code from inv.mtl_parameters a where organization_code IN ('SG1','SG2')";
		...
		<td width="10%" bgcolor="#D3E6F3"  style="font-weight:bold;color:#006666">Pick confirm Date :</td>   
		<td width="70%" colspan="3">
			...
			&nbsp;&nbsp;
			&nbsp;&nbsp;
		    <INPUT TYPE="button" align="middle"  value='EXCEL'  style="font-family:ARIAL" onClick='setExportXLS("../jsp/TSCSGShipCommissionDetailExcel.jsp")' > 
		</td>
	</tr>
</table>
</FORM>
