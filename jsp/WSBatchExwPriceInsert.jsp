...
<html>
<head>
<title>Insert SHIP-OUT PRICE UploadFile into Database</title>
...
{	               	 	        
  ...
  {  	    
	...
	String s="";
	String sql="insert into PSALES_FORE_EXWPRICE(FPCOMP,FPYEAR,FPMONTH,FPREG,FPCOUN,FPTYPE,FPPRJCD,FPEXWPRI,FPMVER,FPLUSER,FPCURR) values(?,?,?,?,?,?,?,?,?,?,?)";
	...
	{	 
	 ...
	 {               	  	  
	  ...
	  { 	   
	   ...
	   String price=s.substring(beginIDX,endIDX);
	   price=price.trim();
	   if (price.equals("")) price="0";
       pstmt.setString(8,price); //寫入抓取的各月數字	 
       pstmt.setString(9,dateString+dateBean.getHourMinute());
	...
	out.println("SHIP-OUT PRICE FILE UPLOAD SUCCESSFULLY");
