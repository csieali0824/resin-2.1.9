...
<title>Monthly Forecast Price Input Form</title>
</head>
<body>
...
<strong> Price of Forecast Input (With VAT)</strong></font> 
     ...
     <% 				 		 
      ...
      <td width="24%"><font size="2"> <font color="#333399" face="Arial Black"><strong>Country: 
       ...
       %> 
        ...
        <INPUT TYPE="button"  value="Add" onClick='setSubmit("../jsp/WSForecastPriceInput.jsp")' >
	  </font></td>     
  </tr>
</table>
<table width="100%" border="1" cellspacing="0" cellpadding="0">
    ...
    <td> <font size="2">
      <%	    	     		 		 
         ...
         {   
		  ...
		  sWhereC= "where PROJECTCODE IS NOT NULL and trim(PROJECTCODE) not in ("+aString+") order by x";	
		  sSqlC = sSqlC+sWhereC;		  
  ...
  <tr>  
    <td colspan="14"><a href='javaScript:setSubmit("../jsp/WSForecastPriceInput.jsp?BRINGLAST=Y")'>Last version of this model</a><BR><HR SIZE=2></td>
    </tr>
  <tr bgcolor="#FFCC33">
