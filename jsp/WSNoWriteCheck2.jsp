...
<jsp:useBean id="dateBean2" scope="page" class="bean.DateBean"/>
<head>
...
<body>
<FORM ACTION="WSNoWriteCheck2.jsp" METHOD="post" NAME="MYFORM">
    ...
    <table width="100%" border="1">
      <tr bgcolor="#0F87FF"> 
        ...
        <td width="9%"><div align="center"><font size="2" color="#000099"> 
            <input name="button" type="button" onClick='setSubmit("../jsp/WSNoWriteCheck2.jsp")'  value="Query" >
            </font></div></td>
