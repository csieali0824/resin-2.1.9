...
<html>
<head>
<title>Insert COGS UploadFile into Database</title>
  ...
  {  	    
	...
	{	 
	 ...
	 {               	  	  
	  ...
	  {	   
	   String sql="insert into PSALES_FORE_COGS(FCCOMP,FCYEAR,FCMONTH,FCREG,FCCOUN,FCTYPE,FCPRJCD,FCCOGS,FCMVER,FCLUSER,FCCURR) values(?,?,?,?,?,?,?,?,?,?,?)";
	   ...
	   String cost=s.substring(beginIDX,endIDX);
	   cost=cost.trim();
	   if (cost.equals("")) cost="0";
       pstmt.setString(8,cost); //寫入抓取的各月數字	 
	...
	out.println("COGS FILE UPLOAD SUCCESSFULLY");
