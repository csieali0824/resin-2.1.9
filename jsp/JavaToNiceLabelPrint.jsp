  ...
  {  
   ...
   if (rs.next())
   {
    ...
    { // 若格式是條碼檔,則以Java呼叫外部程式呼叫 Nice Label	
	  ...
	  String jobFileNPath = "d:/clientupload/"+jobFileName+".JOB";
	  FileWriter fw = new FileWriter(jobFileNPath);
      PrintWriter pw = new PrintWriter(fw);
      pw.write("LABEL "+"\""+"d:\\clientupload\\KerwinSample.lbl"+"\""+" ");
	  pw.write("SET V1="+"\""+"987654321"+"\""+" "); 
	  pw.write("SET "+"\""+"Bar Code"+"\""+"=123456789012 ");	     
      pw.close();
      fw.close();	
	
	  // 產生NiceLabel的條碼Job檔_迄
      ...
      try
      {     
	     out.println("jobFileNPath="+jobFileNPath+"<BR>");                          
	     //Runtime.getRuntime().exec("C://Program Files//EuroPlus//NiceLabel//Bin//nice3.exe KerwinSample.lbl ");
		 Runtime.getRuntime().exec("C://Program Files//EuroPlus//NiceLabel//Bin//nice3.exe "+jobFileNPath+" /s");
