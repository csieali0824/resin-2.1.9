...
String ITEM_DESC="",WIPNO = "",FileName="",VENDOR="",VENDOR_CODE=""; 
...
{ 	
	...
	{	
		...
		ws.setColumnView(col+i_merge_row-1,18);	
		ws.setColumnView(col+i_merge_row,18);	
		row++;//列+1
		...
		*/			
		...
		{					  		   
			...
			String ORIG_LOT=rs1.getString("lot_number"),ORIG_WAFER_QTY=rs1.getString("wafer_qty"),ORIG_CHIP_QTY=rs1.getString("chip_qty"),ORIG_DATE_CODE=rs1.getString("date_code"),ORIG_COMPLETION_DATE=rs1.getString("completion_date"),ORIG_WAFER_NUMBER=rs1.getString("wafer_number");
