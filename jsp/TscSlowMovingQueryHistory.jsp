...
<STYLE TYPE='text/css'> 
 ...
 .style18  {font-family:標楷體; font-size:16px; background-color:#6699CC; color:#FFFFFF; text-align:center;}
...
<strong> Slow Moving Stock Upload History</strong></font>
<br>
</p>
...
try
{
	sql = " SELECT VERSION_ID,UPDATED_BY,TO_CHAR(UPDATE_DATE,'yyyy-mm-dd hh24:mi:ss') UPDATE_DATE"+
	      ...
	      ", (select count(1) from  oraddman.TSC_IDLE_STOCK_DETAIL b where b.version_id = a.version_id) TRANS_TOT "+
	      " from oraddman.TSC_IDLE_STOCK_HEADER a order by version_id desc";
	...
	{	
		...
		out.println("<tr style='background-color:#CCCCCC;font-family:Arial;font-size:14px;'>");
