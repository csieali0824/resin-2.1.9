...
<FORM ACTION="../jsp/TSCWipNBUJobIssuePOAchieveReport .jsp" METHOD="post" NAME="MYFORM">
...
{
   sSql = "SELECT WDJ.WIP_ENTITY_NAME, MSI.SEGMENT1,MSI.DESCRIPTION, WRO.ITEM_DESCRIPTION, MIC.SEGMENT1 as TSC_PACKAGE, "+
		        " WDJ.SCHEDULED_START_DATE, WDJ.SCHEDULED_COMPLETION_DATE, WDJ.START_QUANTITY, MIC.SEGMENT1, "+ 
...
{   
   ...
   if (vendorName!=null && !vendorName.equals("")) { sWhere=sWhere+" and VND.VENDOR_NAME ='"+vendorName+"'";	} 
...
%> 
  <table cellSpacing='0' bordercolordark='#D8DEA9'  cellPadding='1' width='100%' align='center' borderColorLight='#ffffff' border='1'>     	 	 
	...
	<td colspan="2">
		    <INPUT TYPE="button" align="middle"  value='<jsp:getProperty name="rPH" property="pgQuery"/>' onClick='setSubmit("../jsp/TSCWipNBUJobIssuePOAchieveReport .jsp")' > 			 
	</td>
   </tr>
  </table>  
<%
...
%>
  <table width="100%" border="1" cellpadding="0" cellspacing="0" bordercolorlight="#999999" bordercolordark="#FFFFFF">
    <tr bgcolor="#D8DEA9">
	  <td width="4%" height="22" nowrap><div align="center"><font color="#000000">&nbsp;<img style="border-bottom-color:#CC0000 " border="1" src="../jsp/images/docLink.gif"></font></div></td> 	               	  
	  ...
	  <td width="8%" nowrap><div align="center"><font color="#006666">Received Q'ty</font></div></td>   
	  <td width="10%" nowrap><div align="center"><font color="#006666">Accumulative Q'ty</font></div></td>
    ...
    <tr bgcolor="<%=colorStr%>"> 
	  ...
	  <td nowrap><font color="#006666"><%=rsTC.getString("WIP_ENTITY_NAME")%></font></td>     	             
	  <td width="5%" nowrap><div align="center"><font size="2" color="#006666"><%=rsTC.getString("DESCRIPTION")%></font></div></td>
	  <td width="4%" nowrap><div align="center"><font color="#006666"><%=rsTC.getString("VENDOR_NAME")%></font></div></td> 
      <td width="10%" nowrap><font size="2" color="#006666">
	          <% out.println(rsTC.getString("PO")); %></font>
	  </td>
	  <td width="7%" nowrap><div align="center"><font color="#006666"><%=rsTC.getString("PR")%></font></div></td> 
	  <td width="6%" nowrap><div align="center"><font color="#006666"><%=rsTC.getString("ITEM_DESCRIPTION")%></font></div></td> 
	  <td width="5%" nowrap><div align="center"><font color="#006666"><%=rsTC.getString("ITEM_DESCRIPTION")%></font></div></td> 
	  <td width="8%" nowrap><div align="center"><font color="#006666"><%=rsTC.getString("TSC_PACKAGE")%></font></div></td> 
	  <td width="5%" nowrap><div align="center"><font color="#006666"><%=rsTC.getString("SCHEDULED_START_DATE")%></font></div></td> 
	  <td width="6%" nowrap><div align="center"><font color="#006666"><%=rsTC.getString("NEED_BY_DATE")%></font></div></td> 
	  <td width="10%" nowrap><div align="center"><font color="#006666"><%=rsTC.getString("START_QUANTITY")%></font></div></td> 
	  <td width="8%" nowrap><div align="center"><font color="#006666"><%=rsTC.getString("START_QUANTITY")%></font></div></td>
	  <td width="10%" nowrap><div align="center"><font color="#006666"><%=rsTC.getString("QUANTITY")%></font></div></td> 
	  <td width="8%" nowrap><div align="center"><font color="#006666"><%//rsTC.getString("SALESPERSON")%></font></div></td>  
	  <td width="8%" nowrap><div align="center"><font color="#006666"><%//rsTC.getString("SALESPERSON")%></font></div></td> 	  	                
    </tr>
    <%
  rs1__index++;
...
%>
    <tr bgcolor="#D8DEA9"> 
      <td height="23" colspan="16" ><font color="#006666"><jsp:getProperty name="rPH" property="pgQDocNo"/><jsp:getProperty name="rPH" property="pgMRItemQty"/></font> 
        <% 
	      if (CaseCount==0) 
