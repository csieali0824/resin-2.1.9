<html>
<head>
<title>TSCE Setron Order Import </title>
...
<jsp:useBean id="upBean" scope="page" class="javazoom.upload.UploadBean" >
  <jsp:setProperty name="upBean" property="folderstore" value="D:/resin-2.1.9/webapps/oradds/jsp/TSCESetron/" />
...
<%
	...
	SimpleDateFormat sdf = new SimpleDateFormat("yyyyMMdd_HHmmss");
        fileMover.setNewfilename("TSCESetron_"+sdf.format(new java.util.Date())+".xls");
        ...
        if ( (todo != null) && (todo.equalsIgnoreCase("upload")) )  {
         ...
         // Change the directory location below
         Workbook rw = Workbook.getWorkbook(new File("D:/resin-2.1.9/webapps/oradds/jsp/TSCESetron/"+fileMover.getFileName()));
   
         Sheet sheet = rw.getSheet(0);
 
         Cell   cellorderno   = sheet.getCell(0,3);
         String BufferOrderNo = cellorderno.getContents();

         out.println(BufferOrderNo);

         Cell cellcurrency = sheet.getCell(4,1);
         ...
         session.setAttribute("CUSTOMERID","2040");
         session.setAttribute("CUSTOMERNO","1480");
         session.setAttribute("CUSTOMERNAME","SETRON SERVICE DISTRIBUTION GMBH");
         ...
         session.setAttribute("PREORDERTYPE","1154");
         session.setAttribute("ISMODELSELECTED","Y");
         session.setAttribute("PROCESSAREA","001(�b����~�ȳ�-�ڬw��)");
         session.setAttribute("CUSTOMERIDTMP","2040");
...
// Process to determine the total item records
         ...
         try
          ...
          for ( int itemno=0 ; itemno < rows-3 ; itemno++)
          {
             cellpartdesc = sheet.getCell(3,itemno+3);
             cellpartdesc2 = sheet.getCell(2,itemno+3);
             String partdesc   = cellpartdesc.getContents();
             String partdesc2  = cellpartdesc2.getContents();
           
             if(!partdesc2.equals("Total"))
             {
             partdescCNT = "0"+cellpartdesc.getContents();
             }
           ...
           // To Check the ITEM result records
               ...
               sqlCNTitem = "select count(*) from APPS.OE_ITEMS_V where ITEM = '"+partdescCNT+"' ";
...
// End ITEM Count
          ...
          for( int i=0 ; i< rows-3 ; i++ )
          {
            ...
            //attention: The first parameter is column,the second parameter is row.  
             ...
             cellpartdesc = sheet.getCell(3,i+3);
             cellqty =  sheet.getCell(6,i+3);
             //cellreqdate = sheet.getCell(8,i+3);
             Cell cellreqdate = sheet.getCell(8,i+3);
             cellpartdesc2 = sheet.getCell(2,i+3);
             String partdesc2  = cellpartdesc2.getContents();
             String strdate = "";

             if(!partdesc2.trim().equals("Total"))
             {
             ...
             cellunitprice = sheet.getCell(5,i+3);
             ...
             BufferPartDesc[1][i] = "0"+cellpartdesc.getContents();
             ...
             // To Check the ITEM result records
              ...
              //out.println(BufferPartDesc[1][i]);
                    ...
                    sqlUOM = "select b.INVENTORY_ITEM_ID INVENTORY_ITEM_ID, b.SEGMENT1 SEGMENT1, b.DESCRIPTION DESCRIPTION, b.PRIMARY_UOM_CODE PRIMARY_UOM_CODE from APPS.OE_ITEMS_V a, APPS.MTL_SYSTEM_ITEMS b where a.item= '"+BufferPartDesc[1][i]+"' and a.INVENTORY_ITEM=b.SEGMENT1 and b.ORGANIZATION_ID = '49' "; 
...
<form method="post" action="TSCESetronImportTwo.jsp?UPLOADFLAG=Y" name="upform" enctype="multipart/form-data">
  ...
  <table width="60%" border="0" cellspacing="1" cellpadding="1" align="center">
    <tr>
      <td align="left"><font size="-1" face="Verdana, Arial, Helvetica, sans-serif"><b>Select
        TSCE Setron Order in Excel format to upload :</b></font></td>
    </tr>
    <tr>
