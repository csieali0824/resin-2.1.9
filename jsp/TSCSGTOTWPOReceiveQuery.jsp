...
{    
	if (document.MYFORM.VENDOR_INVOICE.value=="")
	{
		alert("請輸入發票號!");
		document.MYFORM.VENDOR_INVOICE.focus();
		return false;
	}
	
 	document.MYFORM.action=URL+"?INVOICE="+document.MYFORM.VENDOR_INVOICE.value;
 	document.MYFORM.submit();
}
...
<title>SG Purchase Receive Query</title>
<!--=============以下區段為安全認證機制==========-->
...
<FORM ACTION="../jsp/TSCSGTOTWPOReceiveQuery.jsp" METHOD="post" NAME="MYFORM">
<strong><font style="font-size:20px;color:#006666">SG ToTW Purchase Order Query</font></strong>
<BR>
...
<table cellSpacing='0' cellPadding='1' width='100%' align='center' borderColorLight="#CFDAD8"  bordercolordark="#5C7671" border='1'>
	<tr>
		<td bgcolor="#D3E6F3"  style="color:#006666">TSC PartNo/Description:</td>   
		...
		<td bgcolor="#D3E6F3"  style="color:#006666">LOT:</td>   
		...
		<td bgcolor="#D3E6F3"  style="color:#006666">Date Code:</td>   
	    ...
	    <td bgcolor="#D3E6F3" style="color:#006666">PO NO:</td> 
		...
		<td bgcolor="#D3E6F3"  style="color:#006666">Receipt Num:</td>   
	...
	<tr>
	    <td bgcolor="#D3E6F3" style="color:#006666">SG Invoice:</td> 
	    ...
	    <td bgcolor="#D3E6F3" style="color:#006666">Order Number:</td> 
		...
		<td width="8%" bgcolor="#D3E6F3"  style="color:#006666">Received Date:</td>   
		<td colspan="5">
<%
...
<BR>
<div align="center"><INPUT TYPE="button" align="middle"  value='<jsp:getProperty name="rPH" property="pgQuery"/>' style="font-family:Tahoma,Georgia" onClick='setSubmit("../jsp/TSCSGTOTWPOReceiveQuery.jsp")' > 
&nbsp;&nbsp;<input type="button" value="Acceptance Confirm" name="btn1" style="font-family:Tahoma,Georgia" onClick='setSubmit("../jsp/TSCSGTOTWPOReceive.jsp")'>
&nbsp;&nbsp;<input type="button" value="Advise Excel" name="btn2" style="font-family:Tahoma,Georgia" onClick='setSubmit1("../jsp/TSCSGTOTWPOReceiveExcel.jsp")'>
</div>
<hr>
<%
try
{       
	...
	sql = " select a.invoice_no"+
		  ...
		  " from oraddman.tssg_po_receive_tw a"+
	...
	sql += " order by  to_char(a.receive_date,'yyyy-mm-dd') desc,a.invoice_no,a.tew_advise_no,to_number(a.carton_no),a.lot";
	//out.println(sql);
	...
	{ 	
		...
		<table border="0" width="100%">
			<tr>
				<td bgcolor="#CCFF66" width="1%">&nbsp;</td><td width="20%">表示正在進行ERP交易中</td>
				<td width="79%">&nbsp;</td>
			</tr>
		</table>		
		<table width="100%" border="1" cellpadding="1" cellspacing="0" borderColorLight="#CFDAD8"  bordercolordark="#5C7671">
			<tr bgcolor="#C9E2D0"> 
				<td width="6%" style="color:#006666" align="center">Invoice No </td>
				<td width="6%" style="color:#006666" align="center">Receipt Num </td>
				<td width="7%" style="color:#006666" align="center">SG  Advise No</td>
				<td width="7%" style="color:#006666" align="center">Order Numbe#</td>
				<td width="3%" style="color:#006666" align="center">Order Line#</td>
				<td width="6%" style="color:#006666" align="center">TSC Prod Group </td>            
				<td width="12%" style="color:#006666" align="center">TSC Desc </td>            
				<td width="3%" style="color:#006666" align="center">Carton No </td>            
				<td width="7%" style="color:#006666" align="center">LOT</td>            
				<td width="5%" style="color:#006666" align="center">D/C</td>
				<td width="4%" style="color:#006666" align="center">DC YYWW</td>
				<td width="5%" style="color:#006666" align="center">Qty(K)</td>            
				<td width="3%" style="color:#006666" align="center">Org Code</td>            
				<td width="3%" style="color:#006666" align="center">Subinventory</td>            
				<td width="6%" style="color:#006666" align="center">PO NO </td>            
				<td width="3%" style="color:#006666" align="center">PO Line# </td>            
				<td width="8%" style="color:#006666" align="center">Received By </td>            
				<td width="6%" style="color:#006666" align="center">Received Date </td>            
			</tr>
		<% 
		}
		%>		
		<tr id="tr_<%=iCnt%>" bgcolor="<%=(rs.getString("process_flag").equals("F")?"#E7F1EB":"#CCFF66")%>" onMouseOver="this.style.Color='#ffffff';this.style.backgroundColor='#91819A';this.style.fontWeight='normal'" onMouseOut="style.backgroundColor='<%=(rs.getString("process_flag").equals("F")?"#E7F1EB":"#CCFF66")%>';style.color='#000000';this.style.fontWeight='normal'">
			<td align="center"><%=rs.getString("invoice_no")%></td>
			<td align="center"><%=(rs.getString("RECEIPT_NUM")==null?(rs.getString("PROCESS_FLAG").equals("Y")?"The transaction is processing":"&nbsp;"):rs.getString("RECEIPT_NUM"))%></td>
			...
			<td><%=(rs.getString("DC_YYWW")==null?"&nbsp;":rs.getString("DC_YYWW"))%></td>
			...
			<td align="center"><%=(rs.getString("po_line_num")==null?"&nbsp;":rs.getString("po_line_num"))%></td>
