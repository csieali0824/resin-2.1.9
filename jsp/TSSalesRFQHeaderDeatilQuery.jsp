...
if ((dateSetBegin==null || dateSetBegin.equals("")) && (dateSetEnd==null || dateSetEnd.equals("")))
{
   sSql = "select DISTINCT c.DNDOCNO,c.PROD_FACTORY,c.CUSTOMER, c.TSCUSTOMERID, "+
		  ...
		  "count(DISTINCT  d.line_no) as MAXLINE "+
   ...
   sSqlCNT = "select count(DISTINCT c.DNDOCNO) as CaseCount "+
               "from ORADDMAN.TSSALES_AREA b, "+
		            "ORADDMAN.TSDELIVERY_NOTICE c, ORADDMAN.TSDELIVERY_NOTICE_DETAIL d, ORADDMAN.TSPROD_MANUFACTORY e, "+
					"ORADDMAN.TSDELIVERY_DETAIL_HISTORY f ";
   sWhere =  "where c.DNDOCNO = d.DNDOCNO and c.DNDOCNO = f.DNDOCNO "+
...
%>  
  <table width="100%" border="1" cellpadding="0" cellspacing="0" bordercolorlight="#999999" bordercolordark="#FFFFFF">
    <tr bgcolor="#FFCC99"> 
	  ...
	  <td width="2%" height="22" nowrap><div align="center"><font color="#CC3366"  size="2"><jsp:getProperty name="rPH" property="pgProductDetail"/></font></div></td>               
      <td width="9%" nowrap><div align="center"><font color="#CC3366" size="2"><jsp:getProperty name="rPH" property="pgQDocNo"/></font></div></td>
      <td width="20%" nowrap><div align="center"><font color="#CC3366" size="2"><jsp:getProperty name="rPH" property="pgDetail"/></font></div></td>            
      <td width="10%" nowrap><div align="center"><font color="#CC3366" size="2"><jsp:getProperty name="rPH" property="pgSalesMan"/></font></div></td> 
	  <td width="12%" nowrap><div align="center"><font color="#CC3366" size="2"><jsp:getProperty name="rPH" property="pgCreateFormDate"/></font></div></td>                    
    </tr>
    ...
    %>
    <tr bgcolor="<%=colorStr%>"> 
      <td width="2%"><div align="center"><font size="2" color="#CC3366"><a name='#<%=rsTC.getString("DNDOCNO")%>'><%out.println(rs1__index+1);%></a></font></div></td>
      ...
      <td width="9%" nowrap><font size="2" color="#CC3366"><%=rsTC.getString("DNDOCNO")%></font></td>
      <td width="48%" nowrap><font size="2" color="#CC3366">
			  ...
			  //out.println("wipEntID="+wipEntID);out.println("rsTC.getString(INVENTORY_ITEM_ID)="+rsTC.getString("INVENTORY_ITEM_ID"));
			       ...
			       { 
					  ...
					  out.println("<font size='-1' color='#CC3366'>");
			              ...
			              {			    
				            ...
				            // if ( dnDocNo ==rsTC.getString("DNDOCNO") || dnDocNo.equals(rsTC.getString("DNDOCNO")) )
				             //{ //out.println("wipEntID="+wipEntID);out.println("rsTC.getString(INVENTORY_ITEM_ID)="+rsTC.getString("INVENTORY_ITEM_ID"));
				               ...
				               String sqlM = "select DISTINCT d.LINE_NO,d.LSTATUS,d.ITEM_DESCRIPTION, d.QUANTITY,d.UOM, "+
                                                    ...
                                                    "e.MANUFACTORY_NAME,d.REMARK,f.PROCESS_WORKTIME "+
										     "from ORADDMAN.TSSALES_AREA b, "+
										          "ORADDMAN.TSDELIVERY_NOTICE_DETAIL d, ORADDMAN.TSPROD_MANUFACTORY e, "+
												  "ORADDMAN.TSDELIVERY_DETAIL_HISTORY f ";										     
							  String whereM = "where d.DNDOCNO = f.DNDOCNO and (d.DNDOCNO = '"+rsTC.getString("DNDOCNO")+"' ) "+
							                  "and d.LINE_NO = f.LINE_NO and d.LSTATUSID = f.ORISTATUSID(+) "+
											  "and d.ASSIGN_MANUFACT = e.MANUFACTORY_NO(+) "+
										        // "or  d.DOCNO || '-' || d.ASSIGN_LNO in ("+distDnDocNo+") ) "+
				               ...
				               while (rsM.next())
				               {
								...
								out.println("</font></td><td nowrap><font size='1' color='#FFFFFF'>");
								%><jsp:getProperty name="rPH" property="pgWorkHour"/><%	
								out.println("</font></td></tr>");
								
								}// End of if (iRow==0)
								
				                out.println("<tr bgcolor="+subColStr+">");
				                out.println("<td width='1%' nowrap><font size='-2' color='#CC3366'>"+rsM.getString("LINE_NO")+"</font></td>");								
								out.println("<td nowrap><font size='-2' color='#CC0066'>"+rsM.getString("ITEM_DESCRIPTION")+"</font></td>");
								out.println("<td nowrap><font size='-2' color='#CC3366'>"+rsM.getString("UOM")+"</font></td>");
								out.println("<td nowrap><font size='-2' color='#CC3366'>"+rsM.getString("QUANTITY")+"</font></td>");
								out.println("<td nowrap><font size='-2' color='#CC3366'>"+rsM.getString(6)+"</font></td>");
								out.println("<td nowrap><font size='-2' color='#CC3366'>");
								...
								out.println("</font></td>");								
								out.println("<td nowrap><font size='-2' color='#CC3366'>"+rsM.getString("LSTATUS")+"</font></td>");
								out.println("<td nowrap><font size='-2' color='#CC3366'>"+rsM.getString("MANUFACTORY_NAME")+"</font></td>");
								out.println("<td nowrap><font size='-2' color='#CC3366'>");
								if (rsM.getString("ORDERNO")==null || rsM.getString("ORDERNO").equals("N/A")) out.println("N/A"); else out.println(rsM.getString("ORDERNO")); 
								out.println("</font></td>");
								out.println("<td nowrap><font size='-2' color='#CC3366'>"+rsM.getString("PROCESS_WORKTIME")+"</font></td>");
				                out.println("</tr>");
				           ...
				           //  }  // End of if (dnDocNo ==rsTC.getString("DNDOCNO") || dnDocNo.equals(rsTC.getString("DNDOCNO"))) 
							  /*
				                        ...
				                        out.print("<tr><td nowrap>"); 
										//out.println("<font size='-1' color='#CC3366'>"+rsTC.getString("DNDOCNO")+"</font>"); 
										out.print("<tr><td nowrap>"); 
					                    out.println("<font size='-1' color='#CC3366'>");
					                    %><jsp:getProperty name="rPH" property="pgTotal"/><%
					                    out.println(rsTC.getString("MAXLINE"));
...
%>
    <tr bgcolor="#FFFFFF"> 
      <td height="23" colspan="10" ><font color="#CC3366" size="2"><jsp:getProperty name="rPH" property="pgQDocNo"/><jsp:getProperty name="rPH" property="pgMRItemQty"/></font> 
        <% 
	      if (CaseCount==0) 
	 ...
	 &nbsp;&nbsp;<font color="#CC3366" size="2"><jsp:getProperty name="rPH" property="pgGTotal"/><jsp:getProperty name="rPH" property="pgItemQty"/></font>
