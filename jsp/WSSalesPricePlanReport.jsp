...
<body>
<FORM ACTION="../jsp/WSSalesPricePlanReport.jsp" METHOD="post" NAME="MYFORM">
<%
   int rs1__numRows = 50;
   int rs1__index = 0;
   int rs_numRows = 0;
...
<table width="100%" border="0">
    <tr>
      <td width="22%" bgcolor="#CCFFFF"><font color="#000066" face="Arial Black" size="+0"><strong>Region</strong></font><strong>        
        <%
         try
         {   
		  String sSql = "";
		 ...
		 */
		  out.println("<select NAME='REGION' onChange='setSubmit("+'"'+"../jsp/WSSalesPricePlanReport.jsp"+'"'+")'>");
      ...
      <td width="25%" bgcolor="#CCFFFF"><font color="#000066" face="Arial Black" size="+0"><strong>Country</strong></font><strong>        
        <%
         try
         {   
		  String sSql = "";
         ...
         */	
          ...
          out.println("<select NAME='COUNTRY' onChange='setSubmit("+'"'+"../jsp/WSSalesPricePlanReport.jsp"+'"'+")'>");
          out.println("<OPTION VALUE=-->--");     
          while (rs.next())
          {            
           String s1=(String)rs.getString(1); 
      ...
      <td width="20%" bgcolor="#CCFFFF"><font color="#000066" face="Arial Black" size="+0"><strong>Brand</strong></font>	  
	   <% 		
	     try
         {   
		  String sSql = "";		 
      ...
      <td width="33%" bgcolor="#CCFFFF"><font color="#000066" face="Arial Black" size="+0"><strong>Model</strong></font>	  
	  <%	    	     		 		 
	     try
         {		 
		  String sSqlC = "";
		  ...
		  if ( interModel!=null && !interModel.equals("--"))  comboBoxBean.setSelection(interModel);		  		  		  
	      comboBoxBean.setFieldName("INTERMODEL");	   
          out.println(comboBoxBean.getRsString());
    ...
    <tr>
      <td bgcolor="#CCFFFF" colspan="3">
        <font color="#000066" face="Arial Black" size="+0"><strong>Plan Date Fr.</strong></font>
        <%
       ...
       %>         
         <font color="#000066" face="Arial Black" size="+1"><strong> ~<font color="#000066" face="Arial Black" size="+0"><strong>Plan Date To</strong></font></strong></font>  
         <%
      ...
      <td bgcolor="#CCFFFF" colspan="1">
      <INPUT TYPE="button"  value="Query" onClick='setSubmit("../jsp/WSSalesPricePlanReport.jsp")' >             
      </td> 
      
    </tr>
</table>
<font color="#009999" face="Times New Roman" size="5"><strong>DBTEL</strong></font>
...
%>
<%   
out.println("<BR><font color='#330099' face='Times New Roman' size='4'><strong>This Month is :"+dateBean.getYearString()+"/"+dateBean.getMonthString()+"&nbsp;&nbsp;&nbsp;&nbsp;Currency:"+curr+"</strong></font>");
try 
{  
   ...
   //out.println("MM_size Step0="+MM_size);
    ...
    <%
      ...
      if (request.getParameterNames().hasMoreElements()) {
        ...
        %>
    <td width="8%"  height="19" bgcolor="#FFFFCC" rowspan="1"  nowrap><font color="#000000" size="2"><strong>
      <div align="center">日期</div>
    </strong></font></td> 
    <td width="8%"  height="19" bgcolor="#FFFFCC" rowspan="1"  nowrap><font color="#000000" size="2"><strong>
      <div align="center">系列</div>
    </strong></font></td> 
    <td width="9%"  height="19" bgcolor="#FFFFCC" rowspan="1"  nowrap><font color="#000000" size="2"><strong>
      <div align="center">PRICE<br>SEGMENT<BR>(含稅)</div>
    </strong></font></td>
    <td width="75%"  height="19" bgcolor="#FFFFCC" rowspan="1"  nowrap>
      <table height="100%" width="100%" border="1" cellspacing="0" cellpadding="0">
        <tr>
          <td rowspan="2" width="9%"><font color="#000000" size="2"><strong>
            <div align="center">內部<br>型號</div>
          </strong></font></td>
          <td rowspan="2" width="7%"><font color="#000000" size="2"><strong>
            <div align="center">內部<br>型號</div>
          </strong></font></td>
          <td rowspan="2" width="8%"><font color="#000000" size="2"><strong>
            <div align="center">LAUNCH<br>TIME</div>
          </strong></font></td>
          <td bgcolor="#FFFFCC" nowrap colspan="12"><div align="center">
              <%out.println("<font color='#FF0000' size='2'><strong><div align='center'>"+"("+rsTC.getString("BRAND")+")"+rsTC.getString("FPYEAR")+"/"+rsTC.getString("FPMONTH")+"</div></strong></font>");%>
          </div></td>
        </tr>
        <tr>
          <td width="7%"><font color="#000000" size="2"><strong><div align="center">銷貨成本</div></strong></font></td>
          <td width="6%"><font color="#000000" size="2"><strong><div align="center">銷售量</div></strong></font></td>
          <td width="6%"><font color="#000000" size="2"><strong><div align="center">最低<br>零售價</div></strong></font></td>
          <td width="6%"><font color="#000000" size="2"><strong><div align="center">零售總額</div></strong></font></td>
          <td width="6%"><font color="#000000" size="2"><strong><div align="center">出廠價</div></strong></font></td>
          <td width="6%"><font color="#000000" size="2"><strong><div align="center">出廠總額</div></strong></font></td>
          <td width="6%"><font color="#000000" size="2"><strong><div align="center">銷貨毛利</div></strong></font></td>
          <td width="6%"><font color="#000000" size="2"><strong><div align="center">毛利率</div></strong></font></td>
          <td width="9%"><font color="#000000" size="2"><strong><div align="center">CHANNEL 每台利潤</div></strong></font></td>
          <td width="9%"><font color="#000000" size="2"><strong><div align="center">CHANNEL 總利潤</div></strong></font></td>
          <td width="9%"><font color="#000000" size="2"><strong><div align="center">CHANNEL 利潤率</div></strong></font></td>          
        </tr>
    </table></td>
  </tr>
      <% 
      ...
      <div align="center">
        <% 
            if (rsTC.getString("SEGMENT")!=null ) 
            {
             ...
             out.println(rsTC.getString("FPYEAR")+"/"+rsTC.getString("FPMONTH"));
            } 
            else { out.println("&nbsp;"); }
      %>
      </div>
    ...
    <td height="20"><font size="2" color="#000099"><strong>
      <div align="center">
        <% 
            ...
            {
             //out.println(rsTC.getString("SEGMENT")+"<BR>"); 
             out.println(rsTC.getString("BRAND"));
            } 
            else { out.println("&nbsp;"); }
      %>
      </div>
		        ...
		        {  
                  ...
                  */  
					...
					while (rsIM.next())
					{
                     ...
                     ///*2004/05/31 取消檢查落於價格帶限制,以取出產品出廠價 */      
                                       // "and FPREG='"+region+"' and to_char(FPCOUN)='"+country+"' and (FPEXWPRI+1 between '"+rsTC.getString("SGMNT_FR")+"' and '"+rsTC.getString("SGMNT_TO")+"') "+
                                         "and FPREG='"+region+"' and to_char(FPCOUN)='"+country+"' "+      
                                          ...
                                          "and FPCOUN= BASECOUNTRY and FPYEAR='"+rsTC.getString("FPYEAR")+"' and FPMONTH='"+rsTC.getString("FPMONTH")+"' and COUNTRY='"+rsTC.getString("SCOUNTRY")+"' and trim(FPPRJCD)='"+rsIM.getString("INTER_MODEL")+"' "+
        ...
        <tr bgcolor="#FFFFFF" >    
          ...
          <td width="6%"><div align="right"><font size="2" color="#CC3366">
            <%
                 ...
                 //totFpPriceInt = Math.round(fpPrice)*Math.round(fwQty); // 2004/05/19 //
                 totFpPrice = Math.round(fpPrice)*fwQty;   
                 totFpPriceInt = Math.round(totFpPrice);          
            /*     
          ...
          <td width="6%"><div align="right"><font size="2" color="#CC3366">
            <%
                ...
                //totFpExwPriceInt=Math.round(fpExwPrice)*Math.round(fwQty); // 2004/05/19 //
                totFpExwPrice=Math.round(fpExwPrice)*fwQty;
                totFpExwPriceInt= Math.round(totFpExwPrice);
               /*             
          ...
          <td width="6%"><div align="right"><font size="2" color="#CC3366">
            <%
                ...
                //sellingProfitsInt = Math.round(fpExwPrice)*Math.round(fwQty)-(Math.round(fwQty)*Math.round(cogs));  // 2004/05/19 //
                sellingProfits = Math.round(fpExwPrice)*fwQty-(Math.round(cogs)*fwQty);
                sellingProfitsInt = Math.round(sellingProfits);  
            ...
            <%
                String GrossMRStr = "";
                 ...
                 if (fpExwPrice>=0 && sellingProfits>=0 )
                 {
                  ...
                  //GrossMarginRate=(sellingProfits/totFpExwPrice)*100;// 2004/05/18 採另類計算方式
                  float GrossMarginRateTemp = Math.round(fpExwPrice) - Math.round(cogs);
                  float fpExwPriceTemp = Math.round(fpExwPrice);
                  GrossMarginRate=(GrossMarginRateTemp/fpExwPriceTemp)*100;   
          ...
          <td width="9%"><div align="right"><font size="2" color="#CC3366">
            <%        // out.println("step0");  
                       ...
                       //totchnlProfitInt = (Math.round(fpPrice)-Math.round(fpExwPrice))*Math.round(fwQty); // 2004/05/19 //
                       totchnlProfit = (Math.round(fpPrice)-Math.round(fpExwPrice))*fwQty;
                       totchnlProfitInt = Math.round(totchnlProfit);     
                       /*
            ...
            <%
                ...
                // int chnlPRateInt = 0;
                 ...
                 if (vat!=0 && fpPrice !=0 )
                 {
                  ...
                  //out.println("fpPrice="+fpPrice);
                  //out.println("fpExwPrice="+fpExwPrice);
                  float chnlPRateTemp = Math.round(fpPrice)-Math.round(fpExwPrice);  
                  float fpPriceTemp = Math.round(fpPrice);    
                  //chnlPRate=((fpPrice)-fpExwPrice)/(fpPrice)*100;  // 2004/05/26 修改四捨五入
                  chnlPRate=(chnlPRateTemp)/fpPriceTemp*100;
                  //out.println("Step2");
                  //out.println("((fpPrice/vat)-fpExwPrice)/(fpPrice)*100="+chnlPRate);
                 // chnlPRateInt = Math.round(chnlPRate);
                  //out.println("Step3");
                  chnlPRateStr=Float.toString(chnlPRate); // 2004/05/26 修改四捨五入
                  //chnlPRateStr=Integer.toString(chnlPRateInt);    
