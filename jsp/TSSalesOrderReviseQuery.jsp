...
<FORM ACTION="../jsp/TSSalesOrderReviseQuery.jsp" METHOD="post" NAME="MYFORM">
	...
	<%
		try
		{
			...
			else if ((UserRoles.indexOf("admin")<0 && UserRoles.indexOf("MPC_User")<0 && UserRoles.indexOf("MPC_003")<0 && UserRoles.indexOf("Sales_M")<0 && UserRoles.indexOf("SalesOrderReviseQuey")<0 && UserName.indexOf("CYTSOU")<0 && UserName.indexOf("JUDY_CHO")<0 && UserName.indexOf("FRANK.SONG")<0 && UserName.indexOf("PERRY.JUAN")<0 && UserName.indexOf("JENNY_LIAO")<0) || (UserRoles.indexOf("Sale,")>=0  && UserRoles.indexOf("Sales_M")<0 && UserName.indexOf("CYTSOU")<0 && UserName.indexOf("JUDY_CHO")<0 && UserName.indexOf("FRANK.SONG")<0 && UserName.indexOf("PERRY.JUAN")<0 && UserName.indexOf("JUNE")<0 ))
			{
	...
	<table align="center" width="2350" border="1" bordercolorlight="#333366" bordercolordark="#ffffff" cellPadding="1" cellspacing="0">
		<tr style="background-color:#E9F8F2;color:#000000">
			...
			<td style="background-color:#FF6600;color:#ffffff" colspan="6" align="center">PC Replied Detail </td>
