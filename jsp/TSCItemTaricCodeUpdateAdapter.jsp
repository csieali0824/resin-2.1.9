...
<%@ page import="bean.DateBean,bean.SendMailBean,bean.SendMailBean,CodeUtil" %>
<html>
<head>
<meta http-equiv="Content-Type" content="text/html; charset=big5">
<title>TSC ITEM CATEGORY TARIC CODE UPDATE ADAPTER</title>
...
<%
  ...
  CallableStatement cs1 = con.prepareCall("{call TSC_UPDATE_TARICCODE_ADAPTER(?,?)}");		
  ...
  if (processStatus=="Update Taric Code Error" || processStatus.equals("Update Taric Code Error"))
  {
       String UserName = "";
       Statement stateList=con.createStatement();
	   String sqlList = "select a.USERMAIL, a.USERNAME from ORADDMAN.WSUSER a,ORADDMAN.WSGROUPUSERROLE b where a.USERNAME = b.GROUPUSERNAME and b.ROLENAME = 'admin' AND USERNAME in ('kerwin','suming') ";
	   ...
	   {   //out.println("USERMAIL="+rsList.getString("USERMAIL"));	
           ...
           sendMailBean.setSubject(CodeUtil.unicodeToBig5("Oracle Item Taric Code Updat Adapter Error "));	 
           //sendMailBean.setBody(CodeUtil.unicodeToBig5("Case No.:")+dnDocNo);	
		   sendMailBean.setUrlName("Dear "+rsList.getString("USERNAME")+",\n"+CodeUtil.unicodeToBig5("   請點擊來自JAVA開發平台JSP系統的郵件:Oracle Item Categories Taric Code更新系統異常-("+processStatus+")"));   	 
           sendMailBean.setUrlAddr(serverHostName+":8080/oradds/jsp/TSCItemTaricCodeUpdateAdapter.jsp");//
