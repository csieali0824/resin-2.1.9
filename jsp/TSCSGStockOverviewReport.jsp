...
{ 	
	...
	sql = " SELECT TSO.SG_STOCK_ID,TRUNC(SYSDATE)-TRUNC(TSO.RECEIVED_DATE) STOCK_AGE,TSC_INV_CATEGORY(TSO.INVENTORY_ITEM_ID,43,1100000003) TSC_PROD_GROUP,TSC_INV_CATEGORY(TSO.INVENTORY_ITEM_ID,43,23) TSC_Package"+
		  ...
		  ",APPS.TSCC_GET_FLOW_CODE(TSO.INVENTORY_ITEM_ID) as FLOW_CODE \n" +
	...
	sql_ship= " UNION ALL"+ // ----------出貨
		  ...
		  " AND round(TPCL.ADVISE_LINE_ID,0)=TSAL.ADVISE_LINE_ID"+
          ...
          " GROUP BY A.SG_STOCK_ID,TSAL.SO_NO ,TSAL.SHIPPING_REMARK,TSAH.ADVISE_NO,TO_CHAR(TSAL.PC_SCHEDULE_SHIP_DATE,'YYYY/MM/DD') ,TO_CHAR(TPCH.PICK_CONFIRM_DATE,'YYYY/MM/DD'),TSAL.ADVISE_LINE_ID "+
