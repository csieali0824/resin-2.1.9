...
<title>SG Shipping Advise Detail Report</title>
<!--=============以下區段為安全認證機制==========-->
...
<strong><font style="font-size:20px;color:#006666">SG 出貨明細查詢報表</font></strong>
<BR>
  ...
  <table cellSpacing='0' cellPadding='1' width='100%' align='center' borderColorLight="#CFDAD8"  bordercolordark="#5C7671" border='1'>
		...
		<td width="90%" colspan="3">
			...
			&nbsp;&nbsp;
			&nbsp;&nbsp;
		    <INPUT TYPE="button" align="middle"  value='EXCEL'  style="font-family:ARIAL" onClick='setExportXLS("../jsp/TSCSGShippingAdviseOverviewReport.jsp")' > 
		</td>
	</tr>
</table>
</FORM>
