...
<jsp:useBean id="upBean" scope="page" class="javazoom.upload.UploadBean" >
  <jsp:setProperty name="upBean" property="folderstore" value="D:/resin-2.1.9/webapps/oradds/jsp/TSCTTantronSample/" />
...
<%
	...
	SimpleDateFormat sdf = new SimpleDateFormat("yyyyMMdd_HHmmss");
        fileMover.setNewfilename("TSCTTantronSample_"+sdf.format(new java.util.Date())+".xls");
        ...
        if ( (todo != null) && (todo.equalsIgnoreCase("upload")) )  {
         ...
         cellcompinfo = sheet.getCell(4,0);
         //String CompInfo = cellcompinfo.getContents(); 
         //out.println(CompInfo);         

          // For Chinese Language Problem

         String temp_p          = replace(cellcompinfo.getContents(),"Company : ","");
         ...
         if (CompInfo.equals("BRIGHT DIAMOND"))
         {
         ...
         else if (CompInfo.equals("GLOBAL PACIFIC GROUP LTD "))
         {
         session.setAttribute("SPQCHECKED","N");
...
// Process to determine the total item records
          ...
          for ( int itemno=0 ; itemno < rows-8 ; itemno++)
          {
             cellpartdesc1 = sheet.getCell(0,itemno+8);
             //cellpartdesc2 = sheet.getCell(3,itemno+1);
...
// End ITEM Count
         ...
         for( int i=0 ; i< rows-8 ; i++ )
         {
            ...
            //attention: The first parameter is column,the second parameter is row.  
             ...
             cellpartdesc1 = sheet.getCell(0,i+8);
             //cellpartdesc2 = sheet.getCell(3,i+1);
             cellqty =  sheet.getCell(2,i+8);
             cellreqdate = sheet.getCell(3,i+8);
             cellunitprice = sheet.getCell(9,i+8); 
             cellremark = sheet.getCell(4,i+8);

             String RemarkDesc = cellremark.getContents();         
             String QtyCheck =  cellqty.getContents();
             String ReqDateTst = cellreqdate.getContents();
             out.println("Date--"+ReqDateTst);
...
<form method="post" action="TSCTTantronSampleImport.jsp?UPLOADFLAG=Y" name="upform" enctype="multipart/form-data">
