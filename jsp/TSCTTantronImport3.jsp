...
<%
	...
	SimpleDateFormat sdf = new SimpleDateFormat("yyyyMMdd_HHmmss");
        ...
        if ( (todo != null) && (todo.equalsIgnoreCase("upload")) )  {
         ...
         session.setAttribute("CUSTOMERNAME","?�M?W�Xe?UaN�D��|3--??�Dq");
...
// End ITEM Count
         ...
         for( int i=0 ; i< rows-7 ; i++ )
         {
            ...
            //attention: The first parameter is column,the second parameter is row.  
             ...
             BufferQuantityNew[3][i] = Double.parseDouble(BufferQuantity[3][i])*1.0;
...
<form method="post" action="TSCTTantronImport3.jsp?UPLOADFLAG=Y" name="upform" enctype="multipart/form-data">
...
<% //TSCEBufferImport.jsp?UPLOADFLAG=Y
  ...
  String q[][]=arrayRFQDocumentInputBean.getArray2DContent();//�Lu��o�DO?e�X}|C?oRe 		
