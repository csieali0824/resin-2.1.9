...
<script language="JavaScript" type="text/JavaScript">
 ...
 {  
  ...
  function FriendlyPrint(URL,printSet,custno,custname,contact,sarea,userID)
 {  
   //Boolean printSet; 
  // document.MYFORM.action=URL;
  //document.MYFORM.submit();  
     
   if (printSet=="true" || printSet.equals("true"))
   {
     subWin=window.open("CustomerMasterShow.jsp?CUSTNO="+custno+"&CUSTNAME="+custname+"&CONTACT="+contact+"&SAREA="+sarea+"&USERID="+userID,"subwin","width=800,height=600,scrollbars=yes,menubar=yes");  
   } else {
                 subWin=window.open("CustomerMasterShow.jsp?CUSTNO="+custno+"&CUSTNAME="+custname+"&CONTACT="+contact+"&SAREA="+sarea+"&USERID="+userID,"subwin","width=800,height=600,scrollbars=yes,menubar=no");       				
              }	
...
<FORM ACTION="../jsp/CustomerMasterInquiry.jsp" METHOD="post" NAME="MYFORM" >
  ...
  <table width="100%" border="0">
    <tr> 
      <td align="center"><strong><font color="#0000FF" size="+2" face="Arial">Customer 
        Master Inquiry 
        <%
          int rs1__numRows = 50;
          int rs1__index = 0;
  ...
  <table width="100%" height="53" border="0" bordercolor="#CCFFFF" >
    <tr bgcolor="#66CCFF"> 
      ...
      <td width="14%"><input name="Search"  type="submit" value="查詢" onClick='return Submit("../jsp/CustomerMasterInquiry.jsp")'></td>	  
    </tr>	   
	<tr bgcolor="#66CCFF">
	 ...
	 <td nowrap>
       ...
       %>  
		   ...
		   <td><input name="Print"  type="button" value="列印" onClick='return FriendlyPrint("../jsp/CustomerMasterShow.jsp","<%=printSet%>","<%=custno%>","<%=custname%>","<%=contact%>","<%=sarea%>","<%=userID%>")'></td>
	</tr>
  </table>
...
<table width="100%" border="0">
  <tr align="center" bordercolor="#000000" > 
    <td width="24%"> 
      <div align="center">
        <pre><font color="#FF0000"><strong><A HREF="<%=MM_moveFirst%>">First</A></strong></font></pre>
      </div></td>
    <td width="24%"> 
      <div align="center">
        <pre><font color="#FF0000"><strong><A HREF="<%=MM_movePrev%>">Previous</A></strong></font></pre>
      </div></td>
	<td width="24%"> 
      <div align="center">
        <pre><font color="#FF0000"><strong><A HREF="<%=MM_moveNext%>">Next</A></strong></font></pre>
      </div></td>
    <td width="28%"> 
      <div align="center">
        <pre><font color="#FF0000"><strong><A HREF="<%=MM_moveLast%>">Last</A></strong></font></pre>
      </div></td>
  </tr>
</table>  
</body>
