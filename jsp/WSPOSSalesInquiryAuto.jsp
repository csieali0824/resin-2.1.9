...
<FORM ACTION="../jsp/WSPOSSalesInquiryAuto.jsp" METHOD="post" NAME="MYFORM">  
 <%
   int rs1__numRows = 25;
   int rs1__index = 0;
   int rs_numRows = 0;
      ...
      <td width="44%" height="23" bordercolor="#FFFFFF"> <p><font color="#CC3366" face="Arial Black"><strong>STORE 
          ...
          <% 
           ...
           {   
		     ...
		     out.println("<select NAME='STORE_NO' onChange='setSubmit("+'"'+"../jsp/WSPOSSalesInquiryAuto.jsp"+'"'+")'>");
     ...
     <tr bgcolor="#D0FFFF"> 	
      <td width="70%" valign="top" bordercolor="#CCCCCC" bgcolor="#CCEEFF"> <font color="#CC3366" face="Arial Black"><strong>SALE 
	   ...
	   <td width="20%" bgcolor="#D0FFFF">
	      <input name="submit1" type="submit" value="Enter" onClick='return setSubmit("../jsp/WSPOSSalesInquiryAuto.jsp")'>
	   </td>
	</tr>
  </table>
  <BR>
		 ...
		 <%  
            ...
            {               
			  ...
			  String sWhereTC = "where a.STORE_NO=b.STORE_NO and b.ITEM_CODE=c.ITEM_CODE and a.MOD_ID !='Y'  ";
               ...
               else { sWhereTC=sWhereTC+" and b.SAL_DATE between "+"'"+dateCurrent+"'"+" and "+"'"+dateCurrent+"' "; }
			  
			  String sOrderTC = "order by a.STORE_NO, b.SAL_DATE ";
   
              //sql = sql + sWhere + sWhereRep + sOrder;  // ?¢G¢D[sWhereRep |]!LI!LI¢DIaIAI?iou-!N¢XI?C?J //
