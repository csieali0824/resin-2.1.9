...
<%     
  ...
  String regionNo=mySmartUpload.getRequest().getParameter("REGION");
...
<table width="100%" border="0">
    <tr bgcolor="#D0FFFF">
	 ...
	 <% 
	   ...
	   {
   	      out.println("<input name='submit1' type='submit' value='Load Ship-out Price file' onClick='return setSubmit("+'"'+"../jsp/WSBatchExwPriceInsert.jsp"+'"'+")'> ");
	   }  
	 %> 
	<% 
	    if (UserRoles.indexOf("admin")>=0 || UserRoles.indexOf("ForecastAdmin")>=0)
	   {
   	      out.println("<input name='submit1' type='submit' value='Load COGs file' onClick='return setSubmit("+'"'+"../jsp/WSBatchCogsInsert.jsp"+'"'+")'> ");
	   }  
	 %> 
	 <% 
	    if (UserRoles.indexOf("admin")>=0 || UserRoles.indexOf("ForecastAdmin")>=0)
	   {
   	      out.println("<input name='submit1' type='submit' value='Load Retailer Price file' onClick='return setSubmit("+'"'+"../jsp/WSBatchRetailerPriceInsert.jsp"+'"'+")'> ");
	   }  
	 %>    	  
	 <% 
	    if (UserRoles.indexOf("admin")>=0 || UserRoles.indexOf("ForecastAdmin")>=0)
	   {
   	      out.println("<input name='submit1' type='submit' value='Load Sales Forecast' onClick='return setSubmit("+'"'+"../jsp/WSBatchForecastInsert.jsp"+'"'+")'> ");
	   }  
	 %> 
</td> 
	</tr>	
    ...
    <tr bgcolor="#FFFFFF"> 	   
       <td colspan="9"><strong></strong>
          <font color="#004080"><strong>Upload
                       FILE</strong></font><font size="2">
