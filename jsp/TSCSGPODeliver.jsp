...
String STATUS="ACCEPT",id="";
int rowcnt=0;
%>
<body> 
<FORM ACTION="../jsp/TSCSGPODeliver.jsp" METHOD="post" NAME="MYFORM">
<div style="font-family:Tahoma,Georgia;font-weight:bold;font-size:20px">SG PO Deliver </div>
...
<TABLE width="100%" border='1' bordercolorlight='#426193' bordercolordark='#ffffff' cellPadding='1' cellspacing='0' bgcolor="#DAF0FC">
  ...
  <DIV align="CENTER"><input type="button" name="btnQuery" value="Query"  style="font-family:Tahoma,Georgia;font-size:11px" onClick="setQuery('../jsp/TSCSGPODeliver.jsp')">&nbsp;&nbsp;
		</DIV>
        <HR>
<%
try
...
<table align="center" width="100%" border="1" bordercolorlight="#333366" bordercolordark="#ffffff" cellPadding="1" cellspacing="0">
	<tr style="background-color:#D1E0D3;color:#000000">
		...
		<td width="3%" align="center" style="background-color:#66CCCC;color:#000000"><input type="checkbox" name="chkall"  onClick="checkall()"></td>
		<td width="4%" style="background-color:#51874E;color:#FFFFFF;" align="center">內外銷</td>
		<td width="11%" style="background-color:#51874E;color:#FFFFFF;" align="center">Receipt Num</td>
		<td width="11%" style="background-color:#51874E;color:#FFFFFF;" align="center">PO NO</td>
		<td width="14%" style="background-color:#51874E;color:#FFFFFF;" align="center">Vendor Name</td>
		...
		<td width="8%" style="background-color:#51874E;color:#FFFFFF;" align="center">Date Code</td>
		<td width="8%" style="background-color:#51874E;color:#FFFFFF;" align="center">Qty(K)</td>
		<td width="8%" style="background-color:#51874E;color:#FFFFFF;" align="center">Receive Date</td>
	</tr>
		<%
		}
	...
	<tr id="tr_<%=id%>">
		...
		<td id="tda_<%=id%>" align="center">
			<input type="checkbox" name="chk" value="<%=id%>" onClick="setCheck(<%=(rowcnt-1)%>)"> <%=(rs.getString("rcv_inspect_trx_id")==null?"disabled":"")%></td>
...
<table border="0" width="100%" bgcolor="#DAF0FC">
	<tr>
		...
		<font style="font-family:Tahoma,Georgia;">Action：</font><select NAME="ACTIONTYPE" style="font-family:Tahoma,Georgia;" onChange="changobj()">
		        ...
		        <OPTION VALUE="DELIVER" <%if (ACTIONTYPE.equals("DELIVER")) out.println("selected");%>>Deliver</OPTION>
		        <OPTION VALUE="RETURN TO RECEIVING" <%if (ACTIONTYPE.equals("RETURN TO RECEIVING")) out.println("selected");%>>Return to Receiving</OPTION>
				<OPTION VALUE="RETURN TO VENDOR" <%if (ACTIONTYPE.equals("RETURN TO VENDOR")) out.println("selected");%>>Return to Supplier</OPTION>
				</select>
		<input type="button" name="submit1" value="Submit" style="font-size:11px;font-family: Tahoma,Georgia;" onClick='setSubmit("../jsp/TSCSGPOReceiveProcess.jsp?TRANSTYPE=DELIVER")'></td>
	</tr>
</table>
<hr>
	<%
