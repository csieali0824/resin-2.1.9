...
String prodAppear=request.getParameter("PRODAPPEAR");
String appearDesc=request.getParameter("APPEARDESC");
...
{  
	   ...
	   //{
		 ...
		 //String c_in_array=request.getParameter("MONTH"+ac+"-"+subac);//取前一頁之輸入欄位
          // sql="insert into PSALES_FORE_COST(FCCOMP,FCYEAR,FCMONTH,FCREG,FCCOUN,FCTYPE,FCPRJCD,FCCOST,FCMVER,FCLUSER,FCCURR) values(?,?,?,?,?,?,?,?,?,?,?)";
           sql="insert into MRPROD_APRNCE(APPEAR_CODE,PROD_APPEAR,APPEAR_DESC) values(?,?,?)";
  ...
  out.println("輸入產品外觀代碼新增成功 !!!<BR>");
  out.println("<A HREF=/wins/WinsMainMenu.jsp>首頁</A>&nbsp;&nbsp;<A HREF=../jsp/WSMRProdAprnceInput.jsp?ENTRY=TRUE>產品外觀代碼資料新增</A>&nbsp;&nbsp;<A HREF='../jsp/WSMRProdAprnceInquiry.jsp'>產品外觀代碼資料查詢</A> ");
