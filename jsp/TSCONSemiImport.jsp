<!--20171106 Peggy,po���line-->
<!--20180202 Peggy,�q��1141�X�f�覡��DHL from Chris-->
<!--20180706 Peggy,on semi houseno�ܦ�-ON-->
<!--20180706 Peggy,on semi houseno�ܦ�-E-->
<!--20180202 Peggy,�q��1141�X�f�覡��UPS EXPRESS from Ava-->
<html>
<head>
	...
	if (MultipartFormDataRequest.isMultipartFormData(request))  
	{
		...
		if ( (todo != null) && (todo.equalsIgnoreCase("upload")) )  
		{
			...
			if ( (files != null) || (!files.isEmpty()) )  
			{
				...
				//Cell   cellorderno   = sheet.getCell(3,2);  //���line,modify by Peggy 20171106
