...
<strong> 產品編碼系統-產品平台資料查詢 </strong></font>
<FORM ACTION="../jsp/WSProdPlatformInquiry.jsp" METHOD="post" NAME="MYFORM">
<%
   int rs1__numRows = 25;
   int rs1__index = 0;
   int rs_numRows = 0;
 ...
 %>
<A HREF="../WinsMainMenu.jsp">首頁</A> &nbsp;&nbsp;<A HREF="../jsp/WSModelEncodingSub.jsp">產品編碼管理作業</A> &nbsp;&nbsp;<A HREF="../jsp/WSMRProdPlatformInput.jsp?ENTRY=TRUE">產品發展平台代碼資料新增</A>
<% 
...
<table width="50%" border="0">      
    <tr>
      <td bgcolor="#FFFFFF" colspan="2"><font color="#000000" face="Arial Black"><strong>產品平台代碼
        <%
         ...
         {       
		  ...
		  sSql = "select PLATFORM_CODE, PLATFORM_CODE || '(' || SPLATFM_NAME ||')' "+
			     "from PRPROD_PLATFORM ";	 
		  sSql = sSql+sWhere;
		  ...
		  comboBoxAllBean.setSelection(platFormCode);
	      comboBoxAllBean.setFieldName("PLATFORMCODE");	   
    ...
    <td width="35%" bgcolor="#FFFFFF"><INPUT TYPE="button"  value="Query" onClick='setSubmit("../jsp/WSMRProdPlatformInquiry.jsp")' ></td>    
    </tr> 
...
<table width="50%" border="1" cellspacing="0" cellpadding="0">
        <tr bgcolor="#006666"> 
		  ...
		  <td width="19%"  height="19" bgcolor="#6699FF" nowrap><font color="#FFFFFF" size="2"><strong>產品平台代碼</strong></font></td>
          <td width="20%"  height="19" bgcolor="#6699FF" nowrap><font color="#FFFFFF" size="2"><strong>產品平台名稱</strong></font></td>
          <td width="35%"  height="19" bgcolor="#6699FF" nowrap><font color="#FFFFFF" size="2"><strong>平台簡稱</strong></font></td>  
          <td width="30%"  height="19" bgcolor="#6699FF" nowrap><font color="#FFFFFF" size="2"><strong>廠商名稱</strong></font></td>                  	  		  
        </tr> 
          <%  
            try
            {  
              ...
              String sqlTC =  "select PLATFORM_CODE, SPLATFM_NAME, PLATFORM, VND_NAME "+
			                  "from PRPROD_PLATFORM ";
			  String sWhereTC = "where PLATFORM_CODE IS NOT NULL ";
			
              if (platFormCode == null || platFormCode.equals("--")) { sWhereTC = sWhereTC + "and PLATFORM_CODE != '0'  "; }
			  else { sWhereTC = sWhereTC + "and PLATFORM_CODE ='"+platFormCode+"'  "; }                      			             
             ...
             // if (MonthFr!="--" && MonthTo!="--") sWhereTC=sWhereTC+" and substr(LAUNCH_DATE,3,4)||substr(LAUNCH_DATE,1,2) between "+"'"+dateStringBegin+"'"+" and "+"'"+dateStringEnd+"' ";
			  ...
			  String sOrderTC = "order by PLATFORM_CODE ";
      ...
      if (request.getParameterNames().hasMoreElements()) {
        ...
        <tr bgcolor="<%=colorStr%>">
          ...
          <td height="20"><font size="2">
                 <% 
                      if (rsTC.getString("PLATFORM_CODE")!=null ) { out.println(rsTC.getString("PLATFORM_CODE")); } 
                      else { out.println("&nbsp;"); }
                  %></font></td>		           	           
		  <td><font size="2" >
                 <%
                   //if (codeClass==null || codeClass=="2" || codeClass.equals("2"))
                     ...
                     if (rsTC.getString("SPLATFM_NAME")!=null) { out.println(rsTC.getString("SPLATFM_NAME")); } 
                     else { out.println("&nbsp;"); }
          ...
          <td><font size="2" >
                 <%
                      if (rsTC.getString("VND_NAME") !=null) { out.println(rsTC.getString("VND_NAME")); } 
                      else { out.println("&nbsp;"); }
                     //=rsTC.getString("TXRPCENTERNO") 
                 %></font></td>		                 
       </tr>
