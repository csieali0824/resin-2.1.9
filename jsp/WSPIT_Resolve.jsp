...
{          
   ...
   if (document.MYFORM.ACTION.value=="008") //如果action是close,則必須檢查remark欄位是否有輸入資料
   {	  
		 if (document.MYFORM.elements["REASON-"+document.MYFORM.CH.value].value=="" || document.MYFORM.elements["REASON-"+document.MYFORM.CH.value].value==null)
		 { 
...
<strong>產品問題追蹤(<%=ticketNo%>)-對策改善</strong></font>
&nbsp;&nbsp;&nbsp;&nbsp;
...
<table width="100%" border="0">
	...
	<table width="100%" border="1">
      ...
      {     	         
       ...
       %></td>
        <td width="77%"><INPUT TYPE="button"  value="<-Submit" onClick='setSubmit2("WSPIT_Process.jsp")' ></td>
      </tr>
    </table>
	<HR>
	...
	<TR bgcolor="#CCFFFF">
	  ...
	  <TD><font size="2">
	    <textarea name="REASON-<%=ticketNo%>"  cols="30" rows="4" ></textarea>
	  </font></TD>
	  <TD><font size="2"><textarea name="CORRECTACTION-<%=ticketNo%>" cols="30" rows="4" ></textarea></font></TD>
	  </TR> 
  </TABLE>
 <!-- 表單參數 -->  
