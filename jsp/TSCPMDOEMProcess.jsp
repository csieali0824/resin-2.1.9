...
<%@ page contentType="text/html; charset=big5"  language="java" import="java.sql.*,java.util.*,java.text.*" %>
<!--=============以下區段為安全認證機制==========-->
		...
		if (ACTIONID.equals("001") || ACTIONID.equals("002"))
		{
			if (WIPTYPE.equals("01") || WIPTYPE.equals("02"))
			{
				...
				else if (WIPTYPE.equals("02")) //工程
				{
					...
					{
						if (PRICEUOM.toLowerCase().equals("ea") && !SUPPLIERNO.equals("3292") && !SUPPLIERNO.equals("3867") && !SUPPLIERNO.equals("2012") && !SUPPLIERNO.equals("3915") && !SUPPLIERNO.equals("3212")  && !SUPPLIERNO.equals("4682")) {
