...
<BR>
  ...
  <table cellSpacing='0' cellPadding='1' width='100%' align='center' borderColorLight="#CFDAD8"  bordercolordark="#5C7671" border='1'>
     <tr>
		<td width="10%" bgcolor="#D3E6F3"  style="font-size:12px;font-weight:bold;color:#006666;"><span style="font-size:12px;color:#006666">產品類別名稱</span> :</td>   
		<td width="15%"><INPUT TYPE="TEXT" NAME="PROD_TYPE_NAME" VALUE="<%=PROD_TYPE_NAME%>" 	 style="font-family: Tahoma,Georgia;"></td> 
