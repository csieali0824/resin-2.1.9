<%@ page contentType="text/html; charset=big5" language="java" import="java.sql.*,java.util.*,java.text.*,javax.mail.*,javax.mail.internet.*,javax.mail.Multipart.*,javax.activation.*,jxl.*,jxl.Workbook.*,jxl.write.*,jxl.format.*,java.io.*" %>
		...
		else
		{
			...
			if (rej_chk_cnt>0)
			{
				sql = " INSERT INTO oraddman.tssg_stock_overview"+
					  " SELECT TSSG_STOCK_ID_S.NEXTVAL,X.*, null "+
					  ...
					  "      ,0 LOCATOR_ID"+  //add by JB 20250702 TSCC
					  "      ,'' F_INVOICE_NO"+  //add by JB 20250702 TSCC
					  "      ,'' ORIG_INVOICE_NO"+  //add by JB 20250702 TSCC
					  "      ,'S' STOCK_FLAG"+  //add by JB 20250702 TSCC
					  "      ,0 RMA_QTY"+  //add by JB 20250702 TSCC
					  "      ,0 SCRAP_QTY"+  //add by JB 20250702 TSCC
		...
		else
		{
			...
			for(int i=0; i< chk.length ;i++)
			{
				...
				sql = " INSERT INTO  oraddman.tssg_stock_overview"+
                      ...
                      ",receipt_num"+
					  ",DC_YYWW"+
					  ",LOCATOR_ID"+  //add by JB 20250702 TSCC
					  ",F_INVOICE_NO"+  //add by JB 20250702 TSCC
					  ",ORIG_INVOICE_NO"+  //add by JB 20250702 TSCC
					  ",STOCK_FLAG"+  //add by JB 20250702 TSCC
					  ",RMA_QTY"+  //add by JB 20250702 TSCC
					  ",SCRAP_QTY"+  //add by JB 20250702 TSCC
					  ",HOLD_FLAG"+
                      " )"+
                      ...
                      ",NULL"+
					  ",DC_YYWW"+ //add by Peggy 20220721
                      ",0"+  //add by JB 20250702 TSCC
                      ",NULL"+  //add by JB 20250702 TSCC
                      ",NULL"+  //add by JB 20250702 TSCC
                      ",'S'"+  //add by JB 20250702 TSCC
					  ",0"+  //add by JB 20250702 TSCC
					  ",0"+  //add by JB 20250702 TSCC
					  ",NULL"+
