...
<html>
<head>
<title>IssueInputPage.jsp</title>
<!--=============以下區段為安全認證機制==========-->
...
<body>
<FORM ACTION="/wins/jsp/INVIssInsert.jsp" METHOD="post" NAME="MYFORM" onSubmit="return submitCheck()">
  <A HREF="/wins/WinsMainMenu.jsp">回首頁</A> &nbsp;&nbsp  
  <BR>
  <font color="#0080FF" size="5"><strong>領料單新增
  <% 
  ...
  <table width="96%" border="1">
	...
	<tr>	  
	  <td width="34%"> 異動類型:I-領料</td>
	  <td width="38%"> 事由:
      <INPUT TYPE="TEXT" NAME="REMARK" SIZE=30 maxlength="30"></td>
      <td colspan="3"><input name="button3" type=button onClick="buttonContent()" value="料號:"> </td>  
	</tr>
  </table>  
  <p>
    ...
    <%
      ...
      {       
       ...
       ResultSet rs=statement.executeQuery("select distinct x1.ACTIONID,x2.ACTIONNAME from WSWORKFLOW x1,WSWFACTION x2 WHERE FORMID='RD'AND TYPENO='001' AND FROMSTATUSID='006' AND x1.ACTIONID=x2.ACTIONID");
...
%>
  ...
  <p> 
    <INPUT TYPE="button" value='執行' onClick='submitCheck("../jsp/INVIssInsert.jsp",<%=div1%>,<%=div2%>)'>
  </p>
  <p>
  <!-- 表單參數 -->  
    <input name="FORMID" type="HIDDEN" value="RD">	
    <input name="FROMSTATUSID" type="HIDDEN" value="006">
  </p>
</FORM>
<!--=============以下區段為釋放連結池==========-->
