...
<body>
  <% 
		...
		//out.println("MODELNO"+sModelNo);
		if ( sModelNo==null )  { sModelNo = ""; out.println("未傳入MODELNO");}
	%>
<FORM NAME="MYFORM" ACTION="../jsp/DMQCCheckListFileUploadInsert.jsp?MODELNO=<%=sModelNo%>" METHOD="post" ENCTYPE="multipart/form-data">
	<input name="MODELNO" type="HIDDEN" value="<%= sModelNo %>" > 
  <input type="hidden" name="AS" value="OK" >
  <p><A HREF='../WinsMainMenu.jsp'>HOME</A> <strong><font color="#004080" size="4"> 
    開發問題總覽 File Upload</font></strong> </p>
