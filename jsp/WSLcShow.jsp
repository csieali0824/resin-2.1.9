<%@ page contentType="text/html; charset=utf-8" language="java" import="java.sql.*,bean.RsBean,bean.ComboBoxBean" %>
...
<%
  ...
  String monthto=request.getParameter("MONTHTO");  
  String dayto=request.getParameter("DAYTO");  
  String titemno=request.getParameter("TITEMNO");
  String datefr=yearfr+monthfr+dayfr;
  String dateto=yearto+monthto+dayto;
  
  if (yearfr==null || yearfr.equals("") || monthfr==null || dayfr==null ) { datefr = dateBean.getYearMonthDay();  }
  if (yearto==null || yearto.equals("") || monthto==null || dayto==null ) { dateto = dateBean.getYearMonthDay();  }
  
  
  /*out.print(repcenterno+"<br>");  
  out.print(userid+"<br>");
  out.print(continent+"<br>");
  out.print(locale+"<br>");
  out.print(datefr+"<br>");
  out.print(dateto+"<br>");
  out.print(titemno+"<br>");*/
  
 
  int numRow = 0;  
%>

  <FORM ACTION="../jsp/WSLcShow.jsp" METHOD="post" NAME="MYFORM">  
<table width="100%">
     <tr bgcolor="#D0FFFF"> 	
      <td width="55%" valign="top" bordercolor="#CCCCCC" bgcolor="#CCEEFF"> 
      ...
      <td width="13%" align="center" bgcolor="#D0FFFF"> <a href="../jsp/CreateLC.jsp">Create</a></td> 
      <td width="14%" align="center"  bgcolor="#D0FFFF"><a href="../jsp/EditLC.jsp">Revise</a> </td> 
	  <td width="14%" align="center"  bgcolor="#D0FFFF"><a href="../jsp/LCDelete.jsp">Delete</a> </td> 
	      	     
	   <td width="7%" bgcolor="#D0FFFF">
  ...
  <tr bgcolor="#CCFFFF"> 
    <td width="11%"><font size="2"><strong>LCNO</strong></font></td>
	<td width="12%"><font size="2"><strong>LCCUR</strong></font></td>
	<td width="14%"><font size="2"><strong>LCAMT</strong></font></td>
	<td width="11%"><font size="2"><strong>LCEFF</strong></font></td>
    <td width="11%"><font size="2"><strong>LCDIS</strong></font></td>
    <td width="16%" nowrap><font size="2"><strong>LCUSAGE</strong></font></td>
    <td width="11%"><font size="2"><strong>LCENUS</strong></font></td>
    <td colspan="2"><font size="2"><strong>LCENDT</strong></font><font size="2">&nbsp;</font><font size="2">&nbsp;</font></td>
  </tr>
  <% //  *** Main Loop  Start   *** //
...
String sql = "select LCNO,LCCUR,LCAMT,LCEFF,LCDIS,LCUSAGE,LCENUS,LCENDT from HLCM ";
String sWhere = "Where ";
			
			//////////////////////////////////////////////////////
			//String swhere = "where t.TOPICTYPE= p.TOPICTYPE ";                          			  
									   
			//String sWhere = "and t.TOPICID >= '0' ";    
								  
		    
			if ((!(dayfr=="--")&&(dayfr=="00")) && dayto=="--") sWhere=sWhere+" LCENDT >="+"'"+datefr+"' ";
            if (dayfr!="--" && dayfr!="--") sWhere=sWhere+" LCENDT between "+"'"+datefr+"'"+" and "+"'"+dateto+"' ";
            		  
		    String sOrder = "order by LCNO ";
  ...
  <%
   ...
   %>
  <tr bgcolor="<%=colorStr%>"> 
    <td nowrap><font color="#993366" size="2"><strong><%=rs.getString("LCNO")%></strong></font></td>
	<td nowrap><font color="#993366" size="2"><strong><%=rs.getString("LCCUR")%></strong></font></td>
    <td nowrap><font color="#993366" size="2"><strong><%=rs.getString("LCAMT")%></strong></font></td>
	<td nowrap><font color="#993366" size="2"><strong><%=rs.getString("LCEFF")%></strong></font></td>
    <td nowrap><font color="#993366" size="2"><strong><%=rs.getString("LCDIS")%></strong></font></td>
    <td nowrap><font color="#993366" size="2"><strong><%=rs.getString("LCUSAGE")%></strong></font></td>
    <td><font color="#993366" size="2"><strong><%=rs.getString("LCENUS")%></strong></font></td>
    <td width="14%" nowrap>
<div align="left"><font color="#993366" size="2"><strong><%=rs.getString("LCENDT")%></strong></font></div></td>
  </tr>
  <tr> 
