...
function WIPOperationPartNoQuery(marketType,acctPeriodID,partNo,operCode)
{     
    subWin=window.open("../jsp/TSMfgWIPOperationDetailQuery.jsp?ORGANIZATION_ID="+marketType+"&ACCT_PERIOD="+acctPeriodID+"&PART_NO="+partNo+"&OPERATION_CODE="+operCode,"subwin","width=600,height=480,scrollbars=yes,menubar=no");    	
}
</script>
<html>
<head>
...
<strong><a>生產月報統計表-站別良率</a></strong></font>
<BR>
...
if ( dateSetBegin==null || dateSetBegin.equals("") )
{
  ...
  {   // out.println("workingDateBean.getWeek()="+workingDateBean.getWeek());
     ...
     sSql = " select DISTINCT YWW.OPERATION_CODE, WOP.DESCRIPTION, YWW.ACCT_PERIOD_ID from YEW_WIP_WIPIO YWW, ORG_ACCT_PERIODS OAP, WIP_OPERATIONS WOP ";	

   sSqlCNT = " select count(DISTINCT YWW.OPERATION_CODE) CaseCount from YEW_WIP_WIPIO YWW, ORG_ACCT_PERIODS OAP, WIP_OPERATIONS WOP  ";
   ...
   sWhere =  "  where YWW.ORGANIZATION_ID = OAP.ORGANIZATION_ID and YWW.ACCT_PERIOD_ID = OAP.ACCT_PERIOD_ID "+
             ...
             " and YWW.ORGANIZATION_ID = "+marketType+" and to_char(OAP.PERIOD_START_DATE,'YYYYMM')= '"+dateBean.getYearString()+dateBean.getMonthString()+"' ";
			 
   sWhereSDRQ = " ";
   havingGrp = " ";               
   havingGrpSDRQ = "  ";
   sOrder = "   order by YWW.OPERATION_CODE  ";
...
{ 
  ...
  {   
   ...
   sSqlCNT = " select count(DISTINCT YWW.OPERATION_CODE) CaseCount from YEW_WIP_WIPIO YWW, ORG_ACCT_PERIODS OAP, WIP_OPERATIONS WOP  ";
     ...
     String sqlOrgCnt = " select count(DISTINCT YWW.OPERATION_CODE) CaseCount from YEW_WIP_WIPIO YWW, ORG_ACCT_PERIODS OAP, WIP_OPERATIONS WOP ";
...
<table cellspacing="0" bordercolordark="#6699CC" cellpadding="1" width="100%" align="center" bordercolorlight="#ffffff" border="1">	
	...
	<td width="31%" colspan="2">
		    <INPUT TYPE="button" align="middle"  value='查詢' onClick='setSubmit("../jsp/TSCMfgWIPOperationYieldRpt.jsp")' > 			
			<input type="reset" name="RESET" align="middle"  value='重置' onClick='setSubmit2("../jsp/TSCMfgWIPOperationYieldEntry.jsp")' >
			<INPUT TYPE="button" align="middle" value='EXCEL' onClick='setSubmit("../jsp/TSCMfgWIPOperationYield2Excel.jsp")'>	</td>
   </tr>
  </table>  
<%  
...
<table cellspacing="0" bordercolordark="#6699CC" cellpadding="1" width="100%" align="center" bordercolorlight="#ffffff" border="1">
    ...
    %>
  <tr>    
   <td><strong><div align="center">陽信長威電子有限公司</div></strong></td>
  </tr>	
  <tr>    
   <td><div align="center">生產月報統計表--站別良率(<%=orgCode%>)</div></td>
  </tr>
  <tr>    
   <td><div align="center">站別:<%=rsTC.getString("OPERATION_CODE")+"("+rsTC.getString("DESCRIPTION")+")"%></div></td>
  </tr>
 <tr><td>
<table cellspacing="0" bordercolordark="#6699CC" cellpadding="1" width="100%" align="center" bordercolorlight="#ffffff" border="1">
    <tr bgcolor="#BBD3E1"> 	  
	  <td width="12%" height="22" nowrap><div align="center"><font color="#006666" face="Arial">成本代號</font></div></td>               
	  <td width="9%" nowrap><div align="center"><font color="#006666" face="Arial">站別</font></div></td>
      <td width="9%" nowrap><div align="center"><font color="#006666" face="Arial">期初數</font></div></td>           
      <td width="9%" nowrap><div align="center"><font color="#006666" face="Arial">接收數</font></div></td> 	
	  <td width="8%" nowrap><div align="center"><font color="#006666" face="Arial">處理數</font></div></td>   
	  <td width="10%" nowrap><div align="center"><font color="#006666" face="Arial">產出數</font></div></td>
	  <td width="9%" nowrap><div align="center"><font color="#006666" face="Arial">耗損數</font></div></td>
	  <td width="9%" nowrap><div align="center"><font color="#006666" face="Arial">期末數</font></div></td>	 
	  <td width="9%" nowrap><div align="center"><font color="#006666" face="Arial">工時</font></div></td>  	   
	  <td width="9%" nowrap><div align="center"><font color="#006666" face="Arial">良品率</font></div></td>
	  <td width="7%" nowrap><div align="center"><font color="#006666" face="Arial">PPH</font></div></td> 
	  <td width="7%" nowrap><div align="center"><font color="#006666" face="Arial">UPH</font></div></td>  	  	  
    </tr>	
	 <%
	     int opCount = 0;
	     ...
	     // 依各個成本代號,找對應結轉各項數據_起
			       ...
			       String whereFront = " where YWW.OPERATION_CODE = '"+rsTC.getString("OPERATION_CODE")+"' and YWW.ORGANIZATION_ID = "+marketType+" and YWW.ACCT_PERIOD_ID = "+rsTC.getString("ACCT_PERIOD_ID")+"  "+
				                       "   and YWW.WIP_ENTITY_ID = WOP.WIP_ENTITY_ID and YWW.OPERATION_SEQ_NUM = WOP.OPERATION_SEQ_NUM "+
		 ...
		 {  
		  ...
		  { // 判斷若各個欄位不為零,才顯示
		      ...
		      /*
			       ...
			       String sqlDTL = " select YWA.WO_NO,    "+
			       ...
			       String whereDTL = " where YWW.WIP_ENTITY_ID = YWA.WIP_ENTITY_ID and YWW.PART_NO = '"+rsFront.getString("PART_NO")+"' "+
				                     "   and YWW.OPERATION_CODE = '"+rsFront.getString("OPERATION_CODE")+"' and YWW.ORGANIZATION_ID = "+marketType+" and YWW.ACCT_PERIOD_ID = "+rsTC.getString("ACCT_PERIOD_ID")+"  "+
				                     "   and YWW.DEPT_NO in ('1','2','3') "; //  確保由生產系統(不含一月份舊系統麗玲手開工令)	  	
				   String groupDTL = " group by YWA.WO_NO ";						  
				   String orderDTL = " order by YWA.WO_NO "; 				   
				   sqlDTL = sqlDTL + whereDTL + groupDTL + orderDTL;
				   //out.println("sqlDTL="+sqlDTL);
				   ...
				   detailLot = "";
				   ResultSet rsDTL=stateDTL.executeQuery(sqlDTL);	
				   while (rsDTL.next())
				   {
				      detailLot = detailLot +"<tr><td>"+rsDTL.getString("WO_NO")+"</td><td><div align=right>"+rsDTL.getString("QUANTITY_BEGIN_BALANCE")+"</div></td><td><div align=right>"+rsDTL.getString("QUANTITY_RECEIVED")+"</div></td><td><div align=right>"+rsDTL.getString("QUANTITY_PROCESSED")+"</div></td><td><div align=right>"+rsDTL.getString("QUANTITY_COMPLETED")+"</div></td><td><div align=right>"+rsDTL.getString("QUANTITY_SCRAPPED")+"</div></td><td><div align=right>"+rsDTL.getString("QUANTITY_END_BALANCE")+"</div></td></tr>";  // 組合前段予後段領用的批號
					  //out.println("1");
				   }
				   rsDTL.close();
				   stateDTL.close();
				   ...
				   //out.println(detailHdr);
		     */
	  %>     
    <tr bgcolor="<%=colorStr%>" >  	  
	  <!--% <td><div align="center"><font color="#FFFFFF" face="Arial"><a onmouseover='this.T_STICKY=true;this.T_WIDTH=400;this.T_CLICKCLOSE=false;this.T_BGCOLOR="#CCFF66";this.T_SHADOWCOLOR="#FFFF99";this.T_TITLE="工令&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;期初&nbsp;&nbsp;&nbsp;&nbsp;接收&nbsp;&nbsp;&nbsp;&nbsp;處理&nbsp;&nbsp;&nbsp;&nbsp;產出&nbsp;&nbsp;&nbsp;&nbsp;耗損&nbsp;&nbsp;&nbsp;&nbsp;期末&nbsp;&nbsp;&nbsp;&nbsp;";this.T_OFFSETY=-32;return escape("<!--%=detailHdr%>")'><font color='#990000'><!--%=rsFront.getString("PART_NO")%></font></a></font></div></td> %-->
	  <td><div align="center"><font color="#FFFFFF" face="Arial"><a href='javaScript:WIPOperationPartNoQuery("<%=marketType%>","<%=rsTC.getString("ACCT_PERIOD_ID")%>","<%=rsFront.getString("PART_NO")%>","<%=rsTC.getString("OPERATION_CODE")%>")'><%=rsFront.getString("PART_NO")%></a></font></div></td>
	  <td nowrap><div align="center"><font color="#006666" face="Arial"><%=rsFront.getString("OPERATION_CODE")+"("+rsFront.getString("DESCRIPTION")+")"%></font></div></td>
	 ...
	 <td nowrap><div align="right"><font color="#006666" face="Arial">
	           <%
				 ...
				 /*
			      ...
			      try
		          { 		           
			         String qtyReceiveStr = nf.format(rsFront.getFloat("QUANTITY_RECEIVED"));
				     bd = new java.math.BigDecimal(qtyReceiveStr);
				     java.math.BigDecimal qtyReceiveStrQty = bd.setScale(3, java.math.BigDecimal.ROUND_HALF_UP);
				     qtyReceive = qtyReceiveStrQty.floatValue();
		          } //end of try
                  catch (NumberFormatException e)
                  {
                   out.println("Exception: Qty Receive"+e.getMessage());
                  }
				  */
	  ...
	  <td nowrap><div align="right"><font color="#006666" face="Arial">
	           <%
			     /*
			      ...
			      try
		          { 		           
			         String qtyProcessStr = nf.format(rsFront.getFloat("QUANTITY_PROCESSED"));
				     bd = new java.math.BigDecimal(qtyProcessStr);
				     java.math.BigDecimal qtyProcessStrQty = bd.setScale(3, java.math.BigDecimal.ROUND_HALF_UP);
				     qtyProcess = qtyProcessStrQty.floatValue();
		          } //end of try
                  catch (NumberFormatException e)
                  {
                   out.println("Exception: Qty Process"+e.getMessage());
                  }
				 */
				 out.println(rsFront.getFloat("QUANTITY_PROCESSED"));
	  ...
	  <td ><div align="right"><font color="#006666" face="Arial">
	           <%
			     /*
			      ...
			      try
		          { 		           
			         String qtyCompleteStr = nf.format(rsFront.getFloat("QUANTITY_COMPLETED"));
				     bd = new java.math.BigDecimal(qtyCompleteStr);
				     java.math.BigDecimal qtyCompleteStrQty = bd.setScale(3, java.math.BigDecimal.ROUND_HALF_UP);
				     qtyComplete = qtyCompleteStrQty.floatValue();
		          } //end of try
                  catch (NumberFormatException e)
                  {
                   out.println("Exception: Qty Complete"+e.getMessage());
                  }
				  */
	  ...
	  <td ><div align="right"><font color="#006666" face="Arial">
	           <% 
			     /*
			      ...
			      try
		          { 		           
			         String qtyScrapStr = nf.format(rsFront.getFloat("QUANTITY_SCRAPPED"));
				     bd = new java.math.BigDecimal(qtyScrapStr);
				     java.math.BigDecimal qtyScrapStrQty = bd.setScale(3, java.math.BigDecimal.ROUND_HALF_UP);
				     qtyScrap = qtyScrapStrQty.floatValue();
		          } //end of try
                  catch (NumberFormatException e)
                  {
                   out.println("Exception: Qty Scrap"+e.getMessage());
                  } 
				  */
			      out.println(rsFront.getFloat("QUANTITY_SCRAPPED")); 
				  frontScrapTotal=frontScrapTotal+rsFront.getFloat("QUANTITY_SCRAPPED");
			   %></font></div></td>	  
	  <td nowrap><div align="right"><font color="#006666" face="Arial">
	           <% 
			      /*
			      float qtyEndBalance = 0;
			      try
		          { 		           
			         String qtyEndBalStr = nf.format(rsFront.getFloat("QUANTITY_END_BALANCE"));
				     bd = new java.math.BigDecimal(qtyEndBalStr);
				     java.math.BigDecimal qtyEndBalStrQty = bd.setScale(3, java.math.BigDecimal.ROUND_HALF_UP);
				     qtyEndBalance = qtyEndBalStrQty.floatValue();
		          } //end of try
                  catch (NumberFormatException e)
                  {
                   out.println("Exception: Qty End Balance"+e.getMessage());
                  } 
				  */
			      out.println(rsFront.getFloat("QUANTITY_END_BALANCE")); 
	  ...
	  <td ><div align="right"><font color="#006666" face="Arial">
	           <% 
			      ...
			      try
		          { 		           
			         String qtyWorkTimeStr = nf.format(rsFront.getFloat("WORK_TIME"));
				     bd = new java.math.BigDecimal(qtyWorkTimeStr);
				     java.math.BigDecimal qtyWorkTimeStrQty = bd.setScale(3, java.math.BigDecimal.ROUND_HALF_UP);
				     qtyWorkTime = qtyWorkTimeStrQty.floatValue();
		          } //end of try
                  catch (NumberFormatException e)
                  {
                   out.println("Exception: Work Time"+e.getMessage());
                  } 
				  */
			      out.println(rsFront.getFloat("WORK_TIME")); 
	  ...
	  <td ><div align="right"><font color="#006666" face="Arial">
	           <% 
		         ...
		         // frontLPLRate=rsFront.getFloat("QUANTITY_COMPLETED")/(rsFront.getFloat("QUANTITY_BEGIN_BALANCE")+rsFront.getFloat("QUANTITY_RECEIVED")-rsFront.getFloat("QUANTITY_END_BALANCE"))*100;  //公式:產出/(期初+接收-期末)=良率
				  frontLPLRate=(rsFront.getFloat("QUANTITY_COMPLETED")/rsFront.getFloat("QUANTITY_PROCESSED"))*100;  //公式:產出/(處理)=良率   2007/04/11 liling修改
                  //out.println("frontLPLRate="+frontLPLRate);
				   
				  // out.println(miscellaneousBean.getFloatRoundStr(tstFloat));
				  ...
				  //if (YieldRate>100)  out.println("100.00%");
				  //else out.println(YieldRate+"%");
			   %></font></div></td>
      <td ><div align="right"><font color="#006666" face="Arial">
	           <% 
		          ...
		          frontPPH=(rsFront.getFloat("QUANTITY_COMPLETED")/rsFront.getFloat("WORK_TIME"));
				   ...
				   //out.println(miscellaneousBean.getFloatRoundStr(frontPPH));
	 ...
	 <td ><div align="right"><font color="#006666" face="Arial">
	           <% 
				  ...
				  out.println(uphValue);
			   %></font></div></td>   	    
    </tr> 
	 <%
	      } // End of if () // 判斷若各個欄位不為零,才顯示
	   } // End of while
	   rsFront.close();
	   stateFront.close();		 
    ...
    <tr><!--% 前段的加總 %--> 
	  ...
	  <td nowrap><div align="right"><font color="#006666" face="Arial">
	          <%//=frontFirstOpRec			      
                 out.println(miscellaneousBean.getFloatRoundStr(frontReceiptTotal));
			  %></font></div></td>
	  <td nowrap><div align="right"><font color="#006666" face="Arial">
	          <%//=frontFirstOpRec			      
                 out.println(miscellaneousBean.getFloatRoundStr(frontProcessTotal));
			  %></font></div></td>
	  <td ><div align="right"><font color="#006666" face="Arial">
	          <%//=frontOSPComplete
			     out.println(miscellaneousBean.getFloatRoundStr(frontCompleteTotal));
			  %></font></div></td>
	  <td ><div align="right"><font color="#006666" face="Arial">
	          <%//=frontQtyScrapTotal
			     out.println(miscellaneousBean.getFloatRoundStr(frontScrapTotal));
			  %></font></div></td>	  
	  <td nowrap><div align="right"><font color="#006666" face="Arial">
	          <%//=frontEndBalTotal
	  ...
	  <td ><div align="right"><font color="#006666" face="Arial">
	          <%//=frontLPLRate
				  ...
				  if (YieldRateTotal>100)  out.println("100.00%");
				  else out.println(YieldRateTotal+"%");
			      //out.println(miscellaneousBean.getFloatRoundStr(LPLRateTotal)+"%");
			  %></font></div></td>
      <td ><div align="right"><font color="#006666" face="Arial">
	          <%//=frontPPHRate
			     // 計算前段的產出率
		       //   PPHTotal=(frontCompleteTotal/frontWorkTimeTotal)*100;		
                  PPHTotal=(frontCompleteTotal/frontWorkTimeTotal);		    // pph= 總產出/總工時   2007/04/11   liling update
			      out.println(miscellaneousBean.getFloatRoundStr(PPHTotal));
			  %></font></div></td> 
	  <td ><div align="right"><font color="#006666" face="Arial">
	          <%//=frontPPHRate
			     // 計算前段的產出率
		       //   PPHTotal=(frontCompleteTotal/frontWorkTimeTotal)*100;		
			      ...
			      out.println(miscellaneousBean.getFloatRoundStr(UPHTotal));
			  %></font></div></td>     
     </tr>	
  </table><!--% 站別的Group %--> 
  <BR> 
