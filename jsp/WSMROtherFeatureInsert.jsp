...
{  
	   ...
	   //{
		 ...
		 //String c_in_array=request.getParameter("MONTH"+ac+"-"+subac);//取前一頁之輸入欄位
          // sql="insert into PSALES_FORE_COST(FCCOMP,FCYEAR,FCMONTH,FCREG,FCCOUN,FCTYPE,FCPRJCD,FCCOST,FCMVER,FCLUSER,FCCURR) values(?,?,?,?,?,?,?,?,?,?,?)";
           sql="insert into MROTH_FEATURE(FTURE_CODE,FEATURE,NOTE) values(?,?,?)";
  ...
  out.println("輸入產品其他特徵代碼新增成功 !!!<BR>");
  out.println("<A HREF=/wins/WinsMainMenu.jsp>首頁</A>&nbsp;&nbsp;<A HREF=../jsp/WSMROtherFeatureInput.jsp?ENTRY=TRUE>產品其他特徵代碼資料新增</A>&nbsp;&nbsp;<A HREF='../jsp/WSMROtherFeatureInquiry.jsp'>產品其他特徵代碼資料查詢</A> ");
