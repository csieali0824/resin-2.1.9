	...
	{	
		...
		{	
			...
			if (UserRoles.indexOf("admin")<0)
			{
				sql += " and exists (select 1 from (SELECT tog.group_name "+
						 ...
						 " tsc_om_group tog,"+
						 " oraddman.wsuser ow"+
						 " WHERE  (aea.employee_no = jrs.salesrep_number or us.user_name =jrs.salesrep_number)"+
		...
		else if (i==2)
		{
			sql = " SELECT upper(Tsc_Intercompany_Pkg.get_sales_group(ooa.header_id)) sales_group,"+  
				  ...
				  "       AND ooh.order_number in ('11420042489','11420042504')"+ 
