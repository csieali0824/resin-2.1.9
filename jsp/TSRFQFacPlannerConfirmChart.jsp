...
<%
   ...
   //   ostream.close();
      ...
      org.jfree.chart.urls.TimeSeriesURLGenerator urlgPC = new org.jfree.chart.urls.TimeSeriesURLGenerator(sdfPC, "jsp/TSRFQFacPlannerConfirmIMap.jsp?FAC="+factory, "TRENDMODE","DATETIME");
...
%>
<table></table>
<img border="0" src="jsp/TSRFQFacPlannerConfirmIMap.jsp" useMap="#<%=filenamePC%>">
</body>
</html>
<!--=============Release==========-->
