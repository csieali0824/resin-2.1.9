...
<body>
<FORM ACTION="../jsp/INVItemQuery.jsp" METHOD="post" NAME="MYFORM" >
  ...
  <table width="100%" border="0">
    <tr> 
      <td align="center"><strong><font color="#0000FF" size="+2" face="Arial">Item</font><font color="#0000FF" size="+2" face="Arial"> Query&nbsp;
            <%
          int rs1__numRows = 15;
          int rs1__index = 0;
          int rs_numRows = 0;
        ...
        <% 
		  ...
		  //String uom=request.getParameter("LOC");	
  ...
  <table width="100%" border="0" bordercolor="#CCFFFF" >
    <tr bgcolor="#66CCFF"> 
	  ...
	  <td width="28%"><font color="#000000" face="Arial Black"><strong>Item:
	    <input type="text" name="ITEM"  size="15" maxlength="15">
      </strong></font>        
      </td>
	  <td width="51%"><font color="#000000" face="Arial Black"><strong>Description:
	        <input type="text" name="DESC"  size="50" maxlength="50">
      </strong></font>      </td>	  
      <td width="21%"><input name="Search"  type="submit" value="Query" onClick='return Submit("../jsp/INVItemQuery.jsp")'></td>	  
    </tr>
  ...
  <table width="100%" border="1" cellspacing="0">
    <tr bordercolor="#000000" bgcolor="#CCFFFF" >
      <td width="7%"><div align="center"><font size="2"><font face="新細明體">Item </font></font></div></td>
      <td width="7%"><div align="center"><font size="2" face="新細明體">Descrtiption</font></div></td>
      <td width="11%"><div align="center"><font size="2" face="新細明體">Item UOM </font></div></td>
    </tr>
    <%   
	   //if (Query == "Y")
	   //{ 		
	     try
          {   
	       ...
	       sqlM = "select ITEMNO, ITEMDESC, ITEMUOM from INV_ITEM ";
		   sWhere = " ";
		   if ((item==null || item.equals("")) & (desc==null || desc.equals("")))
		   {}
		   else if (item!=null & (desc==null || desc.equals("")))
		   {sWhere = sWhere + " Where ITEMNO like '%"+item+"%' ";}
		   else if ((item==null || item.equals("")) & desc!=null)		
		   {sWhere = sWhere + " Where ITEMDESC like '%"+desc+"%' ";}		
		   else
		   {sWhere = sWhere + " Where ITEMNO like '%"+item+"%' And ITEMDESC like '%"+desc+"%' ";}			   		   		   	   
		   sWhere = sWhere + "ORDER BY ITEMNO,ITEMDESC";	      		         
		   sqlM = sqlM+sWhere;
		   //out.println(sqlM);
...
// 加入分頁 - 迄 /		
    ...
    <tr bgcolor="<%=colorStr%>">
      <td width="15%" nowrap><font color="#993366" size="2"><strong>
        <%
             if (rsM.getString("ITEMNO") !=null && !rsM.getString("ITEMNO").equals(" ")) { out.println(rsM.getString("ITEMNO") ); } 
             else { out.println("&nbsp;"); }
         %>
      </strong></font></td>
      <td nowrap><font color="#993366" size="2"><strong><%=rsM.getString("ITEMDESC")%></strong></font></td>
      <td nowrap><font color="#993366" size="2"><strong><%=rsM.getString("ITEMUOM")%></strong></font></td>
    </tr>
    <tr>
