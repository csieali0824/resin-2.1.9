...
<title>Monthly Cost of Forecast Input Form</title>
</head>
<body>
...
<strong> Cost of Forecast Input (Detail)</strong></font> 
     ...
     <% 				 		 
      ...
      <td width="24%"><font size="2"> <font color="#333399" face="Arial Black"><strong>Country: 
       ...
       %> 
        ...
        <INPUT TYPE="button"  value="Add" onClick='setSubmit("../jsp/WSForecastCostInput.jsp")' >
	  </font></td>     
  </tr>
</table>
<table width="100%" border="1" cellspacing="0" cellpadding="0">
  ...
  <tr>  
    <td colspan="14"><a href='javaScript:setSubmit("../jsp/WSForecastCostInput.jsp?BRINGLAST=Y")'>Last version of this model</a><BR><HR SIZE=2></td>
    </tr>
  <tr bgcolor="#FFCC33">
...
<% 
     int div1=0,div2=0;      //做為運算共有多少個row和column輸入欄位的變數
      ...
      {	
       ...
       %>
<BR>
<INPUT name="button2" TYPE="button" onClick='setSubmit("../jsp/WSForecastCostInput.jsp")'  value="DELETE" >
------------------------------------------------------------------------------------------------------------
<INPUT TYPE="button"  value="SAVE" onClick='setSubmit2("../jsp/WSForecastCostInsert.jsp",<%=div1%>,<%=div2%>)' >
---------------------
<!-- 表單參數 -->  
