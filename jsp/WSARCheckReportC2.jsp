...
<body>
<FORM ACTION="WSARCheckReportC2.jsp" METHOD="post" NAME="MYFORM">
  <div align="left">
 ...
 %>
  ...
  <table width="100%" border="0">
    <tr> 
      ...
      <td width="28%" bgcolor="#006699"><input name="button" type="button" onClick='setSubmit("../jsp/WSARCheckReportC2.jsp")'  value="Query" > 
