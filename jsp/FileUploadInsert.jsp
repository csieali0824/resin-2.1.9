...
{	               	 	        
  ...
  {  	    
	...
	{	 
	 ...
	 if (s!=null && !s.equals("")) 
	 {
	   String sql="insert into PSALES_AGENT_GMIDX(INT_MODEL,REGION,COUNTRY,GM_INDEX,CDATE,CUSER) values(?,?,?,?,?,?)";
	  ...
	  pstmt.setString(6,"B01732"); //WRITE THE LAST COLUMN THAT IS the man who upload this file 	  
	  pstmt.executeUpdate();
	  pstmt.close();  
	 } 
