	...
	if (MultipartFormDataRequest.isMultipartFormData(request))  
	{
		...
		if ( (todo != null) && (todo.equalsIgnoreCase("upload")) )  
		{
			...
			if ( (files != null) || (!files.isEmpty()) )  
			{
				...
				session.setAttribute("PROCESSAREA","002(�b����~�ȳ�-����B�D���Τj���a��)");
				...
				String sqla = " select a.SITE_USE_CODE, a.PRIMARY_FLAG, a.SITE_USE_ID, loc.COUNTRY, loc.ADDRESS1,"+       
							 ...
							 " order by decode(a.SITE_USE_CODE,'SHIP_TO',1,2)"; //add by Peggy 20170322
						...
						try 
						{
							...
							{	   
								...
								if (BufferPartNumber[1][i].trim() !=null && BufferPartNumber[1][i].trim() !=null && BufferPartDescNew[1][i].trim() !=null && BufferPartDescNew[1][i].trim() !=null)
								{
									...
									b[j][11]="0";
									b[j][12]="0";
									b[j][13]=itemFactory;   //�Ͳ��t�O add by Peggy 20120303
									b[j][14]=""+BufferPartDesc[1][i];    //�Ȥ�Ƹ� add by Peggy 20120303
									b[j][15]=""+BufferUnitPrice[6][i];  //��� add by Peggy 20120303
									b[j][16]=orderType;      //�q������ add by Peggy 20120303
									...
									b[j][24]="&nbsp;";       //END CUSTOMER,add by Peggy 20140922
									b[j][25]="&nbsp;";       //ORIG SO LINE ID,add by Peggy 20150519
									b[j][26]="&nbsp;";       //direct ship to cust,add by Peggy 20160313
							...
							if(!CheckNext.equals("Y"))
							{
								...
								b[j][19]=CustPOLineNo;   //CUST PO LINE NO,add by Peggy 20120716	
								b[j][20]="&nbsp;";       //QUOTE NUMBER,add by Peggy 20120917	
								b[j][21]="&nbsp;";       //END CUSTOMER,add by Peggy 20121107				
								b[j][22]="&nbsp;";       //SHIPPING MARKS,add by Peggy 20130305
								b[j][23]="&nbsp;";       //REMARKS,add by Peggy 20130305
								b[j][24]="&nbsp;";       //END CUSTOMER,add by Peggy 20140922
								b[j][25]="&nbsp;";       //ORIG SO LINE ID,add by Peggy 20150519
				...
				for (int i=0;i<bb.length;i++) 
				{
					...
					cc[i][21]="D";  //add by Peggy 20121107
					cc[i][22]="D";  //add by Peggy 20130305
					cc[i][23]="D";  //add by Peggy 20130305
					cc[i][24]="D";  //add by Peggy 20140922
					cc[i][25]="D";  //add by Peggy 20150519
					cc[i][26]="D";  //add by Peggy 20160313
