...
<!--%/20040109/將Excel Veiw 夾在檔頭%-->
 <font color="#000066" face="Times New Roman" size="5"><strong>Oracle</strong></font>
 <font color="#000066" face="Times New Roman" size="+2"><strong>Database Concurrent SQL Query</strong></font>  
<BR>
  <!--%/20040109/將Excel Veiw 夾在檔頭%-->
<%
...
{
   sSql = "select DISTINCT a.SID, a.USERNAME, a.LOCKWAIT, a.STATUS, a.SCHEMANAME, a.OSUSER, a.PROCESS , "+
                 "a.MACHINE, a.TERMINAL, a.PROGRAM, a.MODULE, a.ACTION,  b.ADDRESS "+		   
           "from v$SESSION a, v$SQLTEXT b  ";
   sSqlCNT = "select count(DISTINCT a.SID) as CaseCount from v$SESSION a, v$SQLTEXT b  ";
   sWhere =  "where a.sql_address =b.address ";                  
   sOrder = "order by a.SID ";
...
{ 
 ...
 //out.println(sSql);  
   ...
   ResultSet rs2=statement2.executeQuery("select count(DISTINCT a.SID) as CaseCountORG from v$SESSION a, v$SQLTEXT b ");
   if (rs2.next())
   {
 ...
 <A HREF="/oradds/ORAddsMainMenu.jsp">回首頁</A>
  ...
  <table width="100%" border="1" cellpadding="0" cellspacing="0" bordercolorlight="#999999" bordercolordark="#FFFFFF">
    <tr bgcolor="#CCFF99" > 
	  ...
	  <td width="3%" height="22" nowrap><div align="center"><font color="#000000" size="-1">SQL Text</font></div></td>      
      <td width="19%" nowrap><div align="center"><font color="#000000" size="-1">Session ID</font></div></td>  
	  <td width="40%" nowrap><div align="center"><font color="#000000" size="-1">User Name</font></div></td>    
      <td width="7%" nowrap><div align="center"><font color="#000000" size="-1">Lock Wait</font></div></td>
      <td width="21%" nowrap><div align="center"><font color="#000000" size="-1">Status</font></div></td> 
	  <td width="21%" nowrap><div align="center"><font color="#000000" size="-1">Schema Name</font></div></td> 
	  <td width="21%" nowrap><div align="center"><font color="#000000" size="-1">OS User</font></div></td> 
	  <td width="21%" nowrap><div align="center"><font color="#000000" size="-1">Proccess</font></div></td> 
	  <td width="21%" nowrap><div align="center"><font color="#000000" size="-1">Machine</font></div></td>
	  <td width="21%" nowrap><div align="center"><font color="#000000" size="-1">Terminal</font></div></td> 
	  <td width="21%" nowrap><div align="center"><font color="#000000" size="-1">Program</font></div></td> 
	  <td width="21%" nowrap><div align="center"><font color="#000000" size="-1">Module</font></div></td> 
	  <td width="21%" nowrap><div align="center"><font color="#000000" size="-1">Action</font></div></td>	                       	  
    </tr>
    ...
    %>
    <tr bgcolor="<%=colorStr%>"> 
      <td bgcolor="#CCFF99"><div align="center"><font size="-1" color="#000000"><%out.println(rs1__index+1);%></font></div></td>  
	  <td><div align="center"><a href="../jsp/OraSysConcurrentSQLPage.jsp?SID=<%=rsTC.getString("SID")%>"><img src="../image/docicon.gif" width="14" height="15" border="0"></a></div></td>    
	  <td><font size="-1"><%=rsTC.getString("SID") %></font></td>
	  <td><font size="-1"><%=rsTC.getString("USERNAME") %></font></td>
      <td width="19%" nowrap><font size="-1"><%=rsTC.getString("LOCKWAIT")%></font></td>
	  <td width="40%" nowrap><font size="-1"><%=rsTC.getString("STATUS")%></font></td>
      <td width="7%"><font size="-1"><%=rsTC.getString("SCHEMANAME")%></font></td>
      <td width="21%" nowrap><font size="-1"><%=rsTC.getString("OSUSER")%></font></td> 
	  <td width="21%" nowrap><font size="-1"><%=rsTC.getString("PROCESS")%></font></td>
	  <td width="21%" nowrap><font size="-1"><%=rsTC.getString("MACHINE")%></font></td>
	  <td width="21%" nowrap><font size="-1"><%=rsTC.getString("TERMINAL")%></font></td> 
	  <td width="21%" nowrap><font size="-1"><%=rsTC.getString("PROGRAM")%></font></td>
	  <td width="21%" nowrap><font size="-1"><%=rsTC.getString("MODULE")%></font></td>
      <td width="21%" nowrap><font size="-1"><%=rsTC.getString("ACTION")%></font></td>
	     <%//=rsTC.getString("SQL_TEXT")
		    /*
		        String sSQLText = ""; 
		        Statement stateSQL=con.createStatement();
                ResultSet rsSQL=stateSQL.executeQuery("select PIECE, SQL_TEXT from v$SESSION a, v$SQLTEXT b where a.sql_address = b.address and a.SID = '"+rsTC.getString("SID")+"' order by PIECE ");
                while (rsSQL.next())
				{
...
%>
    <tr bgcolor="#CCFF99"> 
      <td height="23" colspan="15" ><font color="#000000">查詢筆數</font> 
        <% 
	      if (CaseCount==0) 
	 ...
	 %><input type="hidden" name="CASECOUNT" value=<%=CaseCount%> size="5"  readonly=""><%out.println("<font color='#000000'><strong><em>"+CaseCount+"</em></strong></font>");%> 
	 </td>      
    </tr>
  </table>
  <!--%每頁筆●顯示筆到筆總共有資料%-->
