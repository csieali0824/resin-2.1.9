...
<title>WINS System-Forecast Cost Inquiry and Maintenance</title>
...
<body>
<FORM ACTION="../jsp/WSForecastCostMaintenance.jsp" METHOD="post" NAME="MYFORM">
...
<strong> Forecast Cost Maintenance </strong></font>
<%
   int rs1__numRows = 25;
   int rs1__index = 0;
   int rs_numRows = 0;
 ...
 %>
<A HREF="../WinsMainMenu.jsp">HOME</A>&nbsp;&nbsp;&nbsp;&nbsp;<A HREF="../jsp/WSForecastMenu.jsp">Back to submenu</A>&nbsp;&nbsp;&nbsp;&nbsp;<A HREF="../jsp/WSForePriCostEntry.jsp">Forecast Cost Entry</A>
<% 
  ...
  <table width="100%" border="0">
    <tr> 
      <td width="37%" bgcolor="#006699"><font color="#FF0066" face="Arial Black"><strong>Business 
        Unit:</strong></font><font color="#330099" size="2" face="Arial Black"><strong> 
        </strong></font><font color="#FF0066" face="Arial Black"><strong> </strong></font><font size="2"> 
        <%	    	     		 		 
	     try
         { 	   		 
		  String sSqlC = "";
	   ...
	   %>
        </font><font color="#FF0066" face="Arial Black"><strong> </strong></font><font color="#330099" size="2" face="Arial Black"><strong> 
        </strong></font><font color="#FF0066" face="Arial Black"><strong> </strong></font></td>
      <td width="33%" bgcolor="#006699"><font color="#FF0066" face="Arial Black"><strong>Forecast 
	   ...
	   %>
        </font><font color="#FF0066" face="Arial Black"><strong> </strong></font><font size="2">&nbsp; 
        </font><font color="#FF0066" face="Arial Black"><strong> </strong></font> 
      </td>
      <td width="30%" bgcolor="#006699"><font color="#FF0066" face="Arial Black"><strong>REGION 
        <%
         try
         {   
		  String sSql = "";
		  ...
		  out.println("<select NAME='REGION' onChange='setSubmit("+'"'+"../jsp/WSForecastCostMaintenance.jsp"+'"'+")'>");
    ...
    <tr> 
      <td bgcolor="#006699"><font color="#FF0066" face="Arial Black"><strong>COUNTRY 
        <%
         ...
         {   
          ...
          Statement statement=con.createStatement();
          ResultSet rs=statement.executeQuery(sSql);         
          out.println("<select NAME='COUNTRY' onChange='setSubmit("+'"'+"../jsp/WSForecastCostMaintenance.jsp"+'"'+")'>");
          out.println("<OPTION VALUE=-->--");     
          while (rs.next())
          {            
           String s1=(String)rs.getString(1); 
      ...
      <td width="30%" bgcolor="#006699"><input name="button" type="button" onClick='setSubmit("../jsp/WSForecastCostMaintenance.jsp")'  value="Query" ></td>
    </tr>
  </table>
  <table width="100%" border="1" cellspacing="0" cellpadding="0">
    <tr bgcolor="#006666"> 
      <td width="4%"  height="19" bgcolor="#6699FF" nowrap><font color="#FFFFFF" size="2"><strong>LINK</strong></font></td>
      <td width="5%"  height="19" bgcolor="#6699FF" nowrap><font color="#FFFFFF" size="2"><strong>REGION</strong></font></td>
      <td width="9%" bgcolor="#6699FF" nowrap><font color="#FFFFFF" size="2"><strong>COUNTRY</strong></font></td>
      <td width="8%" bgcolor="#6699FF" nowrap><font color="#FFFFFF" size="2"><strong>CURRENCY</strong></font></td>
      <td width="6%" bgcolor="#6699FF" nowrap><font color="#FFFFFF" size="2"><strong>MODEL</strong></font></td>
      <td width="9%" bgcolor="#6699FF" nowrap><font color="#FFFFFF" size="2"><strong>COST</strong></font></td>
      <td width="7%" bgcolor="#6699FF" nowrap><font color="#FFFFFF" size="2"><strong>YEAR</strong></font></td>
      <td width="10%" bgcolor="#6699FF" nowrap><font color="#FFFFFF" size="2"><strong>MONTH</strong></font></td>
      <td width="12%" bgcolor="#6699FF" nowrap><font color="#FFFFFF" size="2"><strong>CREATEUSER</strong></font></td>
      <td width="15%" bgcolor="#6699FF" nowrap><font color="#FFFFFF" size="2"><strong>VERSION</strong></font></td>
    </tr>
    <%  
            try
            {  
              ...
              String sqlTC =  "select FCCOMP,FCREG,FCCOUN,FCCURR,FCPRJCD,FCCOST,FCYEAR,FCMONTH,FCTYPE,FCLUSER,FCMVER "+
			                  " from psales_fore_cost";
			  String sWhereTC = " where FCMVER=(select max(FCMVER) from psales_fore_cost ) and FCPRJCD IS NOT NULL  ";
   ...
   //out.println("MM_size Step0="+MM_size);
    ...
    <%
        ...
        %>
    <tr bgcolor="<%=colorStr%>"> 
      <td></a><a href="../jsp/WSForecastCostEdit.jsp?FCCOMP=<%=rsTC.getString("FCCOMP")%>&FCTYPE=<%=rsTC.getString("FCTYPE")%>&FCREG=<%=rsTC.getString("FCREG")%>&FCCOUN=<%=rsTC.getString("FCCOUN")%>&FCCURR=<%=rsTC.getString("FCCURR")%>&FCPRJCD=<%=rsTC.getString("FCPRJCD")%>&FCYEAR=<%=rsTC.getString("FCYEAR")%>&FCMONTH=<%=rsTC.getString("FCMONTH")%>&FCMVER=<%=rsTC.getString("FCMVER")%>"><img src="../image/docicon.gif" width="14" height="19" border="0"></a></td>
      <td height="21"><font size="2" color="#000099"> 
        <% 
      ...
      <td><font size="2" color="#CC3366"> 
        <%
                      if (rsTC.getInt("FCCOST") > 0) { out.println(rsTC.getInt("FCCOST")); } 
                      else { out.println("&nbsp;"); }
                     //=rsTC.getString("TXRPCENTERNO") 
                 %>
        </font></td>
