...
<%
	String rootPath = application.getRealPath("/jsp/TSCT-Disty2");
...
<BR>
<p align="center">
<p align="center" class="style1"><font face="Verdana, Arial, Helvetica, sans-serif">TSCT Disty2 EXL Upload Program and List </font></p>
</p>
<form action="" name="form1" method="post" enctype="multipart/form-data">
 <%@ include file="Tsc1211TSCTD2Head.jsp"%>
  ...
  <TABLE width="70%" height="84" border="0" align="center" cellpadding="0" cellspacing="1" class="tborder">
    <tr bgcolor="#E6FFE6"> 
      <td height="30" colspan="6"> <div align="center"> 
          ...
          <input name="Submit" type="submit" class="btn" onclick ='setUpload("Tsc1211TSCTD2UploadCheck.jsp")' value="Upload">
        </div></td>
    </tr>
	<tr> 
    ...
    <%
  	for(int i=0; i<fileList.size(); i++){
		...
		if( ((String)p.get("fn")).equals("Tsc1211TSCTD2Upload.jsp") || ((String)p.get("fn")).equals("Tsc1211TSCTD2Upload.jsp")){
			continue;
		}
  ...
  %>
    <tr> 
      ...
      <td bgcolor="<%=color%>" ><div align="center">
        <input type="submit" name="Submit2" value="insert" onclick ='setSubmit("Tsc1211TSCTD2UploadCheck.jsp?fileName=<%=p.get("fn")%>")'>
      </div></td>
    </tr>
    <%
  	}
