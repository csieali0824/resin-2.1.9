...
<html>
<head>
<title>Query All PIT Function</title>
...
function NeedConfirm(field)
{
  ...
  if (flag==false)
  {
    ...
    document.MYFORM.action="WSPIT_FuncDel.jsp";
...
<font color="#3366FF" size="+2" face="Arial"><font size="+3" face="Arial Black"><font color="#3366FF" size="+2" face="Arial"><font size="+3" face="Arial Black"><font face="Courier, MS Sans Serif"><font color="#54A7A7" size="+2" face="Arial Black">DBTEL</font></font></font></font><font face="Courier, MS Sans Serif"></font></font></font><font color="#000000" size="+1" face="Times New Roman"> <strong>功能清單</strong></font>
<BR>
<INPUT TYPE="Button"  name="Button" value="刪除" onClick="NeedConfirm(this.form.CH)">
&nbsp;&nbsp; <A HREF="../jsp/WSPIT_FuncInput.jsp?CLASS1=M">新增主功能清單</A>&nbsp; <A HREF="../jsp/WSPIT_FuncInput.jsp?CLASS1=S">新增次功能清單</A>&nbsp;<A HREF="/wins/WinsMainMenu.jsp">回首頁</A> 
&nbsp;&nbsp;&nbsp;&nbsp;CLASS/NAME:
...
try
{      
   String a[]={"<input name='checkselect' type=checkbox onClick='this.value=check(this.form.CH)' title='選取全部或取消選取'>","","CODE","CLASS","NAME","DESCRIPTION","REF","LOCALE","MDATE","MTIME","MUSER"};
   qryAllChkBoxEditBean.setHeaderArray(a); //先設置表頭
   
   if (searchString!=null && !searchString.equals("")) //如果有搜尋特定單號則另下SQL
   {	
	 sql="select code,class,name,description,ref,locale,mdate,mtime,muser from pit_function where code like '"+searchString+"%' or name like '"+searchString+"%' order by class";	
   } else {    
	 sql="select code,class,name,description,ref,locale,mdate,mtime,muser from pit_function order by class";	
   }        

   rs=statement.executeQuery(sql);   
   qryAllChkBoxEditBean.setPageURL("../jsp/WSPIT_FuncEdit.jsp");
   qryAllChkBoxEditBean.setSearchKey("code");
