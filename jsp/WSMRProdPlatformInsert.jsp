...
String splatFmName=request.getParameter("SPLATFMNAME");
String platForm=request.getParameter("PLATFORM");
String vndName=request.getParameter("VNDNAME");
...
{  
	   ...
	   //{
		 ...
		 //String c_in_array=request.getParameter("MONTH"+ac+"-"+subac);//取前一頁之輸入欄位
          // sql="insert into PSALES_FORE_COST(FCCOMP,FCYEAR,FCMONTH,FCREG,FCCOUN,FCTYPE,FCPRJCD,FCCOST,FCMVER,FCLUSER,FCCURR) values(?,?,?,?,?,?,?,?,?,?,?)";
           sql="insert into PRPROD_PLATFORM(PLATFORM_CODE,SPLATFM_NAME,PLATFORM,VND_NAME) values(?,?,?,?)";
  ...
  out.println("輸入產品發展平台代碼新增成功 !!!<BR>");
  out.println("<A HREF=/wins/WinsMainMenu.jsp>首頁</A>&nbsp;&nbsp;<A HREF=../jsp/WSMRProdPlatformInput.jsp?ENTRY=TRUE>產品發展平台代碼資料新增</A>&nbsp;&nbsp;<A HREF='../jsp/WSMRProdPlatformInquiry.jsp'>產品發展平台代碼資料查詢</A> ");
