...
<%
     ...
     String endYYYYMM = workingDateBean.getYearMonthDay().substring(0,6);         
       ...
       String sqlOpened = " select to_char(to_date(substr(d.CREATION_DATE,0,6),'YYYYMM'),'YYYYMM'), count(d.DNDOCNO) as OPENED "+
                         ...
                         "    and f.ORISTATUSID = '002' "+ // 只看經台北企劃分派的單據  
                         "    and f.actionid = '003' "+  // 經台北企劃分派的動作 ( ASSIGNING ) 
      ...
      String sqlClosed = " select to_char(to_date(substr(d.CREATION_DATE,0,6),'YYYYMM'),'YYYYMM'), count(d.DNDOCNO) as CLOSED "+
                         ...
                         "    and d.ASSIGN_MANUFACT = e.MANUFACTORY_NO(+) "+
                         "    and substr(d.DNDOCNO,3,3)=b.SALES_AREA_NO and b.LOCALE='886' "+
                         "    and f.ORISTATUSID = '004' "+ // 只看經企劃回覆的單據 
                         "    and f.actionid = '009' "+  // 企劃回覆的動作 
                         "    and substr(d.CREATION_DATE,0,6) between '"+beginYYYYMM+"' AND '"+endYYYYMM+"' "+
      		             "  group by to_char(to_date(substr(d.CREATION_DATE,0,6),'YYYYMM'),'YYYYMM') "+
                         "  order by to_char(to_date(substr(d.CREATION_DATE,0,6),'YYYYMM'),'YYYYMM') ";	                     
       String sWhereClosed = " ";
...
*/
      ...
      org.jfree.chart.urls.TimeSeriesURLGenerator urlg = new org.jfree.chart.urls.TimeSeriesURLGenerator(sdf, "TSRFQFacPlannerConfirmIMap.jsp?FAC="+factory, "TRENDMODE", "DATETIME");
     ...
     // plot.setRangeAxis(1, valueAxisRetn);
      ...
      org.jfree.chart.JFreeChart chart = new org.jfree.chart.JFreeChart("工廠企劃月訂單確認/回覆統計", org.jfree.chart.JFreeChart.DEFAULT_TITLE_FONT, plot, false);
...
*/                 
    //  JFreeChart chart = new JFreeChart("月客退率排名", JFreeChart.DEFAULT_TITLE_FONT, plot, false);
        ...
        org.jfree.chart.title.TextTitle subYLTitle = new org.jfree.chart.title.TextTitle("月接收數量", new Font("標楷體",java.awt.Font.PLAIN+java.awt.Font.BOLD,14), new Color(255,0,0), org.jfree.ui.RectangleEdge.LEFT, org.jfree.ui.HorizontalAlignment.CENTER, org.jfree.ui.VerticalAlignment.CENTER, new org.jfree.ui.Spacer(1,15,0,0,0) ) ;  // 左右上下 
        chart.addSubtitle(subYLTitle); 

        org.jfree.chart.title.TextTitle subYRTitle = new org.jfree.chart.title.TextTitle("月回覆數量", new Font("標楷體",java.awt.Font.PLAIN+java.awt.Font.BOLD,14), new Color(0,0,255), org.jfree.ui.RectangleEdge.RIGHT, org.jfree.ui.HorizontalAlignment.CENTER, org.jfree.ui.VerticalAlignment.CENTER, new org.jfree.ui.Spacer(1,0,0,15,0) ) ; // 左右上下
