...
{ 
	...
	String sql_update="UPDATE HLCM SET LCSTAT='"+actionID+"',LCRDTE='"+EDITION+"',LCRCTM='"+TIME+"',LCCFM='"+userID+"' WHERE LCNO='"+searchString+"'";
	statement.executeUpdate(sql_update);
	statement.close();

	} 
  
  	out.println("CONFIRM: "+searchString+"L/C OK!<BR>");
