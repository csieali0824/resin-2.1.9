...
<%
	...
	SimpleDateFormat sdf = new SimpleDateFormat("yyyyMMdd_HHmmss");
        ...
        if ( (todo != null) && (todo.equalsIgnoreCase("upload")) )  {
         ...
         Cell cellcurrency = sheet.getCell(5,1);
         ...
         try
          ...
          for ( int itemno=0 ; itemno < rows-3 ; itemno++)
          {
           ...
           // To Check the ITEM result records
               ...
               sqlCNTitem = "select count(*) from APPS.OE_ITEMS_V where ITEM = '"+partdescCNT+"' AND ITEM_STATUS='ACTIVE' AND CROSS_REF_STATUS='ACTIVE' ";
            ...
            //attention: The first parameter is column,the second parameter is row.  
             ...
             // To Check the ITEM result records
              ...
              //out.println(BufferPartDesc[1][i]);
                    ...
                    sqlUOM = "select b.INVENTORY_ITEM_ID INVENTORY_ITEM_ID, b.SEGMENT1 SEGMENT1, b.DESCRIPTION DESCRIPTION, b.PRIMARY_UOM_CODE PRIMARY_UOM_CODE from APPS.OE_ITEMS_V a, APPS.MTL_SYSTEM_ITEMS b where a.item= '"+BufferPartDesc[1][i]+"' and a.INVENTORY_ITEM=b.SEGMENT1 and b.ORGANIZATION_ID = '49' and a.ITEM_STATUS='ACTIVE' and a.CROSS_REF_STATUS='ACTIVE'"; 
...
<form method="post" action="TSCESetronImport.jsp?UPLOADFLAG=Y" name="upform" enctype="multipart/form-data">
