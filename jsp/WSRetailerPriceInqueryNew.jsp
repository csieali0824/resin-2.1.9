...
<FORM ACTION="WSRetailerPriceInqueryNew.jsp" METHOD="post" NAME="MYFORM" onSubmit="rstart()">
<%   
...
if (region==null) region="AP";
String country=request.getParameter("COUNTRY");  
if (country==null) country="886";  //預設值是taiwan
String selCurr=request.getParameter("SELCURR");  //選用之幣別 
if (selCurr==null) selCurr="NTD";  //預設值是NTD
...
<table width="100%" border="0">
    <tr bgcolor="#D0FFFF">
      <td width="8%" bordercolor="#FFFFFF"><font color="#333399" face="Arial Black"><strong>Year</strong></font>
        <%    	      		 
	     try
         {       
      ...
      <td width="10%" height="23" bordercolor="#FFFFFF"> 
      ...
      <td width="14%"><font color="#333399" size="2" face="Arial Black"><strong>Region: 
            <% 		 		 		 
	     try
         {   
		  String sSql = "";
		  ...
		  out.println("<select NAME='REGION' onChange='setSubmit("+'"'+"../jsp/WSRetailerPriceInqueryNew.jsp"+'"'+")'>");
      ...
      <td width="23%"><font size="2"><font color="#333399" face="Arial Black"><strong>Country:
        <% 		 		 		 
	     try
         {   
		  String sSql = "";
      ...
      <td width="13%"><font color="#333399" face="Arial Black"><strong>Currency</strong></font>
        <% 		 		 		 
	     try
         {   
		  String sSql = "";
      ...
      <td width="9%"><font size="2"> <font color="#333399" face="Arial Black"><strong>	   </strong></font>
		...
		<% 
	    if (UserRoles.indexOf("admin")>=0 || UserRoles.indexOf("fp_admin")>=0 )
	   {
   	      out.println("<input name='button' type=button onclick='rstart2()' value='計算零售價'> ");
	   }  
	 %>			
	  </font></td>     
  </tr>
</table>
<font color="#54A7A7" face="Times New Roman" size="5"><STRONG>DBTEL</font><font color="#000000" size="5" face="Times New Roman"> <strong>Retailer
 Price(W/O VAT) Inquery</strong></font>
...
to submenu</A>
<%  
out.println("<BR><font color='#330099' face='Times New Roman' size='4'><strong>This Month is :"+thisDateBean.getYearString()+"/"+thisDateBean.getMonthString()+"&nbsp;&nbsp;&nbsp;&nbsp;Currency:"+selCurr+"</strong></font>");
try 
{  
...
{ 
  ...
  int rt_price=0; //retailer PRICE
  String brand="";
		  
  sSql = "select trim(PROJECTCODE) as INTERMODEL,SALESCODE,BRAND from PIMASTER x";
  sWhere = " where PROJECTCODE is not null";
  if (model!=null && !model.equals("--")) sWhere = sWhere+" and trim(PROJECTCODE)='"+model+"'";	  
  sOrder = " order by PROJECTCODE";		 
  ...
  {         
   ...
   if (brand==null || (brand!=null && (brand.equals("DBTEL") || brand.equals("null") || brand.equals("--")))) 
   {
    out.println("<TD><font face='Times New Roman'>"+interModel+"</font></TD>"); 
    out.println("<TD><font face='Times New Roman'>"+rs.getString("SALESCODE")+"</font></TD>");   
   } else {
    out.println("<TD BGCOLOR=FFE4E1><font face='Times New Roman'>"+interModel+"</font></TD>"); 
    out.println("<TD BGCOLOR=FFE4E1><font face='Times New Roman'>"+rs.getString("SALESCODE")+"</font></TD>"); 
   }   
   ...
   subSql="select max(RPMVER),RPYEAR,RPMONTH,RPREG,RPCOUN,RPPRI from PSALES_RETAILER_PRICE a"; 	 	 	
   subWhere=" where rpmver = (select max(rpmver) from PSALES_RETAILER_PRICE b where a.rpprjcd=b.rpprjcd and a.rpyear=b.rpyear and a.rpmonth=b.rpmonth and a.rpreg=b.rpreg and a.rpcoun=b.rpcoun )  and  RPCURR='"+curr+"' and RPCOUN in ("+countryArrayString+") and RPPRJCD='"+interModel+"' and RPYEAR||'/'||RPMONTH between '"+ymh1+"' and '"+ymh12+"' group by RPREG,RPCOUN,RPPRI,RPYEAR,RPMONTH order by RPYEAR,RPMONTH,RPREG,RPCOUN"; 
   ...
   {   
	 ...
	 {
       if (isEOF.equals("N") && ymArray[ymc].equals(subRs.getString("RPYEAR")+subRs.getString("RPMONTH")))    
	   {
	     out.println("<TD><TABLE border=0>");  
         for (int cac=0;cac<countryArray.length;cac++)
         {	     	   
	        if (isEOF.equals("N") && countryArray[cac][0].equals(subRs.getString("RPCOUN")))
	        {	   
	          rt_price=Math.round(subRs.getInt("RPPRI")*Float.parseFloat(ex_rate));	  	      	   	   
	          if (subRs.next())
			  {
			  } else {			  
	        ...
	        if (rt_price>0)
	        {
			  ...
			  if (rt_price<1000)
			  {
			     rt_price_str=String.valueOf(rt_price);
			  } else {
			    rt_price_str=df.format(rt_price);
			  }
	          out.println("<TR><TD align='right'><FONT face='Times New Roman'>"+rt_price_str+"</FONT></TD></TR>");	     
	        } else {  
