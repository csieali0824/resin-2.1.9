...
<html>
<head>
<title>Forecast Application Process</title>
...
{      
  ...
  out.println("Forecast Data Processed and has been sent to "+nextPrcsManName+"!! (Doc No:"+docNo+")<BR>");
  ...
  if (!nextPrcsManMail.equals(""))
  {
    ...
    sendMailBean.setUrlAddr(serverName+"/wins/jsp/WSForeToApprove.jsp?DOCNO="+docNo);		 
    sendMailBean.sendMail();
  }//enf of nextPrcsManMail if--------------------------------	
  
  if (status.equals("COMPLETE")) //若已核准則通知MCUser	物管人員
  {
