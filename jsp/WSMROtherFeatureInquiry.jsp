...
<strong> 產品編碼系統-其他特徵代碼查詢 </strong></font>
<FORM ACTION="../jsp/WSMROtherFeatureInquiry.jsp" METHOD="post" NAME="MYFORM">
<%
   int rs1__numRows = 25;
   int rs1__index = 0;
   int rs_numRows = 0;
 ...
 %>
<A HREF="../WinsMainMenu.jsp">首頁</A> &nbsp;&nbsp;<A HREF="../jsp/WSModelEncodingSub.jsp">產品編碼管理作業</A> &nbsp;&nbsp;<A HREF="../jsp/WSMROtherFeatureInput.jsp?ENTRY=TRUE">產品其他特徵代碼資料新增</A>
<% 
...
<table width="50%" border="0">      
      ...
      <td bgcolor="#FFFFFF" colspan="2"><font color="#000000" face="Arial Black"><strong>產品外觀代碼
        <%
         ...
         {       
		  ...
		  sSql = "select FTURE_CODE, FTURE_CODE || '(' || FEATURE ||')' "+
			     "from MROTH_FEATURE ";	 
		  sSql = sSql+sWhere;
		  ...
		  comboBoxAllBean.setSelection(featureCode);
	      comboBoxAllBean.setFieldName("FEATURECODE");	   
          out.println(comboBoxAllBean.getRsString());
		  if (rs.next())
		  {		   
            featureCode= rs.getString("FTURE_CODE");
    ...
    <td width="35%" bgcolor="#FFFFFF"><INPUT TYPE="button"  value="Query" onClick='setSubmit("../jsp/WSMROtherFeatureInquiry.jsp")' ></td>    
    </tr> 
...
<table width="50%" border="1" cellspacing="0" cellpadding="0">
        <tr bgcolor="#006666"> 
		  ...
		  <td width="19%"  height="19" bgcolor="#6699FF" nowrap><font color="#FFFFFF" size="2"><strong>其他特徵代碼</strong></font></td>
          <td width="33%"  height="19" bgcolor="#6699FF" nowrap><font color="#FFFFFF" size="2"><strong>產品其他特徵</strong></font></td>
          ...
          <%  
            ...
            {  
              ...
              String sqlTC =  "select FTURE_CODE, FEATURE, NOTE "+
			                  "from MROTH_FEATURE ";
			  String sWhereTC = "where FTURE_CODE IS NOT NULL ";
			
              if (featureCode == null || featureCode.equals("--")) { sWhereTC = sWhereTC + "and FTURE_CODE != '0'  "; }
			  else { sWhereTC = sWhereTC + "and FTURE_CODE ='"+featureCode+"'  "; }                      			             
             ...
             // if (MonthFr!="--" && MonthTo!="--") sWhereTC=sWhereTC+" and substr(LAUNCH_DATE,3,4)||substr(LAUNCH_DATE,1,2) between "+"'"+dateStringBegin+"'"+" and "+"'"+dateStringEnd+"' ";
			  ...
			  String sOrderTC = "order by FTURE_CODE ";
      ...
      if (request.getParameterNames().hasMoreElements()) {
        ...
        <tr bgcolor="<%=colorStr%>">
          ...
          <td height="20"><font size="2">
                 <% 
                      if (rsTC.getString("FTURE_CODE")!=null ) { out.println(rsTC.getString("FTURE_CODE")); } 
                      else { out.println("&nbsp;"); }
                  %></font></td>		           	           
		  <td><font size="2" >
                 <%
                   //if (codeClass==null || codeClass=="2" || codeClass.equals("2"))
                     ...
                     if (rsTC.getString("FEATURE")!=null) { out.println(rsTC.getString("FEATURE")); } 
                     else { out.println("&nbsp;"); }
          ...
          <td><font size="2" >
                 <%
                      if (rsTC.getString("NOTE") !=null) { out.println(rsTC.getString("NOTE")); } 
                      else { out.println("&nbsp;"); }
