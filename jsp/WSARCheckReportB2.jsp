...
<body>
<FORM ACTION="WSARCheckReportB2.jsp" METHOD="post" NAME="MYFORM">
  <div align="left"> <font color="#CC3366" size="2" face="Arial, Helvetica, sans-serif"> 
    ...
    <table width="100%" border="0">
      ...
      <tr>
        <td><div align="center"><strong><font color="#0000FF" size="+2" face="Arial">監檢日報表(催貨)</font></strong> 
            <%
 ...
 %>
  ...
  <table width="100%" border="0">
    <tr> 
      ...
      <td width="28%" bgcolor="#006699"><input name="button" type="button" onClick='setSubmit("../jsp/WSARCheckReportB2.jsp")'  value="Query" > 
  ...
  <table width="100%" border="1" cellspacing="0" cellpadding="0">
    ...
    <%      
	     try
            {  
			  ...
			  String sqlTC =  "SELECT DISTINCT r2.arodyr,r2.arodpx,r2.rinvc,r2.rcust,r2.arsord,cnme"+" "+
			                   "FROM rar r2 ,rcm"+" ";
			  String sWhereTC = "WHERE r2.rrid='RP' AND r2.rseq=0 AND r2.rrem!=0 AND r2.rcust=ccust " ;              
								 

              String sqlTC2 =  "SELECT DISTINCT r1.arodyr,r1.arodpx,r1.rinvc,r1.rcust,r2.arsord,cnme "+" "+
			  ...
			  else if (TYPE=="2" || TYPE.equals("2") ) { sWhereTC2 = sWhereTC2 + "AND (r2.RCTYP ='12') ";  }			  
          ...
          // ¢FFFFFD[?J?A-? - !L!| /
		     ...
		     {		 
               ...
               if (rs1__index!=0 && (!rCustTmp.equals("") && !rCustTmp.equals(rCust)))			   		   		       		     
		        { 		 			 				 
				 //out.println("<tr bgcolor='#FFCCFF'><td colspan='4'>&nbsp;</td><td><font size='2' color='#000099' face='Arial'><div align='right'>"+subsumLQORD+"</div></font></td><td><font size='2' color='#000099' face='Arial'><div align='right'>"+subsumLAMT+"</div></font></td><td>&nbsp;</td><td><font size='2' color='#000099' face='Arial'><div align='right'>"+subsumILQTY+"</div></font></td><td><font size='2' color='#000099' face='Arial'><div align='right'>"+subsumIAMT+"</div></font></td><td>&nbsp;</td><td><font size='2' color='#000099' face='Arial'><div align='right'>"+subsumRAMT+"</div></font></td><td><div align='right'>"+subsumUNQTY+"</div></td><td><font size='2' color='#000099' face='Arial'><div align='right'>"+subsumUNAMT+"</div></font></td><td><font size='2' color='#000099' face='Arial'><div align='right'>"+subsumRAMT+"</div></font></td><td>&nbsp;</td></tr>"); 				
    ...
    <tr bgcolor="#FFFFFF"> 
      ...
      <td><div align="left"><font size="1" color="#000099"> </font><font color="#990033" size="1" face="Arial, Helvetica, sans-serif"> 
      ...
      <td><div align="center"><font size="2" color="#000099"> </font><font color="#000000" size="2" face="Arial, Helvetica, sans-serif"><%=rsTC.getString("arsord") %></font></div></td>
      <td> 
        <div align="center"><font size="2" color="#000099"> </font><font color="#0000FF" size="2" face="Arial, Helvetica, sans-serif">
          <% 
		   out.println("&nbsp;");
		   %>
      ...
      <td><div align="right"><font color="#0000FF" size="2" face="Arial, Helvetica, sans-serif"> 
          </font> <font size="2" color="#000099"></font><font size="2" face="Arial, Helvetica, sans-serif"><font color="#0000FF"> 
          <% 
	         out.println(0); 
		   %>
          </font></font><font color="#0000FF" size="2" face="Arial, Helvetica, sans-serif"></font></div></td>
      <td><div align="right"><font color="#0000FF" size="2" face="Arial, Helvetica, sans-serif"> 
          </font><font size="2" face="Arial, Helvetica, sans-serif"><font color="#0000FF"> 
          <% 
	         out.println(0); 
		   %>
          </font></font><font color="#0000FF" size="2" face="Arial, Helvetica, sans-serif"> 
      ...
      <td><div align="right"><font color="#0000FF" size="2" face="Arial, Helvetica, sans-serif"> 
          ...
          </font></font><font size="2" face="Arial, Helvetica, sans-serif"><font size="2" face="Arial, Helvetica, sans-serif"><font color="#0000FF"> 
          <% 
		   out.println(0);
		   %>
          </font></font></font><font size="2" color="#000099"></font><font color="#0000FF" size="2" face="Arial, Helvetica, sans-serif"> 
          </font></div></td>
      <td> <div align="right"><font color="#0000FF" size="2" face="Arial, Helvetica, sans-serif"> 
          </font><font size="2" color="#000099"></font><font size="2" face="Arial, Helvetica, sans-serif"><font color="#0000FF">
          <% 
          ...
          <%
				 ...
				 amtStatement.close();				 
				   ...
				   while (docrs.next())                   
					 ...
					 out.println(docrs.getString("rdate")); 					 
			         n++;			
	                 } //end of docrs while
					 n=0;					 		 	   
	                 docstatement.close();
      ...
      <td><div align="right"><font color="#0000FF" size="2" face="Arial, Helvetica, sans-serif"> 
          <% if(!rCustTmp.equals("") && !rCustTmp.equals(rCust)){subsumRAMT=0;} 
      ...
      <td bgcolor="#FFFFFF">
<div align="center"><font size="2" color="#000099">&nbsp; </font> <font color="#000000" size="2" face="Arial, Helvetica, sans-serif"><%=rsTC.getString("arodyr") %> <%=rsTC.getString("arodpx") %> <%=rsTC.getString("rinvc") %> </font><font color="#0000FF" size="2" face="Arial, Helvetica, sans-serif"> 
          <% 
		   int CKSTS = 0; 
    ...
    <%        	
	 ...
	 out.println("<tr bgcolor='#FFCCFF'><td colspan='4'>&nbsp;</td><td><font size='2' color='#000099' face='Arial'><div align='right'>"+subsumLQORD_str+"</div></font></td><td><font size='2' color='#000099' face='Arial'><div align='right'>"+subsumLAMT_str+"</div></font></td><td>&nbsp;</td><td><font size='2' color='#000099' face='Arial'><div align='right'>"+subsumILQTY_str+"</div></font></td><td><font size='2' color='#000099' face='Arial'><div align='right'>"+subsumIAMT_str+"</div></font></td><td>&nbsp;</td><td><font size='2' color='#000099' face='Arial'><div align='right'>"+subsumRAMT_str+"</div></font></td><td><font size='2' color='#000099' face='Arial'><div align='right'>"+subsumUNQTY_str+"</div></font></td><td><font size='2' color='#000099' face='Arial'><div align='right'>"+subsumUNAMT_str+"</div></font></td><td><font size='2' color='#000099' face='Arial'><div align='right'>"+subsumAMTMIN_str+"</div></font></td><td>&nbsp;</td></tr>"); 
				 ...
				 //out.println("<tr bgcolor='#6699FF'><td colspan='4'><font size='3' color='#FFFF00' face='Arial'><strong><div align='right'>TOTAL</div></strong></font></td><td><font size='2' color='#FFFF00' face='Arial'><div align='right'>"+sumLQORD+"</div></font></td><td><font size='2' color='#FFFF00' face='Arial'><div align='right'>"+sumLAMT+"</div></font></td><td>&nbsp;</td><td><font size='2' color='#FFFF00' face='Arial'><div align='right'>"+sumILQTY+"</div></font></td><td><font size='2' color='#FFFF00' face='Arial'><div align='right'>"+sumIAMT+"</div></font></td><td>&nbsp;</td><td><font size='2' color='#FFFF00' face='Arial'><div align='right'>"+sumRAMT+"</div></font></td><td><font size='2' color='#FFFF00' face='Arial'><div align='right'>"+sumUNQTY+"</div></font></td><td><font size='2' color='#FFFF00' face='Arial'><div align='right'>"+sumUNAMT+"</div></font></td><td><font size='2' color='#FFFF00' face='Arial'><div align='right'>"+sumRAMT+"</div></font></td><td>&nbsp;</td></tr>"); 
