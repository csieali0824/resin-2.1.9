<html>
<head>
<title>TSCT Bright Diamond Order Import </title>
...
<jsp:useBean id="upBean" scope="page" class="javazoom.upload.UploadBean" >
  <jsp:setProperty name="upBean" property="folderstore" value="D:/resin-2.1.9/webapps/oradds/jsp/TSCTBright/" />
...
<%
	...
	SimpleDateFormat sdf = new SimpleDateFormat("yyyyMMdd_HHmmss");
        fileMover.setNewfilename("TSCTBright_"+sdf.format(new java.util.Date())+".xls");
        ...
        if ( (todo != null) && (todo.equalsIgnoreCase("upload")) )  {
         ...
         // Change the directory location below
         Workbook rw = Workbook.getWorkbook(new File("D:/resin-2.1.9/webapps/oradds/jsp/TSCTBright/"+fileMover.getFileName()));
...
<form method="post" action="TSCTBrightDiamondImport.jsp?UPLOADFLAG=Y" name="upform" enctype="multipart/form-data">
  ...
  <table width="60%" border="0" cellspacing="1" cellpadding="1" align="center">
    <tr>
      <td align="left"><font size="-1" face="Verdana, Arial, Helvetica, sans-serif"><b>Select
        TSCT Bright Diamond Order in Excel format to upload :</b></font></td>
    </tr>
    <tr>
