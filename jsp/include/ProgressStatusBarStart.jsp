...
<div id="showimage" style="position:absolute; visibility:visiable; z-index:65535; top: 160px; left: 200px; width: 370px; height: 90px;"> 
  <br>
  <table width="320" height="70" border="1" align="center" cellpadding="5" cellspacing="0" bordercolor="#6699CC" bordercolordark="#D7F2FF">
    <tr>
    <td height="70" bgcolor="#DCE8F3" align="center"> <font color="#567886"><jsp:getProperty name="rPH" property="pgProgressStsBar"/></font> <BR>
