...
try
{    
  if (dominoConn.isSessionAlive()==false || !dominoConn.getServerName().equals("notesapp.dbtel.com.tw"))
  {
     dominoConn.setServerName("notesapp.dbtel.com.tw");
	 dominoConn.setSecondaryServerName("notesapp.dbtel.com.tw"); 
...
// End of Connection for Domino NOTESAPP Server    
%>
