...
{    
  if (oraddspoolBean.getDriver()==null)
  {
   ...
   oraddspoolBean.setURL(application.getInitParameter("ORADTST2_JDBC_URL"));
   oraddspoolBean.setURL2(application.getInitParameter("ORADTST2_JDBC_URL"));
   oraddspoolBean.setUsername("APPS");
   oraddspoolBean.setPassword("APPS");   
