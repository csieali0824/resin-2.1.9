...
function setSubmit1(URL,xPRINTED) //shipConfirm
{ 

 if ( xPRINTED==null || xPRINTED =="N" || xPRINTED =="" )
  {
   alert("This Invoice not yet Printed!!");
   return false; 
  }
...
function chkStatus()
{    
   document.MYFORM.action="../jsp/TSSHPShipConfirm.jsp";
   document.MYFORM.submit();
} 
</script>
<html>
...
//LILY CREAT
   ...
   String orderHeaderId = request.getParameter("ORDER_HEADER_ID");   
...
<FORM ACTION="TSSHPShipConfirm.jsp" METHOD="post" NAME="MYFORM">
...
<strong>
<jsp:getProperty name="rPH" property="pgInvoiceNo"/><jsp:getProperty name="rPH" property="pgShipType"/><jsp:getProperty name="rPH" property="pgConfirm"/></strong></font>
...
//計算發票總金額
		 ...
		 while (rsa.next())
		 {
			totalAmt = Float.toString(Float.parseFloat(totalAmt)+rsa.getFloat("TOTALAMT"));	
         }
		   rsa.close();
           statea.close();	
           if (totalAmt==null || totalAmt.equals("null")) totalAmt="0"; 	 
...
/*  找尋合法的發票資訊 */
        ...
        sSql =  " select B.SALESORDERNO||'-'|| B.LINE_NO as SELECTFLAG, A.TSINVOICENO,A.SHIPDATE,A.CUSTOMERNO,A.CUSTOMERNAME, "+
       			"        A.SHIPTOORG,A.SHIPADDRESS,A.SHIPMETHOD,A.FOBPOINT,A.PAYTERM,B.SALESORDERNO,B.LINE_NO,B.ORDER_LINE_ID,B.ORDER_HEADER_ID,"+
...
%>  
  <table cellSpacing='0' bordercolordark='#CCCC99'  cellPadding='1' width='100%' align='center' borderColorLight='#ffffff' border='1'>
     <tr>
	    <td valign="middle" nowrap colspan="2"><font color="#006666" size="3"><strong>&nbsp;&nbsp;&nbsp;&nbsp;<jsp:getProperty name="rPH" property="pgTSCAlias"/><jsp:getProperty name="rPH" property="pgInvoiceNo"/></strong></font> 
		  <input type="text" size="15" name="TSINVOICENO" tabindex='4' maxlength="20" value="<%=tsInvoiceNo.toUpperCase()%>" onKeyDown="setSubmit1a('../jsp/TSSHPShipConfirm.jsp')">
		  <INPUT TYPE="button" name="QUERY" align="middle"  value="<jsp:getProperty name='rPH' property='pgQuery'/>" onClick="setSubmit('../jsp/TSSHPShipConfirm.jsp')" >

        <%  if ((chkQuery=="Y" || chkQuery.equals("Y")) && CaseCountORG !=0 ) { %>		  
		   <INPUT TYPE="button"  name="SHIPCON" align="middle"  value="<jsp:getProperty name='rPH' property='pgShipType'/><jsp:getProperty name='rPH' property='pgConfirm'/>" onClick="setSubmit1('../jsp/TSSHPConProcess.jsp','<%=printFlag%>')" > 
        <% } %>  
     </tr>
	 <tr>
	   <td width="10%"><font color="#CC3366">
	     <jsp:getProperty name='rPH' property='pgSystemHint'/></font>
	   </td>
	   <td><font color="#CC3366">
		  <%  
		    if (tsInvoiceNo!=null && !tsInvoiceNo.equals(""))
			{
		      boolean branchConfirmFlag = false;
			  String  statusFlag = "";
		      Statement stateBC=con.createStatement();
              ResultSet rsBC=stateBC.executeQuery("select STATUS from TSC_INVOICE_HEADERS where INVOICE_NO = upper('"+tsInvoiceNo+"')   ");
		      if (rsBC.next())
		      {  
			    if (rsBC.getString("STATUS")!=null && rsBC.getInt("STATUS")>30)
				{ 
		          branchConfirmFlag = true;   
				}    
		      }
		      rsBC.close();
              stateBC.close();
			  
			if (branchConfirmFlag==false)  
			{
		  %><jsp:getProperty name='rPH' property='pgInvBranchConfirm'/>:<jsp:getProperty name='rPH' property='pgAlertBranchConfirm'/>
		  <%
		    } else { out.println("&nbsp;"); }
		   } else { out.println("&nbsp;");   } // (tsInvoiceNo!=null && !tsInvoiceNo.equals(""))		   
		  %></font>
	   </td>
	 </tr>
  </table>  
  ...
  <tr height="20" bgcolor="#D8E6E0">
    <td width="8%"  ><div align="center" class="style4"><font size="2"><jsp:getProperty name="rPH" property="pgCustomerName"/></font></div></td>
    <td colspan=3 width="17%"><div align="left" class="style4"><font size="2"><%=customerNo%>&nbsp;&nbsp;<%=customerName%></font></div></td>
	<td width="8%"><div align="center" class="style4"><font size="2"><strong><jsp:getProperty name="rPH" property="pgShipType"/><jsp:getProperty name="rPH" property="pgAddr"/></strong></font></div></td>
    <td colspan=4><div align="left" class="style4"><font size="2"><%=ShipToOrg%>&nbsp;&nbsp;<%=shipAddress%></font></div></td>
  </tr>
    <tr  height="20"  bgcolor="#D8E6E0">
	<td width="8%"><div align="center" class="style4"><font size="2"><strong><jsp:getProperty name="rPH" property="pgShipDate"/></strong></font></div></td>
    <td width="15%"><div align="left" class="style4"><font size="2"><input type="text" size="15" name="SHIPDATE" value="<%=shipDate%>" > 
		<A href='javascript:void(0)' onclick='gfPop.fPopCalendar(document.MYFORM.SHIPDATE);return false;'><img name='popcal' border='0' src='../image/calbtn.gif'></A>	
	 </font></div></td>
    <td width="8%"><div align="center" class="style4"><font size="2"><strong><jsp:getProperty name="rPH" property="pgShippingMethod"/></strong></font></div></td>
    <td width="12%"><div align="left" class="style4"><font size="2"><%=shipMethod%></font></div></td>
	<td width="10%" ><div align="center" class="style4"><font size="2"><strong><jsp:getProperty name="rPH" property="pgFOB"/></strong></font></div></td>
    <td width="8%"><div align="left" class="style4"><font size="2"><%=fobPoint%></font></div></td>
	<td width="10%"><div align="center" class="style4"><font size="2"><strong><jsp:getProperty name="rPH" property="pgPaymentTerm"/>	</strong></font></div></td>
    <td width="15%"><div align="left" class="style4"><font size="2"><%=paymentTerm%></font></div></td>
  </tr>
  </table>
  <table cellspacing="0" bordercolordark="#6699CC" cellpadding="1" width="100%" align="center" bordercolorlight="#ffffff" border="1">
    <tr bgcolor="#BBD3E1"> 
	  <td width="3%" nowrap><div align="center" class="style14"><font size="2">&nbsp;</font></div></td>
      <td width="12%" nowrap><div align="center" class="style14"><font size="2"><jsp:getProperty name="rPH" property="pgSalesOrderNo"/> </font></div></td>
      <td width="5%"  nowrap><div align="center" class="style14"><font size="2"><jsp:getProperty name="rPH" property="pgDetail"/><jsp:getProperty name="rPH" property="pgAnItem"/> </font></div></td>            
      <td width="15%" nowrap><div align="center" class="style14"><font size="2"><jsp:getProperty name="rPH" property="pgPart"/></font></div></td> 
	  <td width="20%" nowrap><div align="center" class="style14"><font size="2"><jsp:getProperty name="rPH" property="pgTSCAlias"/><jsp:getProperty name="rPH" property="pgOrderedItem"/></font></div></td> 
	  <td width="20%" nowrap><div align="center" class="style14"><font size="2"><jsp:getProperty name="rPH" property="pgCustItemNo"/></font></div></td> 
	  <td width="5%"  nowrap><div align="center" class="style14"><font size="2"><jsp:getProperty name="rPH" property="pgUOM"/></font></div></td> 
	  <td width="10%" nowrap><div align="center" class="style14"><font size="2"><jsp:getProperty name="rPH" property="pgShipType"/><jsp:getProperty name="rPH" property="pgQty"/></font></div></td> 
	  <td width="5%" nowrap><div align="center" class="style14"><font size="2"><jsp:getProperty name="rPH" property="pgPrice"/></font></div></td> 
	  <td width="2%" nowrap><div align="center" class="style14"><font size="2">Printed</font></div></td> 
    </tr>
...
//因為單價常常跳掉,故補show selling price,shipconfirm前可以check.  20060417   lily
         String sqlP =  "select UNIT_SELLING_PRICE from APPS.OE_ORDER_LINES_ALL where  LINE_ID = "+orderLineId ;
         Statement stateP=con.createStatement();
         ResultSet rsP=stateP.executeQuery(sqlP);
		 if (rsP.next())
		 {
		    unitSellingPrice   = rsP.getString("UNIT_SELLING_PRICE");
		  }
		   rsP.close();
           stateP.close();
...
// 單價常常跳掉 end
    ...
    %>
   <font face="Arial">
    </font><tr bgcolor="<%=colorStr%>"> 
      <td width="3%" ><div align="center"><font size="2" face="Arial"><a name='#<%//=rsTC.getString("ORDER_NUM")%>'>
        <%out.println(rs1__index+1);%>
      </a></font></div></td> 
      <td width="12%" nowrap><div align="center" class="style4"><font size="2" face="Arial"><%=rsTC.getString("SALESORDERNO")%></font></div></td>
	  <td width="5%" nowrap><div align="center" class="style15"><font size="2" face="Arial"><%=rsTC.getString("LINE_NO")%></font></div></td>
	  <td width="18%" nowrap><div align="center" class="style15"><font size="2" face="Arial"><%=rsTC.getString("INV_ITEM")%></font></div></td>
	  <td width="20%" nowrap><div align="center" class="style15"><font size="2" face="Arial"><%=rsTC.getString("ITEM_DESC")%></font></div></td>
	  <td width="20%" nowrap><div align="center" class="style15"><font size="2" face="Arial"><%=rsTC.getString("CUSTITEMNO")%></font></div></td>
	  <td width="5%" nowrap><div align="center" class="style15"><font size="2" face="Arial"><%=rsTC.getString("PO_UOM")%></font></div></td>
	  <td width="12%" nowrap><div align="center" class="style15"><font size="2" face="Arial"><%=rsTC.getString("RCVQTY")%></font></div></td>
	  <td width="5%" nowrap><div align="center" class="style15"><font size="2" face="Arial"><%=unitSellingPrice%></font></div></td>
	  <td width="2%" nowrap><div align="center" class="style15"><font size="2" face="Arial"><%=printFlag%></font></div></td>	  
	  <input type="hidden" name="CREATE_BY"  maxlength="5" size="5" value="<%=rsTC.getString("CREATE_BY")%>">
      ...
      <input type="hidden" name="ORDERHEADERID"  maxlength="5" size="5" value="<%=rsTC.getString("ORDER_HEADER_ID")%>">
      <input type="hidden" name="ORDERLINEID"  maxlength="5" size="5" value="<%=rsTC.getString("ORDER_LINE_ID")%>">      
     </tr>
    <%
  rs1__index++;
  rs_hasDataTC = rsTC.next();
...
%>
	...
	<td>&nbsp;
	 ...
	 <font color='#006666' face="Arial"><strong><%=CaseCount%></strong></font>
	 &nbsp;&nbsp;<font color="#006666" size="2"><jsp:getProperty name="rPH" property="pgGTotal"/><jsp:getProperty name="rPH" property="pgItemQty"/></font>
	 <font color='#006666' face="Arial"><strong><%=CaseCountORG%></strong></font>
	 </td>  
     <td ><div align="right"><font color="#006666" face="Arial" size="2">Invoice Total Amount=</font></div></td> 
     <td colspan="6"><font color="#006666" face="Arial" size="3"><strong>&nbsp;<%=totalAmt+"  ("+currencyCode+")"%></strong></font></td>     
    </tr>
  </table>
  <!--%每頁筆●顯示筆到筆總共有資料%-->
