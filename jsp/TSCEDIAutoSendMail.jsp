...
{ 	
	...
	else
	{
		...
		//message.addRecipient(Message.RecipientType.TO, new javax.mail.internet.InternetAddress("anne.landmann@tsceu.com"));  //20170418 celine通知
		//message.addRecipient(Message.RecipientType.TO, new javax.mail.internet.InternetAddress("christine.klein@tsceu.com")); //20170418 celine通知
