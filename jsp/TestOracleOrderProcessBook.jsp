...
<%@ page import="bean.ComboBoxAllBean,bean.ComboBoxBean,bean.DateBean,bean.ArrayComboBoxBean,bean.ArrayListCheckBoxBean,CodeUtil,bean.WriteLogToFileBean"%>
...
<body>
<A HREF="/Oradds/ORAddsMainMenu.jsp">回首頁</A>&nbsp;&nbsp;<A HREF="../jsp/TestOracleOrderProcessBookSelect.jsp"> 訂單Book頁面 </A>&nbsp;&nbsp;<A HREF="../jsp/TestOrderMultiLineImportCreate.jsp"> 新增訂單測試 </A><BR>
<% 
