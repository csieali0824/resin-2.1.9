...
<title>TEW Advise Customer Part NO Revise</title>
</head>
<body>
<FORM NAME="MYFORMD" ACTION="../jsp/TEWShippingAdviseRevise.jsp" METHOD="POST"> 
<%
...
try
{
	...
	sql = " select cust_partno,po_unit_price from tsc.tsc_shipping_po_price "+
	...
	<tr>
		<td>
			<table width="100%" border="0">
  				<tr align=center>
    				<td width="16%"> <input name="btnSubmit" type="button" onClick='setSubmit("../jsp/TEWShippingAdviseRevise.jsp?ACODE=SAVE")' value="Submit" style="font-family:Tahoma,Georgia;font-size:12px">&nbsp;&nbsp;&nbsp;
