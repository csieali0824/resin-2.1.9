...
<strong>Price Plan Inquiry</strong></font>
<FORM ACTION="../jsp/WSForecastPlanReport.jsp" METHOD="post" NAME="MYFORM">
<%
   int rs1__numRows = 25;
   int rs1__index = 0;
   int rs_numRows = 0;
...
<% 
	...
	{out.println(" <A HREF='/wins/report/"+WSUserID+"ForecastPlan_Query.xls'>Sales Forecast Plan Excel View</A>");}	
 %>
<table width="100%" border="0">
    <tr>
      <td width="22%" bgcolor="#006699"><font face="Arial Black"><strong><span class="style2">REGION</span></strong></font><font color="#FF0066" face="Arial Black"><strong>        
        <%
         try
         {   
		  String sSql = "";
		 ...
		 */
		  out.println("<select NAME='REGION' onChange='setSubmit("+'"'+"../jsp/WSForecastPlanReport.jsp"+'"'+")'>");
      ...
      <td width="25%" bgcolor="#006699"><font face="Arial Black"><strong><span class="style2">COUNTRY</span></strong></font><font color="#FF0066" face="Arial Black"><strong>        
        <%
         try
         {   
		  String sSql = "";
         ...
         */	
          ...
          out.println("<select NAME='COUNTRY' onChange='setSubmit("+'"'+"../jsp/WSForecastPlanReport.jsp"+'"'+")'>");
          out.println("<OPTION VALUE=-->--");     
          while (rs.next())
          {            
           String s1=(String)rs.getString(1); 
      ...
      <td width="20%" bgcolor="#006699"><font color="#FF0066" face="Arial Black"><strong>Brand</strong></font>	  
	   <% 		
	     try
         {   
		  String sSql = "";		 
      ...
      <td width="33%" bgcolor="#006699"><font color="#FF0066" face="Arial Black"><strong>INTERNAL MODEL</strong></font>	  
	  <input name="INTERMODEL" type="text" value="<%=interModel%>" size="15" maxlength="15">
      </td>   
    </tr>
    <tr>
      <td bgcolor="#006699" colspan="3">
        <font color="#FF0066" face="Arial Black"><strong>PLAN DATE FR.</strong></font>
        <%
       ...
       %>         
         <font color="#FF0066" face="Arial Black"><strong> ~<font color="#FF0066" face="Arial Black"><strong>PLAN DATE
      ...
      <INPUT TYPE="button"  value="Query" onClick='setSubmit("../jsp/WSForecastPlanReport.jsp")' >             
      </td> 
  ...
  <tr bgcolor="#006666">
    <%  
            ...
            {  
              ...
              /* String sqlTC =  "select DISTINCT BRAND, SEGMENT, SGMNT_FR, SGMNT_TO, FPYEAR, FPMONTH, SREGION, SCOUNTRY "+
			                  "from PSALES_FORE_EXWPRICE, PSALES_PRICE_SGMNT, PSALES_PROD_CENTER ";  */  // 3a!AA¢Du!±a Price Segment |U¢XI?! //
              String sqlTC =  "select DISTINCT BRAND, SEGMENT, SGMNT_FR, SGMNT_TO, FPYEAR, FPMONTH, SREGION, SCOUNTRY "+
			                  "from PSALES_FORE_PRICE, PSALES_PRICE_SGMNT, PSALES_PROD_CENTER ";
              //String sWhere = "where FPREG=SREGION and FPCOUN=SCOUNTRY and trim(SG_BRAND)=trim(BRAND) "+  // -poaChina ¢FD~ao?I?¢FG?A Brand
              String sWhere = "where  "+
		  ...
		  // ¢FFFFFFFFFFFD[?J?A-?-¢FFFFFFFFFFFX???????o??A_
   ...
   //out.println("MM_size Step0="+MM_size);
    ...
    <td width="12%"  height="19" bgcolor="#6699FF" rowspan="1"  nowrap><font color="#FF0066" size="2"><strong>
      <div align="center">PRICE<br>SEGMENT</div>
    </strong></font></td>
               ...
               float fpPriceGet = 0;
		        ...
		        {  
				  ...
				  /*
                    ...
                    String whereIM = "where "+   // ?¢FG?A Brand //
                                    "trim(INTER_MODEL) = trim(FPPRJCD) and (FPEXWPRI+1 between '"+rsTC.getString("SGMNT_FR")+"' and '"+rsTC.getString("SGMNT_TO")+"') "+  // ?uRa¢FXI?! ?¢FG¢FXI?A ?
                  ...
                  */  
                    String sqlIM = "select DISTINCT INTER_MODEL, EXT_MODEL, LAUNCH_DATE, FPPRI, FPYEAR, FPMONTH, b.BRAND, b.BRAND_ADJ "+
                                   "from PSALES_FORE_PRICE a, PIBRAND b, PSALES_PROD_CENTER c ";
                    String whereIM = "where "+
                                     "b.BRAND = c.BRAND "+   // ?¢FG?A Brand //
                                     "and trim(INTER_MODEL) = trim(FPPRJCD) and (FPRPRICE+1 between '"+rsTC.getString("SGMNT_FR")+"' and '"+rsTC.getString("SGMNT_TO")+"') "+  // ?uRa¢FXI?! ?¢FG¢FXI?A ?
                                     "and FPYEAR='"+rsTC.getString("FPYEAR")+"' and FPMONTH='"+rsTC.getString("FPMONTH")+"' "+
					...
					while (rsIM.next())
					{
				     shipPriceCal = rsIM.getFloat("FPPRI")*rsIM.getFloat("BRAND_ADJ");
                     //shipPriceCal = rsIM.getFloat("FPPRI");     
                     Statement stateEXWPrice=con.createStatement();
                     String sqlEXWPrice = "select FPEXWPRI from PSALES_FORE_EXWPRICE a, PSALES_COUNTRY_FACTOR b where FPYEAR = '"+rsIM.getString("FPYEAR")+"' and FPMONTH='"+rsIM.getString("FPMONTH")+"' "+
                     ...
                     if (rsEXWPrice.next()) {  shipPriceGet = rsEXWPrice.getFloat("FPEXWPRI"); }
                     else { shipPriceGet = 0; } 
                    /*             
                     if (shipPriceCal !=0 && shipPriceGet!=0)
                     { fpPriceGet = Math.min(shipPriceCal,shipPriceGet); }   // !Lu?GaI!Mu?p¢DB1s¢Xa?u?¢G?¢X1saI   
                   ...
                   */
                     ...
                     if (shipPriceGet>=shipPriceCal && shipPriceCal != 0) { fpPriceGet = shipPriceCal; }  // !Lu?GaI!Mu?p¢DB1s¢Xa?u?¢G?¢X1saI
        ...
        <tr bgcolor="#FFFFFF" >    
            ...
            <%   /*
               ...
               */ 
                     try
                     {
		              ...
		              //  String sqlV1 = "select FCCOGS from PSALES_FORE_COGS a where FCYEAR='"+rsTC.getString("FPYEAR")+"' and FCMONTH='"+rsTC.getString("FPMONTH")+"' and FCREG='"+rsTC.getString("SREGION")+"' and FCCOUN='"+rsTC.getString("SCOUNTRY")+"' and FCPRJCD='"+rsIM.getString("INTER_MODEL")+"' "+  // -poa?D!PC¢FDH China?¢FX¢FDD
          ...
          <%
                     try
                     {
                      ...
                      //               "and FPMVER = (select max(FPMVER) from PSALES_FORE_PRICE d where d.FPYEAR=a.FPYEAR and d.FPMONTH=a.FPMONTH and d.FPREG=a.FPREG and d.FPCOUN=a.FPCOUN and d.FPPRJCD=a.FPPRJCD) ";			
                      String sqlV1 = "select max(FPPRI) as FPPRI, EXW_ADJ, GM_INDEX, VAT  from PSALES_FORE_PRICE a, PSALES_COUNTRY_FACTOR b, PSALES_AGENT_GMIDX c where FPCOUN= BASECOUNTRY and FPPRJCD= c.INT_MODEL and b.COUNTRY='"+rsTC.getString("SCOUNTRY")+"' and FPPRJCD='"+rsIM.getString("INTER_MODEL")+"' "+
                                     "and FPMVER = (select max(FPMVER) from PSALES_FORE_PRICE d where d.FPYEAR=a.FPYEAR and d.FPMONTH=a.FPMONTH and d.FPREG=a.FPREG and d.FPCOUN=a.FPCOUN and d.FPPRJCD=a.FPPRJCD) "+
		              ...
		              if (rsV1.next())
		              {
                        //fpPrice =  (rsV1.getFloat("FPEXWPRI")*rsV1.getFloat("EXW_ADJ"))/(1-rsV1.getFloat("GM_INDEX"));
                    ...
                    float vat = 0;
                     ...
                     try
                     {
		              ...
		              if (rsV1.next())
		              {
                       ...
                       if (vat !=0)
                       {    
                         chnlProfit=(fpPrice-fpExwPrice);  // ?uRa?@?s?¢G!±t£g| //
                         chnlProfitInt = Math.round(chnlProfit);  
...
<!--=============¢FFFFFFFFFFDH?U¢FFFFFFFFFFXI?q?¢FFFFFFFFFFXAAcn3s¢FFFFFFFFFGg2|A==========-->
