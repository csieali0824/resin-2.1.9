...
<title>備機及備板借出完成</title>
</head>
<body>

<font color="#3366FF" size="+2" face="Arial"><strong>DBTEL</strong></font>
<font color="#000000" size="+2" face="細明體"><strong>備機及備板借出完成</strong></font>
<br>
<A HREF="/wins/WinsMainMenu.jsp">HOME</A> &nbsp
<A HREF="../jsp/WSShippingSpareEntry.jsp">備機及備板借出</A>&nbsp
<A HREF="../jsp/WSShippingSpareQuery.jsp">備機及備板借出查詢</A>
<br>
...
%>
	...
	<tr>
		...
		<td colspan="5"><font color="#333399" font size="2" face="Arial Black"><%=CustName%></font></td>
	</tr>
</table>
<%
	String sFlag = "Y";
	if (Warehouse==null || Warehouse.equals("--")) sFlag = "N";
	if (CustName==null || CustName.equals("")) sFlag = "N";
	if (a==null) sFlag = "N";
	...
	if (sFlag.equals("Y"))
	{
		...
		for (int i=0;i<a.length;i++)
		{
			...
			String version = "";
			String sqlR = "select VERSION VER from SFISM4.R_WIP_KEYPARTS_T where version is not null AND SERIAL_NUMBER = '"+a[i][4]+"' ";
			String sqlH = "select VERSION VER from SFISM4.H_WIP_KEYPARTS_T where version is not null AND SERIAL_NUMBER = '"+a[i][4]+"' ";
			//out.println(sqlR);
