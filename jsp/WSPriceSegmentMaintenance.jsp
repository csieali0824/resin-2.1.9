...
<strong>Price Segment Maintenance </strong></font>
...
<%
 ...
 %>
<A HREF="../WinsMainMenu.jsp">HOME</A>&nbsp;&nbsp;<A HREF="../jsp/WSForecastMenu.jsp">Back to submenu</A>&nbsp;&nbsp;<A HREF="../jsp/WSPriceSegmentEntry.jsp">Price Segment Input</A>&nbsp;&nbsp;<A HREF="../jsp/WSPriceSegmentMaintHView.jsp">Price Segment View</A>
<% 
...
<table width="100%" border="0">
    <tr>
      <td width="34%" bgcolor="#006699"><font color="#FF0066" face="Arial Black"><strong>REGION  
        <%
         ...
         {   
		  ...
		  out.println("<select NAME='REGION' onChange='setSubmit("+'"'+"../jsp/WSPriceSegmentMaintenance.jsp"+'"'+")'>");
      ...
      <td bgcolor="#006699"><font color="#FF0066" face="Arial Black"><strong>COUNTRY
         ...
         */	  
          out.println("<select NAME='COUNTRY' onChange='setSubmit("+'"'+"../jsp/WSPriceSegmentMaintenance.jsp"+'"'+")'>");
          out.println("<OPTION VALUE=-->--");     
          while (rs.next())
          {            
           String s1=(String)rs.getString(1); 
      ...
      <td width="31%" bgcolor="#006699"><font color="#FF0066" face="Arial Black"><strong>BRAND
        <%
          try
            {   
		      String sSql = "";
		      ...
		      /* comboBoxBean.setRs(rsB);
               ...
               out.println(comboBoxBean.getRsString()); */
		      out.println("<select NAME='BRAND' onChange='setSubmit("+'"'+"../jsp/WSPriceSegmentMaintenance.jsp"+'"'+")'>");
              out.println("<OPTION VALUE=-->--");     
              while (rsB.next())
              {            
    ...
    <tr>
      <td bgcolor="#006699" colspan="2"><font color="#FF0066" face="Arial Black"><strong>SEGMENT
        <%
    ...
    <td width="35%" bgcolor="#006699"><INPUT TYPE="button"  value="Query" onClick='setSubmit("../jsp/WSPriceSegmentMaintenance.jsp")' ></td>    
    </tr> 
...
<table width="100%" border="1" cellspacing="0" cellpadding="0">
        <tr bgcolor="#006666"> 
		  ...
		  <td width="13%"  height="19" bgcolor="#6699FF" nowrap><font color="#FFFFFF" size="2"><strong>REGION</strong></font></td>
          <td width="10%"  height="19" bgcolor="#6699FF" nowrap><font color="#FFFFFF" size="2"><strong>COUNTRY</strong></font></td>          	  
		  <td width="6%" bgcolor="#6699FF" nowrap><font color="#FFFFFF" size="2"><strong>BRAND</strong></font></td>
          <td width="11%" bgcolor="#6699FF" nowrap><font color="#FFFFFF" size="2"><strong>SEGMENT</strong></font></td>
		  <td width="13%" bgcolor="#6699FF" nowrap><font color="#FFFFFF" size="2"><strong>SGMNT FROM</strong></font></td>
          <td width="15%" bgcolor="#6699FF" nowrap><font color="#FFFFFF" size="2"><strong>SGMNT TO</strong></font></td>	          
          <td width="17%" bgcolor="#6699FF" nowrap><font color="#FFFFFF" size="2"><strong>LAST MAINT. DATETIME</strong></font></td>	  
		  <td width="12%" bgcolor="#6699FF" nowrap><font color="#FFFFFF" size="2"><strong>LAST MAINT. USER</strong></font></td>	
        </tr> 
          <%  
            try
            {  
              ...
              String sqlTC =  "select SREGION,SCOUNTRY,SG_BRAND,SEGMENT,SGMNT_FR,SGMNT_TO,GDATE,GUSER "+
             ...
             // if (MonthFr!="--" && MonthTo!="--") sWhereTC=sWhereTC+" and substr(LAUNCH_DATE,3,4)||substr(LAUNCH_DATE,1,2) between "+"'"+dateStringBegin+"'"+" and "+"'"+dateStringEnd+"' ";
			  ...
			  String sOrderTC = "order by SCOUNTRY,SG_BRAND,to_number(SEGMENT) ";
   ...
   //out.println("MM_size Step0="+MM_size);
    ...
    <%
      ...
      if (request.getParameterNames().hasMoreElements()) {
        ...
        %>
        <tr bgcolor="<%=colorStr%>">
		  <td><a href="../jsp/WSPriceSegmentMaintEdit.jsp?REGION=<%=rsTC.getString("SREGION")%>&COUNTRY=<%=rsTC.getString("SCOUNTRY")%>&BRAND=<%=rsTC.getString("SG_BRAND")%>&SEGMENT=<%=rsTC.getString("SEGMENT")%>">
          ...
          <td><font size="2" >
                 <%
                      if (rsTC.getString("SG_BRAND") !=null) { out.println(rsTC.getString("SG_BRAND")); } 
                      else { out.println("&nbsp;"); }
                     //=rsTC.getString("TXRPCENTERNO") 
                 %></font></td>		
          <td><font size="2">
                 <%
                      if (rsTC.getString("SEGMENT") !=null && rsTC.getString("SEGMENT") != " " ) { out.println(rsTC.getString("SEGMENT")); } 
                      else { out.println("&nbsp;"); }
                     //=rsTC.getString("TXRPCENTERNO") 
                 %></font></td>	
          <td><font size="2" >
                 <%
                      if (rsTC.getString("SGMNT_FR") !=null) { out.println(rsTC.getString("SGMNT_FR")); } 
                      else { out.println("&nbsp;"); }
                     //=rsTC.getString("TXRPCENTERNO") 
                 %></font></td>	
          <td><font size="2">
                 <%
                      ...
                      if (rsTC.getString("SGMNT_TO") !=null) { out.println(rsTC.getString("SGMNT_TO")); } 
                      else { out.println("&nbsp;"); }
                     //=rsTC.getString("TXRPCENTERNO") 
                 %></font></td> 
		  <td><font size="2" >
                 <%
                      if (rsTC.getString("GDATE") !=null) { out.println(rsTC.getString("GDATE")); } 
                      else { out.println("&nbsp;"); }
                     //=rsTC.getString("TXRPCENTERNO") 
                 %></font></td>			  
          <td width="12%"><font size="2" >
                 <%
                      if (rsTC.getString("GUSER") !=null) { out.println(rsTC.getString("GUSER")); } 
                      else { out.println("&nbsp;"); }
                     //=rsTC.getString("TXRPCENTERNO") 
                 %></font></td>			       
       </tr>
