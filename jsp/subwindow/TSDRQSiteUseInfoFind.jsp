<!-- 20150618 Peggy,TSCE SHIP TO CONTACT��SHIP_TO���D-->
	...
	if (siteUseCode=="SHIP_TO")   
 	{ 
  		...
  		if (document.SITEFORM.FUNC.value =="D1001")
  		{
			...
			//if (window.opener.document.MYFORM.SALESAREANO.value !="001")  //modify by Peggy 20150618,TSCE��SHIP_TO��SHIP TO CONTACT
			//{
...
<%  
    ...
    { 
		if (searchString!="" && searchString!=null) 
	   	{  
			//sql��g,�ѦҨӷ���ERP OM��ship to location��SQL
        	...
        	for (int i=1;i<=colCount-4;i++) // ����ܲĤ@����, �G for �� 2�}�l
        	{
