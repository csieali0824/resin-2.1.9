...
<body >  
<FORM METHOD="post" ACTION="TSLabelGroupInfo.jsp" NAME="SUBFORM">
<table width="100%">
	<tr>
		<td>
			<table>
			...
			<%     
				...
				{ 
					sql = " select a.label_group_code,a.label_group_name, a.label_group_desc, "+
						  ...
						  " ,case when a.label_form_code is null then '' else a.label_form_code||'-'||a.label_form_version end label_form"; //add by Peggy 20220707
					...
					sql += "  and NVL(a.effective_to_date,to_date('20990101','yyyymmdd'))>=trunc(sysdate)"+  //modify by Peggy 20210122
					       " order by a.label_group_code,a.label_group_name";
					//out.println(sql);
					...
					while (rs.next())
					{
						...
						%>
							<table width="100%" border="1" cellpadding="1" cellspacing="0" borderColorLight="#CFDAD8"  bordercolordark="#5C7671">
								<tr bgcolor="#D3E6F3"> 
									...
									<td width="8%" rowspan="2" style="font-size:12px;color:#006666" align="center">文件版號</td>
									<td width="13%" rowspan="2" style="font-size:12px;color:#006666" align="center">群組名稱</td>
									<td width="13%" rowspan="2" style="font-size:12px;color:#006666" align="center">群組說明</td>
									<td width="18%" colspan="5" style="font-size:12px;color:#006666" align="center" valign="middle">業務模組</td>
								</tr>
								<tr bgcolor="#D3E6F3"> 
							<%
						...
						{
						%>
							<td align="center"><%=(rs.getString(9+(i-1))==null?"&nbsp;":rs.getString(9+(i-1)))%></td>
						<%
						}
						%>
						</TR>
