...
<TABLE width="100%" border="1" cellspacing="0" cellpadding="0">
	<TR>
		...
		<TD><font style="font-family:Arial">&nbsp;<INPUT TYPE="FILE" NAME="UPLOADFILE1" size="60" class="style3"><font size="-1" color='red' face="Arial, Helvetica, sans-serif"></font></TD>
	</TR>
	<TR>
		<TD height="29" width="20%" align="center" bgcolor="#FFFFCC"><font style="font-family:'細明體';font-size:12px">&nbsp;上檔附件2&nbsp;</font></TD>
		<TD><font style="font-family:Arial">&nbsp;<INPUT TYPE="FILE" NAME="UPLOADFILE2" size="60" class="style3"><font size="-1" color='red' face="Arial, Helvetica, sans-serif"></font></TD>
	</TR>
	<TR>
		<TD height="29" width="20%" align="center" bgcolor="#FFFFCC"><font style="font-family:'細明體';font-size:12px">&nbsp;上檔附件3&nbsp;</font></TD>
		<TD><font style="font-family:Arial">&nbsp;<INPUT TYPE="FILE" NAME="UPLOADFILE3" size="60" class="style3"><font size="-1" color='red' face="Arial, Helvetica, sans-serif"></font></TD>
	</TR>
	<TR>
		<TD height="29" width="20%" align="center" bgcolor="#FFFFCC"><font style="font-family:'細明體';font-size:12px">&nbsp;上檔附件4&nbsp;</font></TD>
		<TD><font style="font-family:Arial">&nbsp;<INPUT TYPE="FILE" NAME="UPLOADFILE4" size="60" class="style3"><font size="-1" color='red' face="Arial, Helvetica, sans-serif"></font></TD>
	</TR>
	<TR>
		<TD height="29" width="20%" align="center" bgcolor="#FFFFCC"><font style="font-family:'細明體';font-size:12px">&nbsp;上檔附件5&nbsp;</font></TD>
		<TD><font style="font-family:Arial">&nbsp;<INPUT TYPE="FILE" NAME="UPLOADFILE5" size="60" class="style3"><font size="-1" color='red' face="Arial, Helvetica, sans-serif"></font></TD>
	</TR>
	<TR>
		<TD colspan="2" align="center">
		<INPUT TYPE="button" NAME="upload" value="檔案上傳" onClick='setUpload("../subwindow/TSCStockTransAttachments.jsp?ACTION=UPLOAD&HID=<%=HID%>")'>
		&nbsp;&nbsp;&nbsp;&nbsp;
...
<%
	if (ACTION.equals("UPLOAD"))
	{
		try
		{
			if (HID.equals("")) throw new Exception("查無ID!!");
			//java.io.File file = new java.io.File("D:/resin-2.1.9/webapps/oradds/jsp/PMD_Attache/"+FILEID); 
			java.io.File file = new java.io.File(application.getRealPath("/jsp/ILAN_Attache/"+HID));
			if(!file.exists())
			{
				file.mkdirs(); 
			}
 			...
 			for (int i=0;i < mySmartUpload.getFiles().getCount(); i++)
			{
				...
				{
					upload_file.saveAs("/jsp/ILAN_Attache/"+HID+"/"+uploadFile_name);
				}
			}
	%>
			<script language="JavaScript" type="text/JavaScript">
