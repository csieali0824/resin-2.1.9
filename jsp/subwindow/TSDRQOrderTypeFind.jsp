<!-- modify by Peggy 20150416,�S�w�Ȥ���w�S�wline type-->
<!-- modify by Peggy 20150721,TSCE �q����������,shipping method & ssd�n�M������-->
<!-- modify by Peggy 20160706,TSCA �q����������,shipping method & ssd�n�M������-->
...
{ 
	if (lineNo =="")
	{
		if (arrayLine != "" && arrayLine != null && arrayLine != "null")
		{
			...
			//tsce �q����������,shipping method & ssd�n�M������,add by Peggy 20150721
