...
<!-- 20151119 Peggy,AP.ap_supplier_sites_all�W�[ (b.INACTIVE_DATE IS NULL or trunc(b.INACTIVE_DATE)>trunc(sysdate)) and b.PURCHASING_SITE_FLAG='Y'����-->
<!-- 20151225 Peggy,3083�Ѥ��ؤѷL�q�l�ѥ��������q��W��4056�Ѥ��ؤѹq�l����-->
...
{ 
	...
	if (FUNCNAME=="F1001")
	{
		...
		{
			if ( VendorNo=="2012") //�@����L�ʸ�,add by Peggy 20141110
			{
				window.opener.document.MYFORM.CHKASSEMBLY.checked =false;
			}
			else if (VendorNo=="3867")  //�_�s��u������,add by Peggy 20150317
			{
				window.opener.document.MYFORM.CHKASSEMBLY.checked=false;
	...
	if (FUNCNAME !="F1-006")
	{
		...
		if (window.opener.document.getElementById("td1")!=undefined)
		{
			...
			{
				if (Currency==="USD" || window.opener.document.MYFORM.WIPTYPE.value ==="03" || window.opener.document.MYFORM.WIPTYPE.value === "02")  //modify by Peggy 20120705,���u�������쬰K
				{
	     ...
	     %>
		    <!--<script LANGUAGE="JavaScript">		
				...
				if (document.SITEFORM.FUNCNAME.value=="F1001")
				{
					if (window.opener.document.MYFORM.WIPTYPE.value =="01" || window.opener.document.MYFORM.WIPTYPE.value =="03")  //modify by Peggy 20170712,add ���u
					{
						if (document.SITEFORM.VENDORNO.value=="2012") //�@����L�ʸ�,add by Peggy 20141110
						{
							window.opener.document.MYFORM.CHKASSEMBLY.checked =false;
						}	
						else if (document.SITEFORM.VENDORNO.value =="3867")  //�_�s��u������,add by Peggy 20150317
						{
							window.opener.document.MYFORM.CHKASSEMBLY.checked=false;
							window.opener.document.MYFORM.CHKTESTING.checked=true;
							window.opener.document.MYFORM.CHKTAPING.checked=false;
				...
				if (document.SITEFORM.FUNCNAME.value!="F1-006")
				{
					...
					if (window.opener.document.getElementById("td1")!=undefined)
					{
						...
						{
							if (document.SITEFORM.CURRENCYCODE.value =="USD" || window.opener.document.MYFORM.WIPTYPE.value=="03")  //modify by Peggy 20120705,���u�������쬰K
							{
						...
						if (document.SITEFORM.PRICEUOM.value =="��")
						{
