<!-- 20150721 Peggy,shipping method��Hcall tsc_edi_pkg.get_shipping_method���o-->
<!-- 20151026 Peggy,get_ssd  arrow ssd+�B��Ѽ�>=crd -->
<!-- 20160513 Peggy,for TSC_EDI_PKG.GET_SHIPPING_METHOD�s�Wcustomer_id�ӭק�-->
<!-- 20160706 Peggy,TSCA shipping method���&SSD�p��-->
<!-- 20161019 by Peggy,����function:TSC_RFQ_GET_TSCA_SSD,���TSCA_GET_ORDER_SSD-->
...
<%  
	...
	//if (cust_id.equals("7147")) i_days=-1; //add by Peggy 20160729,CRD���e��11��
	...
	try
    {
		...
		while (rs.next())
		{
			...
			for (int i=1;i<=colCount-2;i++) // ����ܲĤ@����, �G for �� 2�}�l
			{
