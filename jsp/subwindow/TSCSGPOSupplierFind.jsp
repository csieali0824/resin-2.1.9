...
<body >  
<FORM METHOD="post" ACTION="TSCSGPOSupplierFind.jsp" NAME="SUBFORM">
<table>
	<tr>
		<td>
			<table>
		...
		<td>
			<%     
				...
				{ 
					...
					sql = " SELECT distinct D.SEGMENT1 vendor_code"+
					      ",F.VENDOR_SITE_CODE"+
						  ",F.INVOICE_CURRENCY_CODE CURRENCY_CODE"+
						  ",D.vendor_name"+
						  ",F.vendor_site_id"+
                          ...
                          " and f.ship_to_location_id = hl.location_id"+
					...
					if (!ORGCODE.equals(""))
					{
						sql += " AND mp.organization_id =" + ORGCODE+"";
					}
					sql +=" AND A.vendor_site_id = F.vendor_SITE_id"+
						  ...
						  " AND (D.VENDOR_NAME LIKE '%"+SEARCHSTR+"%' or f.VENDOR_SITE_CODE like '%"+SEARCHSTR+"%')"+
					...
					statement.setString(2,"SG1");
					statement.setString(3,"SG2");
					...
					out.println("<TH style='font-size:12px;font-family:arial'>內外銷</TH>");
					...
					while (rs.next())
					{
						...
						out.println("<TD style='font-size:12px;font-family:arial' align='center'>"+ rs.getString(6)+"</TD>");
