...
<!-- 20150814 Peggy,MOSFET�t�C���~,Testing Yield=95%-->
...
{ 
	if (LineNo=="")
	{
		...
		{
			if (window.opener.document.MYFORM.SUPPLIERNO.value =="3867")  //�_�s��u������,add by Peggy 20150317
			{
			...
			{			
				if (window.opener.document.MYFORM.SUPPLIERNO.value !="2012" && window.opener.document.MYFORM.PACKAGE.value.toUpperCase() !="WAFER")  //�ʸ˧Φ�=WAFER���īʸ� For Nono issue,add by Peggy 20180126
				{
				...
				if ((PackingType=="AMMO" || PackingType=="TAPE & REEL") && window.opener.document.MYFORM.PACKAGE.value.toUpperCase() !="WAFER") //�ʸ˧Φ�=WAFER���Ľs�a For Nono issue,add by Peggy 20180126 
				{
		...
		if (window.opener.document.MYFORM.WIPTYPE.value =="04")  //WAFER�u��۰ʼg�J�ʸ˳W��δ��ճW�� add by Peggy 20240418
		{
			window.opener.document.MYFORM.PACKAGESPEC.value=PackageSpec;
			window.opener.document.MYFORM.TESTSPEC.value=TestSpec;   			
		}	
		
		if (window.opener.document.MYFORM.WIPTYPE.value =="03" || window.opener.document.MYFORM.WIPTYPE.value =="05")  //CP follow���u by Peggy 20220126
		{
		...
		if (window.opener.document.getElementById("td1")!=undefined)
		{
			...
			{
				if (window.opener.document.MYFORM.CURRENCYCODE.value =="USD" || window.opener.document.MYFORM.WIPTYPE.value=="03" || window.opener.document.MYFORM.WIPTYPE.value==="02")  //modify by Peggy 20120705,���u�������쬰K
				{
    ...
    { 
		...
		if (FUNCNAME.startsWith("F2"))
		{
			sql = " select distinct A.SEGMENT1 ITEM_NAME, A.DESCRIPTION,"+
                     ...
                     " TSC_OM_CATEGORY(A.INVENTORY_ITEM_ID,A.ORGANIZATION_ID,'TSC_PROD_FAMILY') as TSC_FAMILY,"+ //MOSFET�O���bTSC_PROD_FAMILY
		...
		else
		{
			sql = " select distinct A.SEGMENT1 ITEM_NAME, A.DESCRIPTION,"+
					 ...
					 //",(select * from  bom_bill_of_materials bom where exists (select 1 from bom_inventory_components bic where (DISABLE_DATE is null or trunc(DISABLE_DATE)>trunc(sysdate)) AND  bic.BILL_SEQUENCE_ID=bom.BILL_SEQUENCE_ID)) bom"+ //���Τ���� ,add by Peggy 20140414
					 //�Y��alternate bom,�HIS_PREFERRED=Y���u��.modif by Peggy 20140428
			...
			if ((WIPTYPE.equals("03") || WIPTYPE.equals("05"))) sql += " and bom.seqno=1";  //CP follow���u by Peggy 20220126
			sql +=   ") bom"+
			...
			if (WIPTYPE.equals("03") || WIPTYPE.equals("05") || !LINENO.equals(""))  //CP follow���u by Peggy 20220126
			{
		...
		while (rs.next())
		{
			...
			//if (((WIPTYPE.equals("03") || WIPTYPE.equals("05")) && BillSeqID != null && !rs.getString("item_type").toUpperCase().equals("WAFER")) || (!WIPTYPE.equals("03") && !WIPTYPE.equals("05") && LINENO.equals(""))) //CP follow���u by Peggy 20220126
			if (((WIPTYPE.equals("03") || WIPTYPE.equals("05")) && BillSeqID != null && !rs.getString("item_type").toUpperCase().equals("WAFER") && !rs.getString("TSC_PACKAGE").toUpperCase().equals("WAFER")) || (!WIPTYPE.equals("03") && !WIPTYPE.equals("05") && LINENO.equals(""))) //CP follow���u by Peggy 20220126
			{
			...
			//else if ((WIPTYPE.equals("03") || WIPTYPE.equals("05")) && (BillSeqID ==null || rs.getString("item_type").toUpperCase().equals("WAFER"))) //CP follow���u by Peggy 20220126
			else if ((WIPTYPE.equals("03") || WIPTYPE.equals("05")) && (BillSeqID ==null || rs.getString("item_type").toUpperCase().equals("WAFER") || rs.getString("TSC_PACKAGE").toUpperCase().equals("WAFER"))) //�[package�P�_ by Peggy 20220208
			{
				DieID = ItemID;
				DieName ="N/A";
				DIEITEM ="N/A";
			...
			if (WIPTYPE.equals("01"))
			{
				...
				sql = " select MARKING from (SELECT a.INVENTORY_ITEM_NAME,a.VENDOR_CODE, a.MARKING,row_number() over (partition by a.VENDOR_CODE,a.INVENTORY_ITEM_NAME order by a.CREATION_DATE desc) ROW_CNT"+
					  ...
					  " FROM oraddman.tspmd_oem_headers_all a  where STATUS='Approved' AND a.WIP_TYPE_NO='"+WIPTYPE+"' AND a.INVENTORY_ITEM_ID='"+ItemID+"' AND a.MARKING <>'N/A') a where row_cnt =1";  //�̫����P�Omarking for nono,modify by Peggy 20191217
				//out.println(sql);	  
			...
			out.println("' onClick="+'"'+buttonContent+'"'+"></TD>");		
			for (int i=1;i<=colCount-3;i++) // ����ܲĤ@����, �G for �� 2�}�l
			{
