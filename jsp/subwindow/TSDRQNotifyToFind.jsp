...
<%
 ...
 String moContactInfo[]=new String[3]; // �ŧi�@���}�C,�N�䥦�]�w��T�m�JArray
...
<FORM action="TSDRQNotifyToFind.jsp" METHOD="post" NAME="MYFORM">
  <font size="-1"><jsp:getProperty name="rPH" property="pgNotifyContact"/>�B<jsp:getProperty name="rPH" property="pgNotifyLocation"/><jsp:getProperty name="rPH" property="pgOR"/><jsp:getProperty name="rPH" property="pgShipContact"/>: 
  ...
  <%  
      ...
      { 
	   ...
	   {  	
		 ...
		 String where =""; 
		 String order =	"";		        
				   if (useCode.equals("N_CONTACT"))  // �]�w�޲z���i�ݱo��Ҧ��Ȥ�
				   {
