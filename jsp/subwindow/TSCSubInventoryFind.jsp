...
{         
   ...
   {   
	   window.opener.document.DISPLAYREPAIR.SUBINVENTORY<%=xINDEX%>.value=subInventory;
	    window.opener.document.DISPLAYREPAIR.SUBINVDESC<%=xINDEX%>.value=subInvDesc;
	   ...
	   {  	
	    ...
	    if (queryCount==1) //若取到的查詢數 == 1, 則直接帶回原視窗
	    {
		    ...
		    <script LANGUAGE="JavaScript">	
			  //alert("TEST");		
			    formSUBINVENTORY_Write = "window.opener.document.DISPLAYREPAIR.SUBINVENTORY"+document.SUBINVFORM.XINDEX.value+".value";	
