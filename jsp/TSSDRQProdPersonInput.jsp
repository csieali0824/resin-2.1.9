...
<html>
<head>
<title>Product Factory Person Input Form</title>
...
<body>
<FORM ACTION="../jsp/TSSDRQProdPersonInsert.jsp" METHOD="post" name="MYFORM">
<%
       String choiceCenterNo=request.getParameter("MANUFACTORY_NO");
       String UserID = request.getParameter("USERID");

       String maxSalesPersonNo = "";
    
       Statement stateMaxRID=con.createStatement();
       ResultSet rsMaxRID=stateMaxRID.executeQuery("select lpad(max(PROD_PERSONNO)+1,3,'0') from ORADDMAN.TSPROD_PERSON where PLOCALE='"+locale+"' and PROD_FACNO='"+choiceCenterNo+"' "); 
...
%>
  <font color="#0080FF" size="5"><strong><jsp:getProperty name="rPH" property="pgProdPC"/><jsp:getProperty name="rPH" property="pgBasicInf"/><jsp:getProperty name="rPH" property="pgNew"/></strong></font> 
  <table cellSpacing="0" bordercolordark="#99CC99" cellPadding="1" width="90%" bordercolorlight="#FFFFCC"  border="1">
    <tr> 
      <td width="48%" nowrap><font color="#CC0033" size="2"><jsp:getProperty name="rPH" property="pgProdFactory"/><jsp:getProperty name="rPH" property="pgNo"/>
	  <%      
	  try
      {       
    ...
    <tr> 
	  ...
	  <td colspan="1" nowrap><font color="#CC0033" size="2"><jsp:getProperty name="rPH" property="pgProdPC"/><jsp:getProperty name="rPH" property="pgCode"/> 
        <INPUT TYPE="text" NAME="SALESRESID" size="20"></font></td>	
    </tr>
  </table>
  <p> 
    <INPUT TYPE="button" NAME="submit2" value='<-<jsp:getProperty name="rPH" property="pgSave"/>' onClick='return setSubmit("../jsp/TSSDRQProdPersonInsert.jsp")'>
  </p>
  </FORM>
