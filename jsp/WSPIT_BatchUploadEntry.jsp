...
<title>PIT Batch Upload Entry Form</title>
</head>
<body>
<FORM ACTION="WSPIT_BatchUploadInsert.jsp" METHOD="post" NAME="MYFORM" ENCTYPE="multipart/form-data">
...
<table width="100%" border="0">
    <tr bgcolor="#D0FFFF">
      <td width="15%" bordercolor="#FFFFFF"><font color="#330099" face="Arial Black"><strong>PRODUCT:</strong></font>
			<BR>  	 <font size="2">
		<%      
	  try
      {     	         
      ...
      <td width="15%" height="23" bordercolor="#FFFFFF"> 
	...
	<HR>
	<font color="#330099" face="Arial Black"><strong>DATA FILE :</strong></font><INPUT TYPE="FILE" NAME="UPLOADFILE">	
 <!-- 表單參數 -->  
	...
	<input name="ACTION" type="HIDDEN" value="006">	
