...
public class OrderReviseExcelK3 {
    public static void main(String[] args) throws Exception {
        Connection con = ConnUtils.getConnectionProd();
        DateBean dateBean = new DateBean();
        String sql = "", ERP_USERID="", ACTTYPE ="AUTO";
        ...
        String SDATE="20250101";
        String EDATE="20250812";
        String RPTName = "TSCC Order Revise List";
        String FileName = RPTName+"("+SDATE+ "" +")-"+dateBean.getYearMonthDay()+dateBean.getHourMinute()+".xls";
