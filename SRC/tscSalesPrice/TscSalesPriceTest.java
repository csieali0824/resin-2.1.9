...
//    static {
//        try {
//            styles = new ExcelWriter().createStyles();
//        } catch (Exception e) {
...
//                            System.out.println("tscProdGroup="+tscProdGroup);
//                            System.out.println("packageCode="+packageCode);
//                            System.out.println("tscPackage="+tscPackage);
//                            System.out.println("tscFamily="+tscFamily);
//                            System.out.println("description="+description);
//                            System.out.println("websiteStatus="+websiteStatus);
...
//                new ExcelColumn("SPG STATUS", 12, styles.get("centerL"), null, null,
//                        (Map<String, Object> rowData) -> {
//                            String f400Product = (String) rowData.get("F400_PRODUCT");
//                            String tscFamily = (String) rowData.get("TSC_FAMILY");
//                            String aecQ101 = (String) rowData.get("AEC_Q101");
//                            String websiteStatus = (String) rowData.get("WEBSITE_STATUS");
//
//                            if (!StringUtils.isNullOrEmpty(f400Product) && "YES".equals(f400Product) ||
//                                    equalsCase(tscFamily, "MOSFET-HV", "MOSFET-MV", "MOSFET-LV", "TVS LOAD DUMP") ||
//                                    (equalsCase(tscFamily, "TRENCH SKY", "LIGHTING IC") &&
//                                            !StringUtils.isNullOrEmpty(aecQ101) && "Yes".equals(aecQ101))
//                            ) {
//                                if (!StringUtils.isNullOrEmpty(websiteStatus) && "Active".equals(websiteStatus)) {
//                                    return "SPG";
//                                }
