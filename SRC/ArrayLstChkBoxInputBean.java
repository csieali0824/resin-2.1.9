...
public class ArrayLstChkBoxInputBean implements java.io.Serializable
{
  private String fieldName="";  
  private String [] arrayString;
  private String [][] array2DString;  
  private String selection="";
  private String inputBoxFieldName="INPUTBOX"; 
  private String inputBoxFieldLength="8";

  public ArrayLstChkBoxInputBean()
  {}  
 
 public String getInputBoxFieldName()
 {
  return inputBoxFieldName;
 }

 public void setInputBoxFieldName(String str)  
  {
   this.inputBoxFieldName=str;
  } //end of setInputBoxFieldName 

 public String getInputBoxFieldLength()
 {
  return inputBoxFieldLength;
 }

 public void setInputBoxFieldLength(String str)  
  {
   this.inputBoxFieldLength=str;
  } //end of setInputBoxFieldLength
  ...
  {          
    ...
    {   
      ...
      for (j=1;j<array2DString[i].length;j++)      
      {
        ...
        String fieldName=inputBoxFieldName+i+"-"+j;    
            
        sb.append("<TD><FONT SIZE=1><input type='text' name="+fieldName+" size='"+inputBoxFieldLength+"' value='"+s2+"'></TD>");
