...
public class Test {
    ...
    public static void main(String[] args) {
        // 原始??
        String[][] array = {
                {"1", "802H-121QQ21J02600050000000F00", "SMBJ26CAH", "510.0", "KPC", "20251001", "000001_TRUCK_A_LTL", "20250925", "91410000923", "", "N", "0", "0", "002", "1A011119A", "0.0367", "1141", "1008", "DAP", "20.1", "", "32720", "", "", "GENTHERM", "6366295", "", "", "", ""}
        };
        ...
        for (int j = 0; j < array[0].length; j++) {
            if (j == 0) {
                newArray[array.length][j] = "2";
            } else {
                newArray[array.length][j] = null;
            }
        }
